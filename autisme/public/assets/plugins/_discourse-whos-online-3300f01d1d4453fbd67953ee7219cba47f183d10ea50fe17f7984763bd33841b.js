...
define("discourse/plugins/discourse-whos-online/discourse/components/whos-online", ["exports", "@ember/component", "@ember/service", "discourse-common/utils/decorators"], function (_exports, _component, _service, _decorators) {
  ...
  var _default = _component.default.extend((_dec = (0, _decorators.default)("online.users.length"), _dec2 = (0, _decorators.default)("online.users.@each"), _dec3 = (0, _decorators.default)("online.users.length"), _dec4 = (0, _decorators.default)("online.users.length"), (_obj = {
    online: (0, _service.inject)("online-service"),
    showWhosOnline: function showWhosOnline() {
...
define("discourse/plugins/discourse-whos-online/discourse/services/online-service", ["exports", "@ember/service", "discourse/lib/ajax", "discourse/models/user", "discourse/models/site", "@ember/object"], function (_exports, _service, _ajax, _user, _site, _object) {
  "use strict";
  ...
  var _default = _service.default.extend((_obj = {
    ...
    isUserOnline: function isUserOnline(user_id) {
      ...
      var found = this.users.find(matchById, user_id);
    ...
    get shouldDisplay() {
      ...
      if (!this.currentUser) {
        ...
        return this.currentUser.trust_level >= this.siteSettings.whos_online_display_min_trust_level;
      }
    }

  }, (_applyDecoratedDescriptor(_obj, "shouldDisplay", [_object.computed], Object.getOwnPropertyDescriptor(_obj, "shouldDisplay"), _obj)), _obj));
