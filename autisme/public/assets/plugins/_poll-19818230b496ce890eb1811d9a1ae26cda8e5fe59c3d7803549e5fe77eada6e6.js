    ...
    fetchVoters: function fetchVoters(optionId) {
      ...
      return _fetchVoters({
        ...
        if (result.voters[optionId] && result.voters[optionId].length > 0) {
          state.voters[optionId] = _toConsumableArray(new Set([].concat(_toConsumableArray(state.voters[optionId]), _toConsumableArray(result.voters[optionId]))));
          state.page[optionId]++;
        }
    ...
    fetchVoters: function fetchVoters(optionId) {
      ...
      return _fetchVoters({
        ...
        if (result.voters && result.voters.length > 0) {
          state.voters = _toConsumableArray(new Set([].concat(_toConsumableArray(state.voters), _toConsumableArray(result.voters))));
          state.page++;
        }
