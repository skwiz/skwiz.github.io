...
define("discourse/plugins/discourse-local-dates/initializers/discourse-local-dates", ["exports", "discourse-common/lib/deprecated", "discourse-common/lib/get-owner", "discourse/lib/d-popover", "../lib/local-date-builder", "discourse/lib/plugin-api", "discourse/lib/show-modal", "discourse/lib/download-calendar", "discourse-common/lib/icon-library"], function (_exports, _deprecated, _getOwner, _dPopover, _localDateBuilder, _pluginApi, _showModal, _downloadCalendar, _iconLibrary) {
  "use strict";
  ...
  function _downloadCalendarNode(element) {
    ...
    node.innerHTML = "".concat((0, _iconLibrary.renderIcon)("string", "file"), " ").concat(I18n.t("download_calendar.add_to_calendar"));
    ...
    node.setAttribute("data-starts-at", moment.tz("".concat(startDataset.date, " ").concat(startDataset.time || "").trim(), startDataset.timezone).toISOString());

    if (endDataset) {
      node.setAttribute("data-ends-at", moment.tz("".concat(endDataset.date, " ").concat(endDataset.time || "").trim(), endDataset.timezone).toISOString());
    }

    if (!startDataset.time && !endDataset) {
      node.setAttribute("data-ends-at", moment.tz("".concat(startDataset.date), startDataset.timezone).add(24, "hours").toISOString());
    }

    node.setAttribute("data-title", document.querySelector("#topic-title a").innerText);
  ...
  var _default = {
    ...
    showDatePopover: function showDatePopover(event) {
      ...
      if (event === null || event === void 0 ? void 0 : (_event$target = event.target) === null || _event$target === void 0 ? void 0 : (_event$target$classLi = _event$target.classList) === null || _event$target$classLi === void 0 ? void 0 : _event$target$classLi.contains("discourse-local-date")) {
        ...
        (0, _dPopover.hidePopover)(event);
        (0, _downloadCalendar.downloadCalendar)(dataset.postId, dataset.title, [{
