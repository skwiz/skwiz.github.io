...
r += ", вы также можете посмотреть другие сообщения в группе ";
if(!d){
throw new Error("MessageFormat: No data passed to function.");
}
r += d["groupLink"];
...
r += ", вы также можете посмотреть другие <a href='";
if(!d){
throw new Error("MessageFormat: No data passed to function.");
}
r += d["basePath"];
