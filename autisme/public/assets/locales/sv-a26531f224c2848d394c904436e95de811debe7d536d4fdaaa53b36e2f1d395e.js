...
r += " kvar, eller bläddra bland andra meddelanden i ";
if(!d){
throw new Error("MessageFormat: No data passed to function.");
}
r += d["groupLink"];
...
r += " kvar, eller bläddra genom andra <a href='";
if(!d){
throw new Error("MessageFormat: No data passed to function.");
}
r += d["basePath"];
...
r += d["username"];
r += "/message'>personliga meddelanden</a>";
return r;
