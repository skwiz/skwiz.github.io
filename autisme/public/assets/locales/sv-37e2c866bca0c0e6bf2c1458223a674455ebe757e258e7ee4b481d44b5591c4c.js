...
r += " kvar, eller bläddra bland andra <a href='";
if(!d){
throw new Error("MessageFormat: No data passed to function.");
}
r += d["basePath"];
...
r += d["username"];
r += "/messages/personal'>personliga meddelanden</a>";
return r;
