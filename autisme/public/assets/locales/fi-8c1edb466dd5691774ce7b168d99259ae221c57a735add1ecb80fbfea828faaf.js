...
r += "</a> saavutti sivustoasetusrajan ";
if(!d){
throw new Error("MessageFormat: No data passed to function.");
}
var lastkey_1 = "limit";
...
"one" : function(d){
var r = "";
r += "on <b>" + (function(){ var x = k_1 - off_0;
if( isNaN(x) ){
throw new Error("MessageFormat: `"+lastkey_1+"` isnt a number.");
}
return x;
...
r += ", joiden arvioitu lukuaika on <b>";
if(!d){
throw new Error("MessageFormat: No data passed to function.");
}
...
r += " tältä käyttäjältä, poistamassa käyttäjätilin, estämässä uusien tunnusten luonnin IP-osoitteestaan <b>";
if(!d){
throw new Error("MessageFormat: No data passed to function.");
}
r += d["ip_address"];
r += "</b> ja lisäämässä hänen sähköpostiosoitteensa <b>";
if(!d){
throw new Error("MessageFormat: No data passed to function.");
}
r += d["email"];
r += "</b> pysyvälle estolistalle. Oletko varma, että käyttäjä todella on roskapostittaja?";
return r;
...
I18n.translations = {"fi":{"js":{"number":{"format":{"separator":",","delimiter":" "},"human":{"storage_units":{"format":"%n %u","units":{"byte":{"one":"Tavu","other":"Tavua"},"gb":"Gt","kb":"Kt","mb":"Mt","tb":"Tt"}}},"short":{"thousands":"%{number} k","millions":"%{number} M"}},"dates":{"time":"h.mm a","time_with_zone":"hh.mm a (z)","time_short_day":"ddd HH.mm","timeline_date":"MMM YYYY","long_no_year":"D. MMM, HH.mm","long_no_year_no_time":"D. MMMM[ta]","full_no_year_no_time":"Do MMMM[ta]","long_with_year":"D. MMMM[ta] YYYY H.mm","long_with_year_no_time":"D. MMMM[ta] YYYY","full_with_year_no_time":"Do MMMM[ta] YYYY","long_date_with_year":"D. MMMM[ta] YYYY LT","long_date_without_year":"D. MMMM[ta] LT","long_date_with_year_without_time":"D. MMMM[ta] YYYY","long_date_without_year_with_linebreak":"D. MMMM[ta] \u003cbr/\u003eLT","long_date_with_year_with_linebreak":"D. MMMM[ta] YYYY \u003cbr/\u003eLT","wrap_ago":"%{date} sitten","tiny":{"half_a_minute":"\u003c 1 min","less_than_x_seconds":{"one":"\u003c %{count} s","other":"\u003c %{count} s"},"x_seconds":{"one":"%{count} s","other":"%{count} s"},"less_than_x_minutes":{"one":"\u003c %{count} min","other":"\u003c %{count} min"},"x_minutes":{"one":"%{count} min","other":"%{count} min"},"about_x_hours":{"one":"%{count} t","other":"%{count} t"},"x_days":{"one":"%{count} pv","other":"%{count} pv"},"x_months":{"one":"%{count} kk","other":"%{count} kk"},"about_x_years":{"one":"%{count} v","other":"%{count} v"},"over_x_years":{"one":"\u003e %{count} v","other":"\u003e %{count} v"},"almost_x_years":{"one":"%{count} v","other":"%{count} v"},"date_month":"D. MMM","date_year":"MMM YY"},"medium":{"x_minutes":{"one":"%{count} minuutti","other":"%{count} minuuttia"},"x_hours":{"one":"%{count} tunti","other":"%{count} tuntia"},"x_days":{"one":"%{count} päivä","other":"%{count} päivää"},"date_year":"D. MMMM[ta] YYYY"},"medium_with_ago":{"x_minutes":{"one":"%{count} minuutti sitten","other":"%{count} minuuttia sitten"},"x_hours":{"one":"%{count} tunti sitten","other":"%{count} tuntia sitten"},"x_days":{"one":"%{count} päivä sitten","other":"%{count} päivää sitten"},"x_months":{"one":"%{count} kuukausi sitten","other":"%{count} kuukautta sitten"},"x_years":{"one":"%{count} vuosi sitten","other":"%{count} vuotta sitten"}},"later":{"x_days":{"one":"%{count} päivä myöhemmin","other":"%{count} päivää myöhemmin"},"x_months":{"one":"%{count} kuukausi myöhemmin","other":"%{count} kuukautta myöhemmin"},"x_years":{"one":"%{count} vuosi myöhemmin","other":"%{count} vuotta myöhemmin"}},"previous_month":"Edellinen kuukausi","next_month":"Seuraava kuukausi","placeholder":"päivämäärä","to_placeholder":"päivämäärään"},"share":{"topic_html":"Ketju: \u003cspan class=\"topic-title\"\u003e%{topicTitle}\u003c/span\u003e","post":"%{postNumber}. viesti","close":"sulje","twitter":"Jaa Twitterissä","facebook":"Jaa Facebookissa","email":"Lähetä sähköpostitse","url":"Kopioi ja jaa URL"},"action_codes":{"public_topic":"muutettu ketju julkiseksi %{when}","private_topic":"muutettu yksityseksi keskusteluksi %{when}","split_topic":"ketju jaettu %{when}","invited_user":"kutsui käyttäjän %{who} %{when}","invited_group":"kutsuttu käyttäjä %{who} %{when}","user_left":"%{who} poisti itsensä tästä viestistä %{when}","removed_user":"poistettu käyttäjä %{who} %{when}","removed_group":"poistettu käyttäjä %{who} %{when}","autobumped":"nostettu automaattisesti %{when}","autoclosed":{"enabled":"suljettu %{when}","disabled":"avattu %{when}"},"closed":{"enabled":"suljettu %{when}","disabled":"avattu %{when}"},"archived":{"enabled":"arkistoitu %{when}","disabled":"palautettu arkistosta %{when}"},"pinned":{"enabled":"kiinnitetty %{when}","disabled":"kiinnitys poistettu %{when}"},"pinned_globally":{"enabled":"kiinnitetty sivuston laajuisesti %{when}","disabled":"kiinnitys poistettu %{when}"},"visible":{"enabled":"lisätty näkyville %{when}","disabled":"poistettu näkyvistä %{when}"},"banner":{"enabled":"asetettu banneriksi %{when}. Se näytetään jokaisen sivun ylälaidassa, kunnes käyttäjä kuittaa sen nähdyksi.","disabled":"poistettu banneri näkyvistä %{when}. Sitä ei enää näytetä jokaisen sivun ylälaidassa."},"forwarded":"välitetty yllä oleva sähköposti"},"topic_admin_menu":"ketjun toiminnot","wizard_required":"Tervetuloa uuteen Discourseesi! Aloitetaan \u003ca href='%{url}' data-auto-route='true'\u003eohjattu asennus\u003c/a\u003e ✨","emails_are_disabled":"Ylläpitäjä on estänyt kaiken lähtevän sähköpostiliikenteen. Mitään sähköposti-ilmoituksia ei lähetetä.","software_update_prompt":{"message":"Sivusto on juuri päivitetty, \u003cspan\u003epäivitä sivu\u003c/span\u003e, tai sivusto voi käyttäytyä odottamattomasti.","dismiss":"Sulje"},"bootstrap_mode_enabled":{"one":"Jotta sivusto saisi lentävämmän lähdön, olet aloitustilassa. Kaikki käyttäjät nousevat heti luottamustasolle 1, ja päivittäiset sähköpostitiivistelmät kytketään päälle. Tila kytkeytyy pois päältä, kun %{count} käyttäjä on liittynyt.","other":"Jotta sivusto saisi lentävämmän lähdön, olet aloitustilassa. Kaikki käyttäjät nousevat heti luottamustasolle 1, ja päivittäiset sähköpostitiivistelmät kytketään päälle. Tila kytkeytyy pois päältä, kun %{count} käyttäjää on liittynyt."},"bootstrap_mode_disabled":"Aloitustila poistetaan käytöstä seuraavan 24 tunnin aikana.","themes":{"default_description":"Oletus","broken_theme_alert":"Teemassa/komponentissa %{theme} on virheitä, jotka voivat aiheuttaa sen, ettei sivustosi toimi. Voit poistaa sen käytöstä täällä: %{path}."},"s3":{"regions":{"ap_northeast_1":"Aasia ja Tyynimeri (Tokio)","ap_northeast_2":"Aasia ja Tyynimeri (Soul)","ap_east_1":"Aasia ja Tyynimeri (Hongkong)","ap_south_1":"Aasia ja Tyynimeri (Mumbai)","ap_southeast_1":"Aasia ja Tyynimeri (Singapore)","ap_southeast_2":"Aasia ja Tyynimeri (Sydney)","ca_central_1":"Kanada (keskinen)","cn_north_1":"Kiina (Peking)","cn_northwest_1":"Kiina (Ningxia)","eu_central_1":"EU (Frankfurt)","eu_north_1":"EU (Tukholma)","eu_west_1":"EU (Irlanti)","eu_west_2":"EU (Lontoo)","eu_west_3":"EU (Pariisi)","sa_east_1":"Etelä-Amerikka (São Paulo)","us_east_1":"Itäinen USA (Pohjois-Virginia)","us_east_2":"Itäinen USA (Ohio)","us_gov_east_1":"AWS GovCloud (itäinen USA)","us_gov_west_1":"AWS GovCloud (läntinen USA)","us_west_1":"Läntinen USA (Pohjois-Kalifornia)","us_west_2":"Läntinen USA (Oregon)"}},"clear_input":"Tyhjennä sisältö","edit":"muokkaa ketjun otsikkoa ja aluetta","expand":"Laajenna","not_implemented":"Tätä toimintoa ei ole vielä toteutettu, pahoittelut!","no_value":"Ei","yes_value":"Kyllä","submit":"Lähetä","generic_error":"On tapahtunut virhe.","generic_error_with_reason":"Tapahtui virhe: %{error}","sign_up":"Rekisteröidy","log_in":"Kirjaudu","age":"Ikä","joined":"Liittynyt","admin_title":"Ylläpitäjä","show_more":"näytä lisää","show_help":"valinnat","links":"Linkit","links_lowercase":{"one":"linkki","other":"linkkiä"},"faq":"UKK","guidelines":"Ohjeet","privacy_policy":"Tietosuojaseloste","privacy":"Tietosuoja","tos":"Käyttöehdot","rules":"Säännöt","conduct":"Käytännesäännöt","mobile_view":"Mobiilinäkymä","desktop_view":"Työpöytänäkymä","or":"tai","now":"hetki sitten","read_more":"lue lisää","more":"Lisää","x_more":{"one":"%{count} muu","other":"%{count} muuta"},"never":"ei koskaan","every_30_minutes":"30 minuutin välein","every_hour":"tunnin välein","daily":"päivittäin","weekly":"viikottain","every_month":"kuukausittain","every_six_months":"kuuden kuukauden välein","max_of_count":"korkeintaan %{count}","character_count":{"one":"%{count} merkki","other":"%{count} merkkiä"},"related_messages":{"title":"Aiheeseen liittyviä viestejä","see_all":"Katso \u003ca href=\"%{path}\"\u003ekaikki viestit\u003c/a\u003e käyttäjältä @%{username}..."},"suggested_topics":{"title":"Ehdotettuja ketjuja","pm_title":"Viestiehdotuksia"},"about":{"simple_title":"Tietoa","title":"Tietoja kohteesta %{title}","stats":"Sivuston tilastot","our_admins":"Ylläpitäjät","our_moderators":"Valvojat","moderators":"Valvojat","stat":{"all_time":"Yhteensä","last_day":"Viimeiset 24 tuntia","last_7_days":"Viimeiset 7 päivää","last_30_days":"Viimeiset 30 päivää"},"like_count":"Tykkäyksiä","topic_count":"Ketjuja","post_count":"Viestejä","user_count":"Käyttäjiä","active_user_count":"Aktiivisia käyttäjiä","contact":"Ota yhteyttä","contact_info":"Sivustoon liittyvissä kiireellisissä asioissa, ota yhteyttä osoitteeseen %{contact_info}."},"bookmarked":{"title":"Kirjanmerkki","edit_bookmark":"Muokkaa kirjanmerkkiä","clear_bookmarks":"Tyhjennä kirjanmerkit","help":{"bookmark":"Klikkaa lisätäksesi ketjun ensimmäisen viestin kirjanmerkkeihin","edit_bookmark":"Klikkaa muokataksesi tämän ketjun kirjanmerkkiä","unbookmark":"Klikkaa poistaaksesi kaikki tämän ketjun kirjanmerkit","unbookmark_with_reminder":"Klikkaa poistaaksesi kaikki tämän ketjun kirjanmerkit ja muistutukset."}},"bookmarks":{"created":"Olet kirjanmerkinnyt tämän viestin. %{name}","not_bookmarked":"lisää viesti kirjanmerkkeihin","created_with_reminder":"Olet kirjanmerkinnyt tämän viestin muistutuksen kera %{date}. %{name}","remove":"Poista kirjanmerkki","delete":"Poista kirjanmerkki","confirm_delete":"Oletko varma, että haluat poistaa tämän kirjanmerkin? Muistutus poistetaan myös.","confirm_clear":"Haluatko varmasti poistaa kaikki kirjanmerkkisi tästä ketjusta?","save":"Tallenna","no_timezone":"Et ole valinnut aikavyöhykettä, joten et voi asettaa muistutuksia. Aseta se \u003ca href=\"%{basePath}/my/preferences/profile\"\u003eprofiilisivullasi\u003c/a\u003e.","invalid_custom_datetime":"Antamasi päivämäärä ja kellonaika ei kelpaa, yritä uudelleen.","list_permission_denied":"Et voi nähdä tämän käyttäjän kirjanmerkkejä.","no_user_bookmarks":"Kirjanmerkeissäsi ei ole mitään. Kirjanmerkitsemällä viestin löydät sen myöhemmin helposti.","auto_delete_preference":{"label":"Poista automaattisesti","never":"Ei koskaan","when_reminder_sent":"Kun muistutus on lähetetty","on_owner_reply":"Kun olen vastannut tähän ketjuun"},"search_placeholder":"Hae kirjanmerkkejä nimen, ketjun otsikon tai viestin sisällön perusteella","search":"Haku","reminders":{"today_with_time":"tänään klo %{time}","tomorrow_with_time":"huomenna klo %{time}","at_time":"%{date_time}","existing_reminder":"Olet pyytänyt muistutuksen tästä kirjanmerkistä, joka lähetetään %{at_date_time}"}},"copy_codeblock":{"copied":"kopioitiin!"},"drafts":{"label":"Luonnokset","resume":"Jatka","remove":"Poista","remove_confirmation":"Haluatko varmasti poistaa luonnoksen?","new_topic":"Uusi ketjuluonnos","topic_reply":"Vastausluonnos","abandon":{"confirm":"Sinulla on meneillään luonnos tätä ketjua varten. Mitä haluaisit tehdä sen kanssa?","yes_value":"Hylkää","no_value":"Jatka muokkausta"}},"topic_count_latest":{"one":"Katso %{count} uusi tai päivitetty ketju","other":"Katso %{count} uutta tai päivitettyä ketjua"},"topic_count_unseen":{"one":"Katso %{count} uusi tai päivitetty ketju","other":"Katso %{count} uutta tai päivitettyä ketjua"},"topic_count_unread":{"one":"Näytä %{count} lukematon ketju","other":"Näytä %{count} lukematonta ketjua"},"topic_count_new":{"one":"Näytä %{count} uusi ketju","other":"Näytä %{count} uutta ketjua"},"preview":"esikatselu","cancel":"peruuta","deleting":"Poistetaan...","save":"Tallenna muutokset","saving":"Tallennetaan...","saved":"Tallennettu!","upload":"Lataa","uploading":"Ladataan...","uploading_filename":"Ladataan: %{filename}","processing_filename":"Käsitellään: %{filename}...","clipboard":"leikepöytä","uploaded":"Ladattu!","pasting":"Liitetään...","enable":"Ota käyttöön","disable":"Poista käytöstä","continue":"Jatka","undo":"Kumoa","revert":"Palauta","failed":"Epäonnistui","switch_to_anon":"Siirry anonyymitilaan","switch_from_anon":"Poistu anonyymitilasta","banner":{"close":"Sulje tämä banneri.","edit":"Muokkaa banneria \u003e\u003e"},"pwa":{"install_banner":"Haluatko \u003ca href\u003easentaa kohteen %{title} tälle laitteelle?\u003c/a\u003e"},"choose_topic":{"none_found":"Ketjuja ei löytynyt.","title":{"search":"Hae ketjua","placeholder":"Syötä ketjun otsikko, url tai tunnus tähän"}},"choose_message":{"none_found":"Viestejä ei löytynyt.","title":{"search":"Hae viestiä","placeholder":"Syötä viestin otsikko, url tai tunnus tähän"}},"review":{"order_by":"Järjestä","in_reply_to":"vastauksena:","explain":{"why":"selitä miksi tämä päätyi jonoon","title":"Käsittelypisteytys","formula":"Kaava","subtotal":"Välisumma","total":"Yhteensä","min_score_visibility":"Näkymisen vähimmäispistemäärä","score_to_hide":"Pistemäärä, joka piilottaa viestin","take_action_bonus":{"name":"teki toimenpiteen","title":"Kun henkilökunnnan jäsen tekee toimenpiteen, merkintä saa bonuksen."},"user_accuracy_bonus":{"name":"käyttäjän tarkkuus","title":"Käyttäjät, joiden aiemmista merkinnöistä on oltu samaa, mieltä saavat bonuksen."},"trust_level_bonus":{"name":"luottamustaso","title":"Korkeampien luottamustasojen käyttäjien luomat käsiteltävät kohteet saavat korkeammat pisteet."},"type_bonus":{"name":"tyyppibonus","title":"Henkilökunta voi määrittää tietyille käsiteltävälle tyypeille bonuksen, jotta ne saavat korkeamman prioriteetin."}},"claim_help":{"optional":"Voit osoittaa tämän kohteen itsellesi, jolloin muut eivät voi käsitellä sitä.","required":"Sinun täytyy osoittaa kohde itsellesi, ennen kuin voit käsitellä sen.","claimed_by_you":"Osoitit tämän itsellesi ja voit nyt käsitellä sen.","claimed_by_other":"Tämän voi käsitellä vain \u003cb\u003e%{username}\u003c/b\u003e."},"claim":{"title":"osoita ketju itsellesi"},"unclaim":{"help":"peru osoitus"},"awaiting_approval":"Odottaa hyväksyntää","delete":"Poista","settings":{"saved":"Tallennettu","save_changes":"Tallenna muutokset","title":"Asetukset","priorities":{"title":"Käsittelyprioriteetit"}},"moderation_history":"Valvontahistoria","view_all":"Katso kaikki","grouped_by_topic":"Ryhmitelty ketjun mukaan","none":"Ei käsiteltäviä kohteita.","view_pending":"näytä odottavat","topic_has_pending":{"one":"\u003cb\u003e%{count}\u003c/b\u003e viesti tähän ketjuun odottaa hyväksyntää","other":"\u003cb\u003e%{count}\u003c/b\u003e viestiä tähän ketjuun odottaa hyväksyntää"},"title":"Käsittele","topic":"Ketju:","filtered_topic":"Olet suodattanut käsiteltävän sisällön yhdestä ketjusta.","filtered_user":"Käyttäjä","filtered_reviewed_by":"Käsittelijä:","show_all_topics":"näytä kaikki ketjut","deleted_post":"(viesti poistettu)","deleted_user":"(käyttäjä poistettu)","user":{"bio":"Käyttäjätiedot","website":"Verkkosivusto","username":"Käyttäjätunnus","email":"Sähköposti","name":"Nimi","fields":"Kentät","reject_reason":"Syy"},"user_percentage":{"summary":{"one":"%{agreed}, %{disagreed}, %{ignored} (edellisestä merkinnästä)","other":"%{agreed}, %{disagreed}, %{ignored} (edellisistä %{count} merkinnästä)"},"agreed":{"one":"%{count}% samaa mieltä","other":"%{count}% samaa mieltä"},"disagreed":{"one":"%{count}% eri mieltä","other":"%{count}% eri mieltä"},"ignored":{"one":"%{count}% sivuutettu","other":"%{count}% sivuutettu"}},"topics":{"topic":"Ketju","reviewable_count":"Lukumäärä","reported_by":"Ilmoittaja","deleted":"[Ketju poistettu]","original":"(alkuperäinen ketju)","details":"tiedot","unique_users":{"one":"%{count} käyttäjä","other":"%{count} käyttäjää"}},"replies":{"one":"%{count} vastaus","other":"%{count} vastausta"},"edit":"Muokkaa","save":"Tallenna","cancel":"Peruuta","new_topic":"Tämän kohteen hyväksyminen aloittaa uuden ketjun","filters":{"all_categories":"(kaikki luokat)","type":{"title":"Tyyppi","all":"(kaikki tyypit)"},"minimum_score":"Vähimmäispisteet:","refresh":"Päivitä","status":"Tila","category":"Alue","orders":{"score":"Arvo","score_asc":"Arvo (käänteinen)","created_at":"Luotu","created_at_asc":"Luotu (käänteinen)"},"priority":{"title":"Vähimmäisprioriteetti","any":"(kaikki)","low":"Matala","medium":"Keskitaso","high":"Korkea"}},"conversation":{"view_full":"katso koko keskustelu"},"scores":{"about":"Pisteet perustuvat ilmoittajan luottamustasoon, heidän aiempien merkintöjen osuvuuteen ja ilmitetun kohteen prioriteettiin.","score":"Arvo","date":"Päivämäärä","type":"Tyyppi","status":"Tila","submitted_by":"Lähettäjä","reviewed_by":"Käsittelijä"},"statuses":{"pending":{"title":"Odottaa"},"approved":{"title":"Hyväksytty"},"rejected":{"title":"Hylätty"},"ignored":{"title":"Sivuutettu"},"deleted":{"title":"Poistettu"},"reviewed":{"title":"(kaikki käsitellyt)"},"all":{"title":"(kaikki)"}},"types":{"reviewable_flagged_post":{"title":"Merkitty viesti","flagged_by":"Merkinnän tekijä"},"reviewable_queued_topic":{"title":"Jonossa oleva ketju"},"reviewable_queued_post":{"title":"Jonossa oleva viesti"},"reviewable_user":{"title":"Käyttäjä"},"reviewable_post":{"title":"Viesti"}},"approval":{"title":"Viesti odottaa hyväksyntää","description":"Viestisi saapui perille, mutta valvojan on vielä hyväksyttävä se, jotta se näkyy sivustolla. Ole kärsivällinen.","pending_posts":{"one":"Jonossa on \u003cstrong\u003e%{count}\u003c/strong\u003e viesti.","other":"Jonossa on \u003cstrong\u003e%{count}\u003c/strong\u003e viestiä."},"ok":"OK"},"example_username":"käyttäjätunnus","reject_reason":{"title":"Miksi olet hylkäämässä tämän käyttäjän?","send_email":"Lähetä sähköposti hylkäämisestä"}},"relative_time_picker":{"minutes":{"one":"minuutti","other":"minuuttia"},"hours":{"one":"tunti","other":"tuntia"},"days":{"one":"päivä","other":"päivää"},"months":{"one":"kuukausi","other":"kuukautta"},"years":{"one":"vuosi","other":"vuotta"},"relative":"Suhteellinen"},"time_shortcut":{"later_today":"Myöhemmin tänään","next_business_day":"Seuraavana arkipäivänä","tomorrow":"Huomenna","post_local_date":"Päivämäärä viestissä","later_this_week":"Myöhemmin tällä viikolla","this_weekend":"Viikonloppuna","start_of_next_business_week":"Maanantaina","start_of_next_business_week_alt":"Seuraavana maanantaina","two_weeks":"Kaksi viikkoa","next_month":"Ensi kuussa","six_months":"Kuusi kuukautta","custom":"Mukautettu päivämäärä ja aika","relative":"Suhteellinen aika","none":"Ei vaadittu","last_custom":"Viimeisin mukautettu päivämäärä"},"user_action":{"user_posted_topic":"\u003ca href='%{userUrl}'\u003e%{user}\u003c/a\u003e kirjoitti \u003ca href='%{topicUrl}'\u003eketjuun\u003c/a\u003e","you_posted_topic":"\u003ca href='%{userUrl}'\u003eSinä\u003c/a\u003e kirjoitit \u003ca href='%{topicUrl}'\u003eketjuun\u003c/a\u003e","user_replied_to_post":"\u003ca href='%{userUrl}'\u003e%{user}\u003c/a\u003e vastasi \u003ca href='%{postUrl}'\u003e%{post_number}\u003c/a\u003e","you_replied_to_post":"\u003ca href='%{userUrl}'\u003eSinä\u003c/a\u003e vastasit \u003ca href='%{postUrl}'\u003e%{post_number}\u003c/a\u003e","user_replied_to_topic":"\u003ca href='%{userUrl}'\u003e%{user}\u003c/a\u003e vastasi \u003ca href='%{topicUrl}'\u003eketjuun\u003c/a\u003e","you_replied_to_topic":"\u003ca href='%{userUrl}'\u003eSinä\u003c/a\u003e vastasit \u003ca href='%{topicUrl}'\u003eketjuun\u003c/a\u003e","user_mentioned_user":"\u003ca href='%{user1Url}'\u003e%{user}\u003c/a\u003e mainitsi käyttäjän \u003ca href='%{user2Url}'\u003e%{another_user}\u003c/a\u003e","user_mentioned_you":"\u003ca href='%{user1Url}'\u003e%{user}\u003c/a\u003e mainitsi \u003ca href='%{user2Url}'\u003esinut\u003c/a\u003e","you_mentioned_user":"\u003ca href='%{user1Url}'\u003eSinä\u003c/a\u003e mainitsit käyttäjän \u003ca href='%{user2Url}'\u003e%{another_user}\u003c/a\u003e","posted_by_user":"Kirjoittaja: \u003ca href='%{userUrl}'\u003e%{user}\u003c/a\u003e","posted_by_you":"\u003ca href='%{userUrl}'\u003eSinun\u003c/a\u003e kirjoittamasi","sent_by_user":"Lähettäjä: \u003ca href='%{userUrl}'\u003e%{user}\u003c/a\u003e","sent_by_you":"\u003ca href='%{userUrl}'\u003eSinun\u003c/a\u003e lähettämäsi"},"directory":{"username":"Käyttäjätunnus","filter_name":"suodata käyttäjänimen perusteella","title":"Käyttäjät","likes_given":"Annetut","likes_received":"Saadut","topics_entered":"Katsellut","topics_entered_long":"Katseltuja ketjuja","time_read":"Lukuaika","topic_count":"Ketjut","topic_count_long":"Ketjunaloituksia","post_count":"Vastauksia","post_count_long":"Kirjoitettuja vastauksia","no_results":"Ei tuloksia.","days_visited":"Vierailut","days_visited_long":"Vierailupäiviä","posts_read":"Luetut","posts_read_long":"Luettuja viestejä","last_updated":"Viimeksi päivitetty:","total_rows":{"one":"%{count} käyttäjä","other":"%{count} käyttäjää"},"edit_columns":{"title":"Muokkaa hakemiston sarakkeita","save":"Tallenna","reset_to_default":"Palauta oletus"},"group":{"all":"kaikki ryhmät"}},"group_histories":{"actions":{"change_group_setting":"Muuta ryhmän asetusta","add_user_to_group":"Lisää käyttäjä","remove_user_from_group":"Poista käyttäjä","make_user_group_owner":"Myönnä isännyys","remove_user_as_group_owner":"Peru isännyys"}},"groups":{"member_added":"Lisättiin","member_requested":"Pyydetty","add_members":{"title":"Lisää käyttäjiä ryhmään %{group_name}","description":"Anna luettelo käyttäjistä, jotka haluat kutsua ryhmään, tai liitä pilkuilla erotettu luettelo:","usernames_placeholder":"käyttäjätunnukset","usernames_or_emails_placeholder":"käyttäjätunnukset tai sähköpostiosoitteet","notify_users":"Ilmoita käyttäjille","set_owner":"Aseta käyttäjiä tämän ryhmän omistajiksi"},"requests":{"title":"Pyynnöt","reason":"Syy","accept":"Hyväksy","accepted":"hyväksyi","deny":"Hylkää","denied":"hylättiin","undone":"pyyntö peruttu","handle":"käsittele jäsenhakemus"},"manage":{"title":"Hallitse","name":"Nimi","full_name":"Koko nimi","add_members":"Lisää käyttäjiä","invite_members":"Kutsu","delete_member_confirm":"Poistetaanko '%{username}' ryhmästä '%{group}'?","profile":{"title":"Profiili"},"interaction":{"title":"Vuorovaikutus","posting":"Kirjoittaminen","notification":"Ilmoitus"},"email":{"title":"Sähköposti","status":"Synkronoitu %{old_emails}/%{total_emails} viestiä IMAP:n kautta.","enable_smtp":"Ota SMTP käyttöön","enable_imap":"Ota IMAP käyttöön","test_settings":"Testaa asetukset","save_settings":"Tallenna asetukset","last_updated":"Viimeksi päivitetty:","last_updated_by":"käyttäjä","settings_required":"Kaikki asetukset ovat pakollisia, täytä kaikki kentät ennen vahvistamista.","smtp_settings_valid":"SMTP-asetukset ovat kelvollisia.","smtp_title":"SMTP","smtp_instructions":"Kun otat SMTP:n käyttöön ryhmälle, kaikki ryhmän postilaatikosta lähetetyt sähköpostit lähetetään tässä määritettyjen SMTP-asetusten kautta muille foorumisi lähettämille sähköposteille määritetyn postipalvelimen sijasta.","imap_title":"IMAP","imap_additional_settings":"Lisäasetukset","imap_instructions":"Kun otat IMAPin käyttöön ryhmälle, sähköpostit synkronoidaan ryhmän postilaatikon ja annetun IMAP-palvelimen ja postilaatikon välillä. SMTP täytyy olla käytössä kelvollisilla ja testatuilla tunnistetiedoilla, ennen kuin IMAP voidaan ottaa käyttöön. SMTP:ssä käytettyä sähköpostiosoitetta ja salasanaa käytetään IMAPissa. Katso lisätietoja \u003ca target=\"_blank\" href=\"https://meta.discourse.org/t/imap-support-for-group-inboxes/160588\"\u003eominaisuusilmoituksessa Discourse Metassa\u003c/a\u003e.","imap_alpha_warning":"Varoitus: Tämä on alfavaiheen ominaisuus. Vain Gmailia tuetaan virallisesti. Käytä omalla vastuullasi!","imap_settings_valid":"IMAP-asetukset ovat kelvollisia.","smtp_disable_confirm":"Jos poistat SMTP:n käytöstä, kaikki SMTP- ja IMAP-asetukset nollataan, ja niihin liittyvät toiminnot poistetaan käytöstä. Oletko varma, että haluat jatkaa?","imap_disable_confirm":"Jos poistat IMAPin käytöstä, kaikki IMAP-asetukset nollataan, ja niihin liittyvät toiminnot poistetaan käytöstä. Oletko varma, että haluat jatkaa?","imap_mailbox_not_selected":"Sinun täytyy valita postilaatikko tälle IMAP-määritykselle, muuten postilaatikoita ei synkronoida!","prefill":{"title":"Esitäyttö asetuksilla:","gmail":"Gmail"},"credentials":{"title":"Tunnistetiedot","smtp_server":"SMTP-palvelin","smtp_port":"SMTP-portti","smtp_ssl":"Käytä SSL-salausta SMTP:lle","imap_server":"IMAP-palvelin","imap_port":"IMAP-portti","imap_ssl":"Käytä SSL-salausta IMAP:lle","username":"Käyttäjätunnus","password":"Salasana"},"settings":{"title":"Asetukset","allow_unknown_sender_topic_replies":"Salli tuntemattomien lähettäjien vastaukset ketjuun.","allow_unknown_sender_topic_replies_hint":"Salli tuntemattomien lähettäjien vastata ryhmän ketjuihin. Jos tämä ei ole käytössä, vastaukset sähköpostiosoitteista, joita ei ole kutsuttu ketjuun, luovat uuden ketjun."},"mailboxes":{"synchronized":"Synkronoitu postilaatikko","none_found":"Tältä sähköpostitililtä ei löytynyt postilaatikoita.","disabled":"Pois käytöstä"}},"membership":{"title":"Jäsenyys","access":"Pääsy"},"categories":{"title":"Alueet","long_title":"Alueen oletusilmoitustaso","description":"Kun käyttäjä lisätään tähän ryhmään, hänen ilmoitustasoasetuksensa asetetaan automaattisesti näiden oletusarvojen mukaisiksi. Hän voi muokata arvoja jälkikäteen.","watched_categories_instructions":"Tarkkaile kaikkia ketjuja näillä alueilla. Ryhmän jäsenet saavat ilmoituksen kaikista uusista viesteistä ja ketjunaloituksista, ja uusien viestien määrät myös näkyvät ketjujen yhteydessä.","tracked_categories_instructions":"Seuraa kaikkia ketjuja näillä alueilla. Uusien viestien määrät näkyvät ketjujen yhteydessä.","watching_first_post_categories_instructions":"Käyttäjät saavat ilmoituksen näiden alueiden ketjujen ensimmäisistä viesteistä.","regular_categories_instructions":"Jos nämä alueet on vaimennettu, vaimennus perutaan ryhmän jäseniltä. Käyttäjälle ilmoitetaan, jos hänet mainitaan tai joku vastaa hänelle.","muted_categories_instructions":"Käyttäjille ei ilmoiteta millään lailla näiden alueiden uusista ketjuista, eikä niitä näytetä Alueet- eikä Tuoreimmat-listauksissa."},"tags":{"title":"Tunnisteet","long_title":"Tunnisteiden oletusilmoitukset","description":"Kun käyttäjiä lisätään tähän ryhmään, heidän ilmoitusasetukset tunnisteille asetetaan näihin oletusasetuksiin. He voivat muuttaa niitä itse myöhemmin.","watched_tags_instructions":"Aseta automaattisesti kaikki ketjut tarkkailuun näillä tunnisteilla. Ryhmän jäsenet saavat ilmoitukset kaikista uusista viesteistä ja ketjuista sekä uusien viestien lukumäärä näytetään ketjun otsikon vieressä.","tracked_tags_instructions":"Ketjut, joilla on joku näistä tunnisteista, asetetaan automaattisesti seurantaan. Uusien viestien lukumäärä näytetään ketjun otsikon vieressä.","watching_first_post_tags_instructions":"Käyttäjät saavat ilmoituksen jokaisen uuden ketjun ensimmäisestä viestistä näillä tunnisteilla.","regular_tags_instructions":"Jos nämä tunnisteet vaimennetaan, niiden vaimennus poistuu ryhmän jäseniltä. Käyttäjät saavat ilmoitukset, jos heidät mainitaan tai joku vastaa heille.","muted_tags_instructions":"Käyttäjille ei ilmoiteta uusista ketjuista näillä tunnisteilla, eikä niitä näytetä Tuoreimmat-listauksessa."},"logs":{"title":"Lokit","when":"Milloin","action":"Toimi","acting_user":"Toimija","target_user":"Kohdekäyttäjä","subject":"Aihe","details":"Tiedot","from":"Alkaen","to":"Päättyen"}},"permissions":{"title":"Oikeudet","none":"Tähän ryhmään ei ole liitetty alueita.","description":"Tämän ryhmän jäsenet voivat käyttää näitä alueita"},"public_admission":"Salli käyttäjien liittyä ryhmään vapaasti (ryhmän täytyy olla julkinen)","public_exit":"Salli käyttäjien poistua ryhmästä vapaasti","empty":{"posts":"Ryhmän jäsenet eivät ole lähettäneet viestejä.","members":"Ryhmässä ei ole jäseniä.","requests":"Tälle ryhmälle ei ole jäsenhakemuksia.","mentions":"Ryhmää ei ole mainittu.","messages":"Ryhmälle ei ole viestejä.","topics":"Ryhmän jäsenet eivät ole aloittaneet ketjuja.","logs":"Ryhmällä ei ole lokitietoja."},"add":"Lisää","join":"Liity","leave":"Poistu","request":"Pyyntö","message":"Viesti","confirm_leave":"Haluatko varmasti poistua ryhmästä?","allow_membership_requests":"Salli käyttäjän lähettää jäsenhakemuksia ryhmien isännille (Vaatii sen, että ryhmä on julkinen)","membership_request_template":"Mukautettu viestipohja, joka näytetään käyttäjälle, kun hän lähettää jäsenhakemusta ryhmään.","membership_request":{"submit":"Lähetä hakemus","title":"Hakemus ryhmään @%{group_name}","reason":"Kerro ryhmän isännille, miksi kuulut tähän ryhmään"},"membership":"Jäsenyys","name":"Nimi","group_name":"Ryhmän nimi","user_count":"Käyttäjät","bio":"Tietoa ryhmästä","selector_placeholder":"syötä käyttäjätunnus","owner":"isäntä","index":{"title":"Ryhmät","all":"Kaikki ryhmät","empty":"Näkyvillä olevia ryhmiä ei ole.","filter":"Suodata ryhmän tyypin mukaan","owner_groups":"Ryhmät, joita isännöin","close_groups":"Suljetut ryhmät","automatic_groups":"Automaattiset ryhmät","automatic":"Automaattinen","closed":"Suljettu","public":"Julkinen","private":"Yksityinen","public_groups":"Julkiset ryhmät","my_groups":"Omat ryhmät","group_type":"Ryhmän tyyppi","is_group_user":"Jäsen","is_group_owner":"Isäntä"},"title":{"one":"Ryhmä","other":"Ryhmät"},"activity":"Toiminta","members":{"title":"Jäsenet","filter_placeholder_admin":"käyttäjätunnus tai sähköpostiosoite","filter_placeholder":"käyttäjätunnus","remove_member":"Poista jäsen","remove_member_description":"Poista \u003cb\u003e%{username}\u003c/b\u003e ryhmästä","make_owner":"Myönnä isännyys","make_owner_description":"Tee käyttäjästä \u003cb\u003e%{username}\u003c/b\u003e ryhmän isäntä","remove_owner":"Peru isännyys","remove_owner_description":"Peru käyttäjältä \u003cb\u003e%{username}\u003c/b\u003e ryhmän isännyys","make_primary":"Aseta ensisijaiseksi","make_primary_description":"Aseta tämä käyttäjän \u003cb\u003e%{username}\u003c/b\u003e ensisijaiseksi ryhmäksi","remove_primary":"Poista ensisijainen ryhmä","remove_primary_description":"Poista tämä käyttäjän \u003cb\u003e%{username}\u003c/b\u003e ensisijaisesta ryhmästä","remove_members":"Poista jäsenet","remove_members_description":"Poista valitut käyttäjät tästä ryhmästä","make_owners":"Aseta isännäksi","make_owners_description":"Aseta valitut käyttäjät ryhmän isänniksi","remove_owners":"Poista isännät","remove_owners_description":"Poista valitut käyttäjät ryhmän isännistä","make_all_primary":"Aseta kaikille ensisijaiseksi","make_all_primary_description":"Aseta tämä ryhmä ensisijaiseksi kaikille valituille käyttäjille","remove_all_primary":"Poista kaikilta ensisijaisuus","remove_all_primary_description":"Poista tämä ryhmä kaikilta ensisijaisena ryhmänä","owner":"Isäntä","primary":"Ensisijainen","forbidden":"Et voi tarkastella jäseniä."},"topics":"Ketjut","posts":"Viestit","mentions":"Maininnat","messages":"Viestit","notification_level":"Ryhmäviestien oletusilmoitustaso","alias_levels":{"mentionable":"Ketkä voivat @mainita ryhmän?","messageable":"Ketkä voivat lähettää ryhmälle viestin?","nobody":"Ei kukaan","only_admins":"Vain ylläpitäjät","mods_and_admins":"Vain ylläpitäjät ja valvojat","members_mods_and_admins":"Vain ryhmän jäsenet, valvojat ja ylläpitäjät","owners_mods_and_admins":"Vain ryhmän isännät, valvojat ja ylläpito","everyone":"Kaikki"},"notifications":{"watching":{"title":"Tarkkailussa","description":"Saat ilmoituksen uusista viesteistä jokaisessa viestiketjussa, ja uusien vastausten lukumäärä näytetään."},"watching_first_post":{"title":"Tarkkaillaan ensimmäistä viestiä","description":"Saat ilmoituksen uusista ryhmän viesteistä, muttet vastauksista niihin."},"tracking":{"title":"Seurannassa","description":"Saat ilmoituksen, jos joku mainitsee @nimesi tai vastaa sinulle, ja uusien vastausten lukumäärä näytetään."},"regular":{"title":"Tavallinen","description":"Saat ilmoituksen, jos joku mainitsee @nimesi tai vastaa sinulle."},"muted":{"title":"Vaimennettu","description":"Et saa ilmoituksia ryhmän viesteistä."}},"flair_url":"Avatarpinssin kuva","flair_upload_description":"Käytä neliönmuotoisia kuvia, joiden koko on vähintään 20px kertaa 20px.","flair_bg_color":"Avatarpinssin taustaväri","flair_bg_color_placeholder":"(Valinnainen) hex-väriarvo","flair_color":"Avatarpinssin väri","flair_color_placeholder":"(Valinnainen) hex-väriarvo","flair_preview_icon":"Kuvakkeen esikatselu","flair_preview_image":"Kuvan esikatselu","flair_type":{"icon":"Valitse kuvake","image":"Lataa kuva"},"default_notifications":{"modal_description":"Haluatko tämän muutoksen vaikuttavan takautuvasti? Tämä muuttaa kaikkien %{count} olemassa olevan käyttäjän asetusta.","modal_yes":"Kyllä","modal_no":"Ei, käytä muutosta vain jatkossa"}},"user_action_groups":{"1":"Tykkäykset","2":"Tykkäykset","3":"Kirjanmerkit","4":"Ketjut","5":"Vastaukset","6":"Vastaukset","7":"Maininnat","9":"Lainaukset","11":"Muokkaukset","12":"Lähetetyt","13":"Postilaatikko","14":"Odottaa","15":"Luonnokset"},"categories":{"all":"kaikki alueet","all_subcategories":"kaikki","no_subcategory":"ei mitään","category":"Alue","category_list":"Näytä alueluettelo","reorder":{"title":"Järjestä alueet uudelleen","title_long":"Järjestä alueluettelo uudelleen","save":"Tallenna järjestys","apply_all":"Käytä","position":"Sijoitus"},"posts":"Viestit","topics":"Ketjut","latest":"Tuoreimmat","subcategories":"Ala-alueet","muted":"Vaimennetut alueet","topic_sentence":{"one":"%{count} ketju","other":"%{count} ketjua"},"topic_stat":{"one":"%{number} / %{unit}","other":"%{number} / %{unit}"},"topic_stat_unit":{"week":"viikko","month":"kuukausi"},"topic_stat_all_time":{"one":"%{number} yhteensä","other":"%{number} yhteensä"},"topic_stat_sentence_week":{"one":"%{count} uusi ketju viimeisimmän viikon aikana.","other":"%{count} uutta ketjua viimeisimmän viikon aikana."},"topic_stat_sentence_month":{"one":"%{count} uusi ketju viimeisimmän kuukauden aikana.","other":"%{count} uutta ketjua viimeisimmän kuukauden aikana."},"n_more":"Alueet (%{count} muuta)..."},"ip_lookup":{"title":"IP-osoitteen haku","hostname":"Isäntänimi","location":"Sijainti","location_not_found":"(tuntematon)","organisation":"Organisaatio","phone":"Puhelin","other_accounts":"Muut tilit samasta IP-osoitteesta:","delete_other_accounts":"Poista %{count}","username":"käyttäjätunnus","trust_level":"LT","read_time":"lukuaika","topics_entered":"katseltuja ketjuja","post_count":"# viestiä","confirm_delete_other_accounts":"Oletko varma, että haluat poistaa nämä tilit?","powered_by":"\u003ca href='https://maxmind.com'\u003eMaxMindDB\u003c/a\u003e:n avulla","copied":"kopioitu"},"user_fields":{"none":"(valitse vaihtoehto)","required":"\"%{name}\" on pakollinen"},"user":{"said":"%{username}:","profile":"Profiili","mute":"Vaimenna","edit":"Muokkaa asetuksia","download_archive":{"button_text":"Lataa kaikki","confirm":"Haluatko varmasti ladata viestisi?","success":"Lataus aloitettu. Saat ilmoituksen yksityisviestinä, kun prosessi on valmis.","rate_limit_error":"Viestit voi ladata kerran vuorokaudessa. Yritä huomenna uudelleen."},"new_private_message":"Uusi viesti","private_message":"Viesti","private_messages":"Viestit","user_notifications":{"filters":{"filter_by":"Suodata","all":"Kaikki","read":"Luetut","unread":"Lukemattomat"},"ignore_duration_title":"Sivuuta käyttäjä","ignore_duration_username":"Käyttäjätunnus","ignore_duration_when":"Kesto:","ignore_duration_save":"Sivuuta","ignore_duration_note":"Huomioi että sivuutukset poistuvat automaattisesti, kun sivuutuksen kesto päättyy.","ignore_duration_time_frame_required":"Valitse ajanjakso","ignore_no_users":"Et ole sivuuttanut ketään.","ignore_option":"Sivuutettu","ignore_option_title":"Et saa käyttäjään liittyviä ilmoituksia, ja kaikki hänen aloittamansa ketjut ja vastaukset piilotetaan.","add_ignored_user":"Lisää...","mute_option":"Vaimennettu","mute_option_title":"Et saa tähän käyttäjään liittyviä ilmoituksia.","normal_option":"Normaali","normal_option_title":"Saat ilmoituksen, jos käyttäjä vastaa sinulle, lainaa sinua tai mainitsee sinut."},"notification_schedule":{"title":"Ilmoitusten aikataulu","label":"Aseta mukautettu ilmoitusten aikataulu","tip":"Näiden aikojen ulkopuolella sinut asetetaan automaattisesti Älä häiritse -tilaan.","midnight":"Keskiyö","none":"Ei mitään","monday":"Maanantai","tuesday":"Tiistai","wednesday":"Keskiviikko","thursday":"Torstai","friday":"Perjantai","saturday":"Lauantai","sunday":"Sunnuntai","to":"-"},"activity_stream":"Toiminta","read":"Luetut","read_help":"Äskettäin luetut ketjut","preferences":"Asetukset","feature_topic_on_profile":{"open_search":"Valitse uusi ketju","title":"Valitse ketju","search_label":"Hae ketjua nimellä","save":"Tallenna","clear":{"title":"Tyhjennä","warning":"Haluatko varmasti nollata valikoimasi ketjun?"}},"use_current_timezone":"Käytä nykyistä aikavyöhykettäni","profile_hidden":"Käyttäjän julkinen profiili ei ole nähtävillä.","expand_profile":"Laajenna","collapse_profile":"Supista","bookmarks":"Kirjanmerkit","bio":"Tietoa minusta","timezone":"Aikavyöhyke","invited_by":"Kutsuja","trust_level":"Luottamustaso","notifications":"Ilmoitukset","statistics":"Tilastot","desktop_notifications":{"label":"Live-ilmoitukset","not_supported":"Tämä selain ei tue ilmoituksia, pahoittelut.","perm_default":"Näytä ilmoituksia","perm_denied_btn":"Ei oikeuksia","perm_denied_expl":"Olet kieltänyt ilmoitukset. Salli ilmoitukset selaimesi asetuksista.","disable":"Poista ilmoitukset käytöstä","enable":"Näytä ilmoituksia","each_browser_note":"Huomautus: Tätä asetusta on muutettava jokaisessa käyttämässäsi selaimessa. Kaikki ilmoitukset poistetaan käytöstä, kun ”älä häiritse” -tila on käytössä riippumatta tästä asetuksesta.","consent_prompt":"Haluatko reaaliaikaisia ilmoituksia, kun ihmiset vastaavat viesteihisi?"},"dismiss":"Kuittaa","dismiss_notifications":"Kuittaa kaikki","dismiss_notifications_tooltip":"Merkitse kaikki lukemattomat ilmoitukset luetuiksi","no_messages_title":"Sinulla ei ole viestejä","no_messages_body":"Haluatko suoraa henkilökohtaista keskustelua jonkun kanssa normaalin keskusteluvirran ulkopuolella? Lähetä hänelle viesti napsauttamalla hänen profiilikuvaansa ja käyttämällä viestipainiketta %{icon}.\u003cbr\u003e\u003cbr\u003e Jos tarvitset apua, voit \u003ca href='%{aboutUrl}'\u003elähettää viestin henkilökunnan jäsenelle\u003c/a\u003e.\n","no_bookmarks_title":"Et ole vielä lisännyt mitään kirjanmerkkeihin","no_bookmarks_body":"Aloita kirjanmerkkien lisääminen painikkeella %{icon} ja ne listataan tähän helposti löydettäväksi. Voit ajastaa myös muistutuksen!\n","no_bookmarks_search":"Kirjanmerkkejä ei löytynyt näillä hakusanoilla.","no_notifications_title":"Sinulla ei ole vielä ilmoituksia","no_notifications_body":"Tässä paneelissa näytetään ilmoituksia sinulle relevantista toiminnasta, kuten omien ketjujesi viestit ja vastaukset, kun joku \u003cb\u003e@mainitsee\u003c/b\u003e nimesi tai lainaa sinua, tai vastaa ketjuihin joita tarkkailet. Ilmoitukset lähetetään sinulle sähköpostitse silloin, kun et ole kirjautunut hetkeen. \u003cbr\u003e\u003cbr\u003e Napsauta painiketta %{icon}, kun haluat ilmoituksia tietystä ketjusta, alueesta tai tunnisteesta. Lisää valintoja löydät \u003ca href='%{preferencesUrl}'\u003eilmoitusasetuksista\u003c/a\u003e.\n","no_notifications_page_title":"Sinulla ei ole vielä ilmoituksia","first_notification":"Ensimmäinen ilmoitus sinulle! Valitse se aloittaaksesi.","dynamic_favicon":"Näytä määrät selaimen kuvakkeessa","skip_new_user_tips":{"description":"Ohita uuden käyttäjän aloittamisvinkit ja kunniamerkit","not_first_time":"Eikö tämä ole ensikertasi?","skip_link":"Ohita nämä vinkit","read_later":"Luen sen myöhemmin."},"theme_default_on_all_devices":"Tee tästä oletusteema kaikille laitteilleni","color_scheme_default_on_all_devices":"Aseta oletusvärimalli(t) kaikille laitteilleni","color_scheme":"Värimalli","color_schemes":{"default_description":"Teeman oletus","disable_dark_scheme":"Sama kuin oletus","dark_instructions":"Voit esikatsella tumman tilan värimallia aktivoimalla laitteesi tumman tilan asetuksen.","undo":"Nollaa","regular":"Tavallinen","dark":"Tumma tila","default_dark_scheme":"(sivuston oletus)"},"dark_mode":"Tumma tila","dark_mode_enable":"Ota käyttöön automaattinen tumman tilan värimalli","text_size_default_on_all_devices":"Tee tästä oletusfonttikoko kaikille laitteilleni","allow_private_messages":"Salli toisten käyttäjien lähettää minulle yksityisviestejä","external_links_in_new_tab":"Avaa sivuston ulkopuoliset linkit uudessa välilehdessä","enable_quoting":"Ota käyttöön viestin lainaaminen tekstiä valitsemalla","enable_defer":"Ota käyttöön lykkäystoiminto, jolla voi merkitä ketjun lukemattomaksi","change":"vaihda","featured_topic":"Valikoitu ketju","moderator":"%{user} on valvoja","admin":"%{user} on ylläpitäjä","moderator_tooltip":"Tämä käyttäjä on valvoja","admin_tooltip":"Tämä käyttäjä on ylläpitäjä","silenced_tooltip":"Käyttäjä on hiljennetty","suspended_notice":"Tämä käyttäjätili on estetty %{date} asti.","suspended_permanently":"Käyttäjä on hyllytetty.","suspended_reason":"Syy: ","github_profile":"GitHub","email_activity_summary":"Yhteenveto tapahtumista","mailing_list_mode":{"label":"Postituslistatila","enabled":"Ota käyttöön postituslistatila","instructions":"Asetus ohittaa yhteenvedon tapahtumista.\u003cbr /\u003e\nVaimennettujen ketjujen ja alueiden viestejä ei sisällytetä sähköposteihin.\n","individual":"Lähetä sähköposti jokaisesta uudesta viestistä","individual_no_echo":"Lähetä sähköposti jokaisesta uudesta viestistä lukuun ottamatta omiani","many_per_day":"Lähetä minulle sähköpostia jokaisesta uudesta viestistä (noin %{dailyEmailEstimate} päivässä)","few_per_day":"Lähetä minulle sähköposti jokaisesta uudesta viestistä (noin 2 päivässä)","warning":"Postituslistatila käytössä. Sähköposti-ilmoitusasetukset ohitettu."},"tag_settings":"Tunnisteet","watched_tags":"Tarkkaillut","watched_tags_instructions":"Ketjut, joilla on jokin näistä tunnisteista, asetetaan automaattisesti tarkkailuun. Saat ilmoituksen kaikista uusista viesteistä sekä ketjuista, ja uusien viestien lukumäärä näytetään ketjun otsikon vieressä.","tracked_tags":"Seuratut","tracked_tags_instructions":"Ketjut, joilla on joku näistä tunnisteista, asetetaan automaattisesti seurantaan. Uusien viestien lukumäärä näytetään ketjun otsikon vieressä.","muted_tags":"Vaimennettu","muted_tags_instructions":"Et saa ilmoituksia ketjuista, joilla on joku näistä tunnisteista, eivätkä ne näy tuoreimmissa.","watched_categories":"Tarkkaillut","watched_categories_instructions":"Näiden alueiden kaikki uudet ketjut asetetaan automaattisesti tarkkailuun. Saat ilmoituksen kaikista uusista viesteistä sekä ketjuista, ja uusien viestien lukumäärä näytetään ketjun otsikon vieressä.","tracked_categories":"Seuratut","tracked_categories_instructions":"Näiden alueiden ketjut asetetaan automaattisesti seurantaan. Uusien viestien lukumäärä näytetään ketjun yhteydessä.","watched_first_post_categories":"Tarkkaillaan ensimmäistä viestiä","watched_first_post_categories_instructions":"Saat ilmoituksen näiden alueiden ketjujen ensimmäisistä viesteistä.","watched_first_post_tags":"Tarkkaillaan ensimmäistä viestiä","watched_first_post_tags_instructions":"Saat ilmoituksen uusista ketjuista, joilla on joku näistä tunnisteista.","muted_categories":"Vaimennetut","muted_categories_instructions":"Et saa ilmoituksia näille alueille luoduista uusista ketjuista. Ketjut eivät näy alueissa eivätkä tuoreimmissa.","muted_categories_instructions_dont_hide":"Et saa ilmoituksia mistään tämän alueen uusiin ketjuihin liittyvästä.","regular_categories":"Normaali","regular_categories_instructions":"Näet nämä alueet Tuoreimmat- ja Suosituimmat-ketjuluetteloissa.","no_category_access":"Valvojana sinulla on rajoitetut oikeudet alueisiin, et voi tallentaa.","delete_account":"Poista tilini","delete_account_confirm":"Oletko varma, että haluat poistaa tilisi pysyvästi? Tätä toimintoa ei voi kumota!","deleted_yourself":"Tilisi on poistettu.","delete_yourself_not_allowed":"Ota yhteyttä henkilökuntaan, jos haluat, että tilisi poistetaan.","unread_message_count":"Viestit","admin_delete":"Poista","users":"Käyttäjät","muted_users":"Vaimennettu","muted_users_instructions":"Älä näytä ilmoituksia tai vastaanota yksityisviestejä näiltä käyttäjiltä.","allowed_pm_users":"Sallittu","allowed_pm_users_instructions":"Salli yksityisviestit vain näiltä käyttäjiltä.","allow_private_messages_from_specific_users":"Salli vain tiettyjen käyttäjien lähettää minulle yksityisviestejä.","ignored_users":"Sivuutettu","ignored_users_instructions":"Älä näytä viestejä ja ilmoituksia tai vastaanota yksityisviestejä näiltä käyttäjiltä.","tracked_topics_link":"Näytä","automatically_unpin_topics":"Poista kiinnitetyn ketjun kiinnitys automaattisesti, kun olen selannut sen loppuun.","apps":"Sovellukset","revoke_access":"Peru käyttöoikeus","undo_revoke_access":"Peru käyttöoikeuden peruminen","api_approved":"Sallittu:","api_last_used_at":"Viimeksi käytetty:","theme":"Teema","save_to_change_theme":"Teema päivittyy, kun valitset \"%{save_text}\"","home":"Oletusaloitussivu","staged":"Esikäyttäjä","staff_counters":{"flags_given":"hyödyllistä merkintää","flagged_posts":"merkittyä viestiä","deleted_posts":"poistettua viestiä","suspensions":"estoa","warnings_received":"varoituksia","rejected_posts":"hylättyjä viestejä"},"messages":{"inbox":"Saapuneet","latest":"Tuoreimmat","sent":"Lähetetyt","unread":"Lukemattomat","unread_with_count":{"one":"Lukematta (%{count})","other":"Lukematta (%{count})"},"new":"Uudet","new_with_count":{"one":"Uudet (%{count})","other":"Uudet (%{count})"},"archive":"Arkisto","groups":"Omat ryhmät","move_to_inbox":"Siirrä saapuneisiin","move_to_archive":"Arkisto","failed_to_move":"Valittujen viestien siirto epäonnistui (vika saattaa olla verkkoyhteydessäsi)","tags":"Tunnisteet","warnings":"Viralliset varoitukset"},"preferences_nav":{"account":"Tili","security":"Tietoturva","profile":"Profiili","emails":"Sähköpostit","notifications":"Ilmoitukset","categories":"Alueet","users":"Käyttäjät","tags":"Tunnisteet","interface":"Käyttöliittymä","apps":"Sovellukset"},"change_password":{"success":"(sähköposti lähetetty)","in_progress":"(sähköpostia lähetetään)","error":"(virhe)","emoji":"lukkoemoji","action":"Lähetä sähköposti salasanan palauttamista varten","set_password":"Aseta salasana","choose_new":"Valitse uusi salasana","choose":"Valitse salasana"},"second_factor_backup":{"title":"Kaksivaiheisen tunnistuksen varakoodit","regenerate":"Tee uusi","disable":"Poista käytöstä","enable":"Ota käyttöön","enable_long":"Ota varakoodit käyttöön","manage":{"one":"Hallitse varakoodeja. Sinulla on \u003cstrong\u003e%{count}\u003c/strong\u003e varakoodi jäljellä.","other":"Hallitse varakoodeja. Sinulla on \u003cstrong\u003e%{count}\u003c/strong\u003e varakoodia jäljellä."},"copy_to_clipboard":"Kopioi leikepöydälle","copy_to_clipboard_error":"Virhe kopioimisessa leikepöydälle","copied_to_clipboard":"Kopioitiin leikepöydälle","download_backup_codes":"Lataa varakoodit","remaining_codes":{"one":"Sinulla on \u003cstrong\u003e%{count}\u003c/strong\u003e varakoodi jäljellä.","other":"Sinulla on \u003cstrong\u003e%{count}\u003c/strong\u003e varakoodia jäljellä."},"use":"Käytä varakoodi","enable_prerequisites":"Sinun täytyy ottaa käyttöön ensisijainen kaksivaiheinen tunnistustapa, jotta voit luoda varakoodeja.","codes":{"title":"Varakoodit luotiin","description":"Kunkin näistä varakoodeista voi käyttää vain kerran. Säilö ne johonkin turvalliseen paikkaan, josta löydät ne."}},"second_factor":{"title":"Kaksivaiheinen tunnistus","enable":"Hallitse kaksivaiheista tunnistusta","disable_all":"Poista kaikki käytöstä","forgot_password":"Unohditko salasanasi?","confirm_password_description":"Jatka vahvistamalla salasanasi","name":"Nimi","label":"Koodi","rate_limit":"Odota hetki ennen toisen todennuskoodin kokeilemista.","enable_description":"Skannaa QR-koodi tuetulla sovelluksella (\u003ca href=\"https://www.google.com/search?q=authenticator+apps+for+android\" target=\"_blank\"\u003eAndroid\u003c/a\u003e – \u003ca href=\"https://www.google.com/search?q=authenticator+apps+for+ios\" target=\"_blank\"\u003eiOS\u003c/a\u003e) ja syötä todennuskoodisi.\n","disable_description":"Syötä sovelluksen tarjoama todennuskoodi","show_key_description":"Syötä manuaalisesti","short_description":"Suojaa tilisi kertakäyttöisillä turvakoodeilla.\n","extended_description":"Kaksivaiheinen tunnistus lisää tilisi turvallisuutta vaatimalla kertakäyttöisen koodin salasanasi lisäksi. Koodeja voi luoda \u003ca href=\"https://www.google.com/search?q=authenticator+apps+for+android\" target='_blank'\u003eAndroid-\u003c/a\u003e ja \u003ca href=\"https://www.google.com/search?q=authenticator+apps+for+ios\"\u003eiOS\u003c/a\u003e-laitteilla.\n","oauth_enabled_warning":"Huomioi, ettet voi kirjautua some-tilien avulla, jos kaksivaiheinen tunnistus on käytössä tililläsi.","use":"Käytä Authenticator-sovellusta","enforced_notice":"Kaksivaiheinen tunnistus täytyy ottaa käyttöön, jotta voit käyttää sivustoa.","disable":"Poista käytöstä","disable_confirm":"Oletko varma, että haluat poistaa kaikki kaksivaiheiset tunnistustavat käytöstä?","save":"Tallenna","edit":"Muokkaa","edit_title":"Muokkaa todentajaa","edit_description":"Todentajan nimi","enable_security_key_description":"Kun \u003ca href=\"https://www.google.com/search?q=hardware+security+key\" target=\"_blank\"\u003etunnistautumislaite\u003c/a\u003e on valmiina, paina alla olevaa Rekisteröi-painiketta.\n","totp":{"title":"Tunnuksiin perustuvat todentajat","add":"Lisää todentaja","default_name":"Oma todentaja","name_and_code_required_error":"Anna nimi sekä todentajasovelluksesta löytyvä koodi."},"security_key":{"register":"Rekisteröi","title":"Tunnistautumislaite","add":"Lisää tunnistautumislaite","default_name":"Päätunnistautumislaite","not_allowed_error":"Tunnistautumislaitteen rekisteröintiprosessi joko vanheni tai peruutettiin.","already_added_error":"Olet jo rekisteröinyt tämän tunnistautumislaitteen. Sitä ei tarvitse rekisteröidä uudelleen.","edit":"Muokkaa tunnistautumislaitetta","save":"Tallenna","edit_description":"Tunnistautumislaitteen nimi","name_required_error":"Tunnistautumislaite tarvitsee nimen."}},"change_about":{"title":"Muokkaa kuvaustasi","error":"Arvon muuttamisessa tapahtui virhe."},"change_username":{"title":"Vaihda käyttäjätunnus","confirm":"Oletko aivan varma, että haluat vaihtaa käyttäjätunnuksesi?","taken":"Tämä käyttäjätunnus on valitettavasti jo käytössä.","invalid":"Käyttäjätunnus ei kelpaa. Siinä saa olla ainoastaan numeroita ja kirjaimia."},"add_email":{"title":"Lisää sähköpostiosoite","add":"lisää"},"change_email":{"title":"Vaihda sähköposti","taken":"Tämä sähköpostiosoite ei valitettavasti ole saatavilla.","error":"Sähköpostiosoitteen vaihdossa tapahtui virhe. Ehkäpä sama sähköpostiosoite on jo käytössä?","success":"Annettuun osoitteeseen on lähetetty viesti. Seuraa sen ohjeita sähköpostiosoitteen varmentamiseksi.","success_via_admin":"Olemme lähettäneet sähköpostin tähän osoitteeseen. Käyttäjän täytyy noudattaa sähköpostissa annettuja vahvistusohjeita.","success_staff":"Lähetimme sähköpostin nykyiseen osoitteeseesi. Noudata vahvistusohjeita."},"change_avatar":{"title":"Vaihda profiilikuvasi","gravatar":"\u003ca href='//%{gravatarBaseUrl}%{gravatarLoginUrl}' target='_blank'\u003e%{gravatarName}\u003c/a\u003e, perustuen","gravatar_title":"Muuta avatariasi palvelun %{gravatarName} sivustolla","gravatar_failed":"%{gravatarName}-gravataria ei löytynyt sähköpostiosoitteella.","refresh_gravatar_title":"Päivitä %{gravatarName}","letter_based":"Sivuston luoma profiilikuva","uploaded_avatar":"Mukautettu kuva","uploaded_avatar_empty":"Lisää mukautettu kuva","upload_title":"Lataa oma kuva","image_is_not_a_square":"Varoitus: olemme rajanneet kuvaasti; korkeus ja leveys eivät olleet samoja","logo_small":"Sivuston pieni logo. Käytetään oletuksena."},"change_profile_background":{"title":"Profiilin yläkuva","instructions":"Profiilin yläkuva keskitetään, ja sen oletusleveys on 1 110 px."},"change_card_background":{"title":"Käyttäjäkortin taustakuva","instructions":"Taustakuvat keskitetään, ja niiden oletusleveys on 590 px."},"change_featured_topic":{"title":"Valikoitu ketju","instructions":"Käyttäjäkorttiisi ja profiilisivullesi tulee linkki tähän ketjuun."},"email":{"title":"Sähköposti","primary":"Ensisijainen sähköpostiosoite","secondary":"Toissijaiset sähköpostiosoitteet","primary_label":"ensisijainen","unconfirmed_label":"vahvistamaton","resend_label":"lähetä vahvistussähköposti uudelleen","resending_label":"lähetetään...","resent_label":"sähköposti lähetetty","update_email":"Vaihda sähköposti","set_primary":"Aseta ensisijainen sähköpostiosoite","destroy":"Poista sähköpostiosoite","add_email":"Lisää vaihtoehtoinen sähköpostiosoite","auth_override_instructions":"Sähköpostiosoite voidaan päivittää todennuksen tarjoajalta.","no_secondary":"Ei toissijaisia sähköpostiosoitteita","instructions":"Ei tule julkiseksi.","admin_note":"Huomautus: Ylläpitäjä, joka vaihtaa sellaisen käyttäjän sähköpostiosoitteen, joka ei ole ylläpitäjä, tämä tarkoittaa, että käyttäjä on menettänyt pääsyn alkuperäiseen sähköpostitiliinsä, joten salasanan palautussähköposti lähetetään hänen uuteen osoitteeseensa. Käyttäjän sähköpostiosoite vaihtuu vasta, kun salasanan palautusprosessi on suoritettu loppuun.","ok":"Lähetämme sinulle sähköpostin varmistukseksi","required":"Syötä sähköpostiosoitteesi","invalid":"Anna kelvollinen sähköpostiosoite","authenticated":"%{provider} on todentanut sähköpostiosoitteesi","invite_auth_email_invalid":"Kutsun sähköpostiosoite ei täsmää sähköpostiosoitteen kanssa, jonka %{provider} todensi","authenticated_by_invite":"Kutsu on vahvistanut sähköpostiosoitteesi","frequency_immediately":"Lähetämme sinulle välittömästi sähköpostiviestin, jos et ole lukenut asiaa, josta lähetämme sinulle sähköpostia.","frequency":{"one":"Lähetämme sähköpostin vain, jos emme ole nähneet sinua viimeisen minuutin aikana.","other":"Lähetämme sähköpostin vain, jos emme ole nähneet sinua viimeisten %{count} minuutin aikana."}},"associated_accounts":{"title":"Liitetyt tilit","connect":"Yhdistä","revoke":"Kumoa","cancel":"Peruuta","not_connected":"(ei liitetty)","confirm_modal_title":"Yhdistä palvelun %{provider} tili","confirm_description":{"account_specific":"Palvelun %{provider} tiliäsi \"%{account_description}\" käytetään todentamiseen.","generic":"Palvelun %{provider} tiliäsi käytetään todentamiseen."}},"name":{"title":"Nimi","instructions":"koko nimesi (valinnainen)","instructions_required":"Koko nimesi","required":"Syötä nimesi","too_short":"Nimesi on liian lyhyt","ok":"Nimesi vaikuttaa hyvältä"},"username":{"title":"Käyttäjätunnus","instructions":"uniikki, ei välilyöntejä, lyhyt","short_instructions":"Muut käyttäjät voivat mainita sinut nimellä @%{username}","available":"Käyttäjätunnus on vapaana","not_available":"Ei saatavilla. Entä %{suggestion}?","not_available_no_suggestion":"Ei saatavilla","too_short":"Käyttäjätunnus on liian lyhyt","too_long":"Käyttäjätunnus on liian pitkä","checking":"Tarkistetaan käyttäjätunnuksen saatavuutta...","prefilled":"Sähköpostiosoite vastaa tätä rekisteröityä käyttäjätunnusta","required":"Syötä käyttäjätunnus","edit":"Muokkaa käyttäjätunnusta"},"locale":{"title":"Käyttöliittymän kieli","instructions":"Käyttöliittymän kieli. Se vaihtuu, kun päivität sivun.","default":"(oletus)","any":"mikä tahansa"},"password_confirmation":{"title":"Salasana uudelleen"},"invite_code":{"title":"Kutsukoodi","instructions":"Tilin rekisteröintiin tarvitaan kutsukoodi"},"auth_tokens":{"title":"Viimeksi käytetyt laitteet","details":"Tiedot","log_out_all":"Kirjaudu ulos kaikkialta","not_you":"Etkö tämä ole sinä?","show_all":"Näytä kaikki (%{count})","show_few":"Näytä vähemmän","was_this_you":"Olitko tämä sinä?","was_this_you_description":"Jos sisäänkirjautuja et ollut sinä, suosittelemme salasanan vaihtamista ja uloskirjautumista kaikilta laitteiltasi.","browser_and_device":"%{browser} laitteella %{device}","secure_account":"Turvaa tilini","latest_post":"Viimeisin viestisi...","device_location":"\u003cspan class=\"auth-token-device\"\u003e%{device}\u003c/span\u003e \u0026ndash; \u003cspan title=\"IP: %{ip}\"\u003e%{location}\u003c/span\u003e","browser_active":"%{browser} | \u003cspan class=\"active\"\u003eaktiivinen nyt\u003c/span\u003e","browser_last_seen":"%{browser} | %{date}"},"last_posted":"Viimeisin viesti","last_seen":"Nähty","created":"Liittynyt","log_out":"Kirjaudu ulos","location":"Sijainti","website":"Verkkosivusto","email_settings":"Sähköposti","hide_profile_and_presence":"Piilota julkinen profiilini ja läsnäolo-ominaisuudet","enable_physical_keyboard":"Ota käyttöön iPadin fyysisen näppäimistön tuki","text_size":{"title":"Tekstikoko","smallest":"Pienin","smaller":"Pienempi","normal":"Normaali","larger":"Suurempi","largest":"Suurin"},"title_count_mode":{"title":"Taustasivun otsikon näyttäjen määrä:","notifications":"Uusia ilmoituksia","contextual":"Uusi sivusisältö"},"like_notification_frequency":{"title":"Ilmoita, kun viestistäni tykätään","always":"Aina","first_time_and_daily":"Ensimmäisen kerran, kun viestistä tykätään, ja päivittäin","first_time":"Ensimmäisen kerran, kun viestistä tykätään","never":"Ei koskaan"},"email_previous_replies":{"title":"Lisää aiemmat vastaukset mukaan sähköpostin alaosaan","unless_emailed":"ellei lähetetty aiemmin","always":"aina","never":"ei koskaan"},"email_digests":{"title":"Kun en käy täällä, lähetä sähköpostiini yhteenveto suosituista ketjuista ja vastauksista","every_30_minutes":"30 minuutin välein","every_hour":"tunneittain","daily":"päivittäin","weekly":"viikottain","every_month":"kuukausittain","every_six_months":"kuuden kuukauden välein"},"email_level":{"title":"Lähetä minulle sähköposti, jos joku lainaa viestiäni, vastaa viestiini, maintsee @käyttäjätunnukseni tai kutsuu minut ketjuun","always":"aina","only_when_away":"vain, kun olen poissa","never":"ei koskaan"},"email_messages_level":"Lähetä minulle sähköposti, kun joku lähettää minulle viestin","include_tl0_in_digests":"Lisää uusien käyttäjien sisältö yhteenvetosähköposteihin","email_in_reply_to":"Sisällytä lyhennelmä vastattavasta viestistä sähköposteihin","other_settings":"Muut","categories_settings":"Alueet","new_topic_duration":{"label":"Tulkitse ketju uudeksi, jos","not_viewed":"en ole vielä katsonut sitä","last_here":"se on luotu edellisen käyntini jälkeen","after_1_day":"se on luotu viimeisen päivän aikana","after_2_days":"se on luotu viimeisten 2 päivän aikana","after_1_week":"se on luotu viimeisen viikon aikana","after_2_weeks":"se on luotu viimeisten 2 viikon aikana"},"auto_track_topics":"Seuraa automaattisesti ketjuja, jotka avaan","auto_track_options":{"never":"ei koskaan","immediately":"heti","after_30_seconds":"30 sekunnin jälkeen","after_1_minute":"1 minuutin jälkeen","after_2_minutes":"2 minuutin jälkeen","after_3_minutes":"3 minuutin jälkeen","after_4_minutes":"4 minuutin jälkeen","after_5_minutes":"5 minuutin jälkeen","after_10_minutes":"10 minuutin jälkeen"},"notification_level_when_replying":"Kun kirjoitan ketjuun, aseta se","invited":{"title":"Kutsut","pending_tab":"Odottavat","pending_tab_with_count":"Avoimet (%{count})","expired_tab":"Vanhentuneet","expired_tab_with_count":"Vanhentuneet (%{count})","redeemed_tab":"Hyväksytyt","redeemed_tab_with_count":"Hyväksytyt (%{count})","invited_via":"Kutsu","invited_via_link":"linkki %{key} (%{count} / %{max} lunastettu)","groups":"Ryhmät","topic":"Ketju","sent":"Luotu/Viimeksi lähetetty","expires_at":"Vanhenee","edit":"Muokkaa","remove":"Poista","copy_link":"Hae linkki","reinvite":"Lähetä sähköposti uudelleen","reinvited":"Kutsu lähetetty uudelleen","removed":"Poistettu","search":"kirjoita hakeaksesi kutsuja...","user":"Kutsuttu käyttäjä","none":"Ei näytettäviä kutsuja.","truncated":{"one":"Näytetään ensimmäinen kutsu.","other":"Näytetään ensimmäiset %{count} kutsua."},"redeemed":"Hyväksytyt kutsut","redeemed_at":"Hyväksytty","pending":"Odottavat kutsut","topics_entered":"Avatut ketjut","posts_read_count":"Luetut viestit","expired":"Tämä kutsu on vanhentunut.","remove_all":"Poista vanhentuneet kutsut","removed_all":"Kaikki vanhentuneet kutsut poistettu!","remove_all_confirm":"Haluatko varmasti poistaa kaikki vanhentuneet kutsut?","reinvite_all":"Lähetä kaikki kutsut uudelleen","reinvite_all_confirm":"Haluatko varmasti lähettää kaikki kutsut uudelleen?","reinvited_all":"Kaikki kutsut lähetettiin uudelleen","time_read":"Lukuaika","days_visited":"Vierailupäiviä","account_age_days":"Tilin ikä päivissä","create":"Kutsu","generate_link":"Luo kutsulinkki","link_generated":"Tässä kutsulinkkisi!","valid_for":"Kutsulinkki toimii vain tällä sähköpostiosoitteella: %{email}","single_user":"Kutsu sähköpostitse","multiple_user":"Kutsu linkin avulla","invite_link":{"title":"Kutsulinkki","success":"Kutsulinkki luotiin!","error":"Kutsulinkin luominen epäonnistui","max_redemptions_allowed_label":"Kuinka moni saa rekisteröityä tällä linkillä?","expires_at":"Koska tämä linkki vanhenee?"},"invite":{"new_title":"Luo kutsu","edit_title":"Muokkaa kutsua","instructions":"Jaa tämä linkki, jotta voit välittömästi myöntää pääsyn tälle sivustolle","copy_link":"kopioi linkki","expires_in_time":"Vanhenee %{time}","expired_at_time":"Vanhentunut %{time}","show_advanced":"Näytä lisäasetukset","hide_advanced":"Piilota lisäasetukset","restrict_email":"Rajoita yhteen sähköpostiosoitteeseen","max_redemptions_allowed":"Käyttökertoja enintään","add_to_groups":"Lisää ryhmiin","invite_to_topic":"Saavu tähän ketjuun","expires_at":"Aikaa vanhenemiseen","custom_message":"Valinnainen henkilökohtainen viesti","send_invite_email":"Tallenna ja lähetä sähköposti","save_invite":"Tallenna kutsu","invite_saved":"Kutsu tallennettu.","invite_copied":"Kutsulinkki kopioitu."},"bulk_invite":{"none":"Ei näytettäviä kutsuja tällä sivulla.","text":"Joukkokutsu","instructions":"\u003cp\u003eKutsu lista käyttäjiä, jotta saat yhteisösi nopeaan kasvuun. Valmistele \u003ca href=\"https://en.wikipedia.org/wiki/Comma-separated_values\" target=\"_blank\"\u003eCSV-tiedosto\u003c/a\u003e joka sisältää vähintään yhden rivin, kukin sähköpostiosoite omalla rivillään. Seuraavat pilkuilla erotetut tiedot voidaan antaa, jos haluat lisätä käyttäjiä ryhmiin tai lähettää heidät tiettyyn ketjuun ensimmäistä kertaa heidän kirjautuessaan sisään.\u003c/p\u003e\n\u003cpre\u003ejohn@smith.com, ensimmäisen_ryhmän_nimi;toisen_ryhmän_nimi, ketjun_tunnus\u003c/pre\u003e\n\u003cp\u003eJokaiseen CSV-tiedoston sähköpostiosoitteeseen lähetetään kutsu, ja voit hallita sitä myöhemmin.\u003c/p\u003e\n","progress":"Ladattu %{progress} %...","success":"Tiedoston lataaminen onnistui. Saat ilmoituksen viestillä, kun prosessi on valmis.","error":"Tiedoston tulee olla CSV-muodossa."}},"password":{"title":"Salasana","too_short":"Salasanasi on liian lyhyt.","common":"Annettu salasana on liian yleinen.","same_as_username":"Salasanasi on sama kuin käyttäjätunnuksesi.","same_as_email":"Salasanasi on sama kuin sähköpostisosoitteesi.","ok":"Salasana vaikuttaa hyvältä.","instructions":"vähintään %{count} merkkiä.","required":"Syötä salasana"},"summary":{"title":"Yhteenveto","stats":"Tilastot","time_read":"lukuaika","recent_time_read":"viimeisin lukuaika","topic_count":{"one":"avattu ketju","other":"aloitettua ketjua"},"post_count":{"one":"kirjoitettu viesti","other":"kirjoitettua viestiä"},"likes_given":{"one":"annettu","other":"annettu"},"likes_received":{"one":"saatu","other":"saatu"},"days_visited":{"one":"päivänä vieraillut","other":"päivänä vieraillut"},"topics_entered":{"one":"luettu ketju","other":"luettua ketjua"},"posts_read":{"one":"luettu viesti","other":"luettua viestiä"},"bookmark_count":{"one":"kirjanmerkki","other":"kirjanmerkkiä"},"top_replies":"Suosituimmat vastaukset","no_replies":"Ei vielä vastauksia.","more_replies":"Lisää vastauksia","top_topics":"Suosituimmat ketjut","no_topics":"Ei vielä ketjuja.","more_topics":"Lisää ketjuja","top_badges":"Suosituimmat kunniamerkit","no_badges":"Ei vielä kunniamerkkejä.","more_badges":"Lisää kunniamerkkejä","top_links":"Suosituimmat linkit","no_links":"Ei vielä linkkejä.","most_liked_by":"Eniten tykkäyksiä saatu","most_liked_users":"Tykätyin","most_replied_to_users":"Useimmin vastannut","no_likes":"Ei vielä tykkäyksiä.","top_categories":"Suositut alueet","topics":"Ketjut","replies":"Vastaukset"},"ip_address":{"title":"Viimeinen IP-osoite"},"registration_ip_address":{"title":"IP-osoite rekisteröityessä"},"avatar":{"title":"Profiilikuva","header_title":"profiili, viestit, kirjanmerkit ja asetukset","name_and_description":"%{name} - %{description}","edit":"Muokkaa profiilikuvaa"},"title":{"title":"Titteli","none":"(ei mitään)","instructions":"näkyy käyttäjätunnuksesi jälkeen"},"flair":{"title":"Flairi","none":"(ei mitään)","instructions":"kuvake, joka näytetään profiilikuvasi vieressä"},"primary_group":{"title":"Ensisijainen ryhmä","none":"(ei mitään)"},"filters":{"all":"Kaikki"},"stream":{"posted_by":"Viestin kirjoittaja","sent_by":"Lähettänyt","private_message":"viesti","the_topic":"ketju"}},"loading":"Ladataan...","errors":{"prev_page":"yrittäessä ladata","reasons":{"network":"Verkkovirhe","server":"Palvelinvirhe","forbidden":"Pääsy estetty","unknown":"Virhe","not_found":"Sivua ei löytynyt"},"desc":{"network":"Tarkista yhteytesi.","network_fixed":"Näyttää siltä, että se on palannut.","server":"Virhekoodi: %{status}","forbidden":"Sinulla ei ole oikeutta katsoa tätä.","not_found":"Sovellus yritti ladata URL-osoitteen, jota ei ole olemassa.","unknown":"Jokin meni vikaan."},"buttons":{"back":"Palaa takaisin","again":"Yritä uudelleen","fixed":"Lataa sivu"}},"modal":{"close":"sulje","dismiss_error":"Hylkää virhe"},"close":"Sulje","assets_changed_confirm":"Tämä sivusto sai juuri ohjelmistopäivityksen. Hae uusin versio nyt?","logout":"Sinut kirjattiin ulos.","refresh":"Päivitä","home":"Aloitus","read_only_mode":{"enabled":"Sivusto on vain luku -tilassa. Voit jatkaa selailua, mutta vastaaminen, tykkääminen ja muita toimintoja on toistaiseksi poissa käytöstä.","login_disabled":"Et voi kirjautua sisään, kun sivusto on vain luku -tilassa.","logout_disabled":"Et voi kirjautua ulos, kun sivusto on vain luku -tilassa."},"logs_error_rate_notice":{},"learn_more":"lisätietoja...","first_post":"Ensimmäinen viesti","mute":"Vaimenna","unmute":"Poista vaimennus","last_post":"Kirjoitti","local_time":"Paikallinen aika","time_read":"Lukenut","time_read_recently":"%{time_read} viime aikoina","time_read_tooltip":"%{time_read} kokonaislukuaika","time_read_recently_tooltip":"%{time_read} kokonaislukuaika (%{recent_time_read} viimeisten 60 päivän aikana)","last_reply_lowercase":"viimeisin vastaus","replies_lowercase":{"one":"vastaus","other":"vastausta"},"signup_cta":{"sign_up":"Rekisteröidy","hide_session":"Muistuta huomenna","hide_forever":"ei kiitos","hidden_for_session":"OK, kysymme sinulta huomenna. Voit myös aina käyttää 'Kirjaudu sisään' -linkkiä tilin luomiseen.","intro":"Hei! Vaikuttaa siltä, että olet pitänyt keskusteluista, muttet ole luonut käyttäjätiliä.","value_prop":"Kun luot tilin, muistamme mitä olet lukenut, jotta voit aina palata keskusteluissa takaisin oikeaan kohtaan. Saat myös ilmoituksia – palstalla näkyviä ja sähköpostiisi saapuvia – kun joku vastaa sinulle. Ja voit myös tykätä viesteistä. :heartpulse:"},"summary":{"enabled_description":"Tarkastelet yhteenvetoa tästä ketjusta, sen mielenkiintoisimpia viestejä käyttäjien toiminnan perusteella.","description":{"one":"Ketjussa on \u003cb\u003e%{count}\u003c/b\u003e vastaus.","other":"Ketjussa on \u003cb\u003e%{count}\u003c/b\u003e vastausta."},"enable":"Näytä ketjun tiivistelmä","disable":"Näytä kaikki viestit"},"deleted_filter":{"enabled_description":"Tämä ketju sisältää poistettuja viestejä, jotka on piilotettu.","disabled_description":"Ketjun poistetut viestit näytetään.","enable":"Piilota poistetut viestit","disable":"Näytä poistetut viestit"},"private_message_info":{"title":"Viesti","invite":"Kutsu muita...","edit":"Lisää tai poista...","remove":"Poista...","add":"Lisää...","leave_message":"Haluatko varmasti poistua tästä viestistä?","remove_allowed_user":"Haluatko varmasti poistaa käyttäjän %{name} tästä viestistä?","remove_allowed_group":"Haluatko varmasti poistaa käyttäjän %{name} tästä viestistä?"},"email":"Sähköposti","username":"Käyttäjätunnus","last_seen":"Nähty","created":"Luotu","created_lowercase":"luotu","trust_level":"Luottamustaso","search_hint":"käyttäjätunnus, sähköposti tai IP-osoite","create_account":{"header_title":"Tervetuloa!","subheader_title":"Luodaan sinulle käyttäjätili","disclaimer":"Kun rekisteröidyt, hyväksyt \u003ca href='%{privacy_link}' target='blank'\u003etietosuojaselosteen\u003c/a\u003e ja \u003ca href='%{tos_link}' target='blank'\u003ekäyttöehdot\u003c/a\u003e.","title":"Luo tili","failed":"Jokin meni vikaan. Tämä sähköpostiosoite on ehkä jo rekisteröity, kokeile salasanan unohduslinkkiä"},"forgot_password":{"title":"Salasanan palautus","action":"Unohdin salasanani","invite":"Syötä käyttäjätunnuksesi tai sähköpostiosoitteesi, niin lähetämme sinulle salasanan palutusviestin.","reset":"Palauta salasana","complete_username":"Jos käyttäjätunnusta \u003cb\u003e%{username}\u003c/b\u003e vastaava tili löytyy, saat kohta sähköpostin, jossa on ohjeet salasanan palauttamiseen.","complete_email":"Jos sähköpostiosoitetta \u003cb\u003e%{email}\u003c/b\u003e vastaava tili löytyy, saat kohta sähköpostin, jossa on ohjeet salasanan palauttamiseen.","complete_username_found":"Käyttäjätunnusta \u003cb\u003e%{username}\u003c/b\u003e vastaava tili löytyi. Saat kohta sähköpostin, jossa on ohjeet salasanan palauttamiseen.","complete_email_found":"Sähköpostiosoitetta \u003cb\u003e%{email}\u003c/b\u003e vastaava tili löytyi. Saat kohta sähköpostin, jossa on ohjeet salasanan palauttamiseen.","complete_username_not_found":"Käyttäjätunnusta \u003cb\u003e%{username}\u003c/b\u003e vastaavia tilejä ei ole","complete_email_not_found":"Sähköpostiosoitetta \u003cb\u003e%{email}\u003c/b\u003e vastaavia tilejä ei ole","help":"Eikö sähköposti saavu? Tarkasta ensin roskapostikansiosi.\u003cp\u003eEtkö ole varma käyttämästäsi sähköpostiosoitteesta? Syötä sähköpostiosoite, niin saat tietää onko sillä luotu käyttäjätunnusta.\u003c/p\u003e\u003cp\u003eJos sinulla ei ole enää pääsyä tilisi sähköpostiosoitteeseen, ota yhteyttä \u003ca href='%{basePath}/about'\u003eavuliaaseen henkilökuntaamme.\u003c/a\u003e\u003c/p\u003e","button_ok":"OK","button_help":"Apua"},"email_login":{"link_label":"Lähetä minulle kirjautumislinkki","button_label":"sähköpostilla","login_link":"Ohita salasana; lähetä minulle kirjautumislinkki sähköpostitse","emoji":"lukkoemoji","complete_username":"Jos tili vastaa käyttäjänimeä \u003cb\u003e%{username}\u003c/b\u003e, sinun tulisi saada pian kirjautumislinkki sähköpostitse.","complete_email":"Jos tili vastaa sähköpostiosoitetta \u003cb\u003e%{email}\u003c/b\u003e, sinun tulisi saada pian kirjautumislinkki sähköpostitse.","complete_username_found":"Tili käyttäjänimellä \u003cb\u003e%{username}\u003c/b\u003e löytyi, sinun tulisi saada pian kirjautumislinkki sähköpostitse.","complete_email_found":"Tili sähköpostiosoitteella \u003cb\u003e%{email}\u003c/b\u003e löytyi, sinun tulisi saada pian kirjautumislinkki sähköpostitse.","complete_username_not_found":"Käyttäjätunnusta \u003cb\u003e%{username}\u003c/b\u003e vastaavia tilejä ei ole","complete_email_not_found":"Sähköpostiosoitetta \u003cb\u003e%{email}\u003c/b\u003e vastaavia tilejä ei ole","confirm_title":"Jatka sivustolle %{site_name}","logging_in_as":"Kirjaudutaan käyttäjänä %{email}","confirm_button":"Kirjaudu"},"login":{"header_title":"Tervetuloa takaisin","subheader_title":"Kirjaudu sisään tilillesi","title":"Kirjaudu","username":"Käyttäjä","password":"Salasana","second_factor_title":"Kaksivaiheinen tunnistus","second_factor_description":"Syötä sovelluksen antama todennuskoodi:","second_factor_backup":"Kirjaudu käyttäen varakoodia","second_factor_backup_title":"Kaksivaiheinen vara","second_factor_backup_description":"Syötä yksi varakoodeistasi:","second_factor":"Kirjaudu todentajasovelluksella","security_key_description":"Kun fyysinen tunnistautumislaite on kätesi ulottuvilla, klikkaa alla olevaa \"Tunnistaudu tunnistautumislaitteella\" -painiketta.","security_key_alternative":"Kokeile muuta tapaa","security_key_authenticate":"Tee todennus tunnistautumislaitteella","security_key_not_allowed_error":"Tunnistautumislaitteen todennusprosessi joko vanheni tai peruutettiin.","security_key_no_matching_credential_error":"Tunnistautumislaitteelta ei löytynyt vastaavia tunnistetietoja.","security_key_support_missing_error":"Nykeinen laitteesi tai selaimesi ei tue tunnistaumislaitteita. Käytä muuta tapaa.","email_placeholder":"Sähköposti/käyttäjätunnus","caps_lock_warning":"Caps Lock on päällä","error":"Tuntematon virhe","cookies_error":"Vaikuttaa siltä, että selaimessasi ei ole evästeet käytössä. Et ehkä pysty kirjautumaan sisään ottamatta niitä käyttöön ensin.","rate_limit":"Odota hetki, ennen kuin yrität kirjautua uudelleen.","blank_username":"Syötä sähköpostiosoitteesi tai käyttäjätunnuksesi.","blank_username_or_password":"Kirjoita sähköpostiosoite tai käyttäjätunnus ja salasana.","reset_password":"Uusi salasana","logging_in":"Kirjaudutaan...","or":"Tai","authenticating":"Todennetaan...","awaiting_activation":"Tilisi odottaa aktivointia; saat uuden aktivointisähköpostin unohdin salasanani -linkin kautta.","awaiting_approval":"Henkilökunta ei ole vielä hyväksynyt käyttäjätiliäsi. Saat sähköpostiviestin, kun tunnuksesi on hyväksytty.","requires_invite":"Tämä foorumi on vain kutsutuille käyttäjille.","not_activated":"Et voi vielä kirjautua sisään. Lähetimme aiemmin aktivointisähköpostiviestin osoitteeseen \u003cb\u003e%{sentTo}\u003c/b\u003e. Seuraa viestin ohjeita tilisi aktivoimiseksi.","not_allowed_from_ip_address":"Tästä IP-osoitteesta ei voi kirjautua.","admin_not_allowed_from_ip_address":"Et voi kirjautua ylläpitäjänä tästä IP-osoitteesta.","resend_activation_email":"Klikkaa tästä lähettääksesi aktivointiviestin uudelleen.","omniauth_disallow_totp":"Käyttäjätilisi käyttää kaksivaiheista tunnistusta. Kirjaudu salasanasi avulla.","resend_title":"Lähetä aktivointisähköposti uudelleen","change_email":"Vaihda sähköpostiosoitetta","provide_new_email":"Anna uusi osoite, niin lähetämme sinulle vahvistamissähköpostin uudelleen.","submit_new_email":"Päivitä sähköpostiosoite","sent_activation_email_again":"Lähetimme sinulle uuden aktivointiviestin osoitteeseen \u003cb\u003e%{currentEmail}\u003c/b\u003e. Viestin saapumisessa voi kestää muutama minuutti; muista tarkastaa myös roskapostikansio.","sent_activation_email_again_generic":"Lähetimme sinulle uuden aktivointiviestin. Viestin saapumisessa voi kestää muutama minuutti; muista tarkastaa myös roskapostikansio.","to_continue":"Kirjaudu sisään","preferences":"Sinun täytyy olla kirjautuneena sisään muokataksesi käyttäjäasetuksia","not_approved":"Tiliäsi ei ole vielä hyväksytty. Saat ilmoituksen sähköpostilla, kun voit kirjautua sisään.","google_oauth2":{"name":"Google","title":"Googlella"},"twitter":{"name":"Twitter","title":"Twitterillä"},"instagram":{"name":"Instagram","title":"Instagramilla"},"facebook":{"name":"Facebook","title":"Facebookilla"},"github":{"name":"GitHub","title":"GitHubilla"},"discord":{"name":"Discord","title":"Discordilla"},"second_factor_toggle":{"totp":"Käytä todentajasovellusta tämän sijaan","backup_code":"Käytä varakoodia tämän sijaan"}},"invites":{"accept_title":"Kutsu","emoji":"kirjekuoriemoji","welcome_to":"Tervetuloa sivustolle %{site_name}!","invited_by":"Sinut kutsui","social_login_available":"Voit myös kirjautua yhteisökirjautumisen avulla, joka on saman sähköpostiosoitteen alainen.","your_email":"Tilisi sähköpostiosoite on \u003cb\u003e%{email}\u003c/b\u003e.","accept_invite":"Hyväksy kutsu","success":"Tili luotiin, ja olet nyt kirjautunut sisään.","name_label":"Nimi","password_label":"Salasana","optional_description":"(valinnainen)"},"password_reset":{"continue":"Jatka sivustolle %{site_name}"},"emoji_set":{"apple_international":"Apple/Kansainvälinen","google":"Google","twitter":"Twitter","win10":"Win10","google_classic":"Google Classic","facebook_messenger":"Facebook Messenger"},"category_page_style":{"categories_only":"Vain alueet","categories_with_featured_topics":"Alueet, joissa on esiteltyjä ketjuja","categories_and_latest_topics":"Alueet ja tuoreimmat ketjut","categories_and_top_topics":"Alueet ja suosittuja ketjuja","categories_boxes":"Laatikot, joissa ala-alueita","categories_boxes_with_topics":"Laatikot, joissa esiteltyjä ketjuja"},"shortcut_modifier_key":{"shift":"Vaihto","ctrl":"Ctrl","alt":"Alt","enter":"Enter"},"conditional_loading_section":{"loading":"Ladataan..."},"category_row":{"topic_count":{"one":"%{count} ketju tällä alueella","other":"%{count} ketjua tällä alueella"},"plus_subcategories_title":{"one":"%{name} ja yksi ala-alue","other":"%{name} ja %{count} ala-aluetta"},"plus_subcategories":{"one":"+ %{count} ala-alue","other":"+ %{count} ala-aluetta"}},"select_kit":{"delete_item":"Poista %{name}","filter_by":"Suodata: %{name}","select_to_filter":"Valitse suodatettava arvo","default_header_text":"Valitse...","no_content":"Ei osumia","filter_placeholder":"Hae...","filter_placeholder_with_any":"Hae tai luo...","create":"Luo: '%{content}'","max_content_reached":{"one":"Voit valita vain %{count} kohteen.","other":"Voit valita enintään %{count} kohdetta."},"min_content_not_reached":{"one":"Valitse ainakin %{count} kohde.","other":"Valitse ainakin %{count} kohdetta."},"invalid_selection_length":{"one":"Täytyy valita ainakin %{count} merkki.","other":"Täytyy valita ainakin %{count} merkkiä."},"components":{"tag_drop":{"filter_for_more":"Näytä lisää..."},"categories_admin_dropdown":{"title":"Hallitse alueita"}}},"date_time_picker":{"from":"Alkaen","to":"Päättyen"},"emoji_picker":{"filter_placeholder":"Hae emojia","smileys_\u0026_emotion":"Hymiöt ja tunteet","people_\u0026_body":"Ihmiset ja kehot","animals_\u0026_nature":"Eläimet ja luonto","food_\u0026_drink":"Ruoka ja juoma","travel_\u0026_places":"Matkustaminen ja paikat","activities":"Harrasteet","objects":"Esineet","symbols":"Symbolit","flags":"Liput","recent":"Hiljattain käytetyt","default_tone":"Ei ihonsävyä","light_tone":"Vaalea ihonväri","medium_light_tone":"Vaaleanruskea ihonväri","medium_tone":"Ruskea ihonväri","medium_dark_tone":"Tummanruskea ihonväri","dark_tone":"Tumma ihonväri","default":"Mukautetut emojit"},"shared_drafts":{"title":"Jaetut luonnokset","notice":"Tämä ketju näkyy vain niille, jotka voivat julkaista jaettuja luonnoksia.","destination_category":"Kohdealue","publish":"Julkaise jaettu luonnos","confirm_publish":"Haluatko varmasti julkaista luonnoksen?","publishing":"Julkaistaan ketjua..."},"composer":{"emoji":"Emoji :)","more_emoji":"lisää...","options":"Asetukset","whisper":"kuiskaus","unlist":"listaamaton","add_warning":"Tämä on virallinen varoitus.","toggle_whisper":"Kuiskaus päälle/pois","toggle_unlisted":"Listaus päälle/pois","posting_not_on_topic":"Mihin ketjuun haluat vastata?","saved_local_draft_tip":"tallennettu paikallisesti","similar_topics":"Tämä ketju vaikuttaa samalta kuin..","drafts_offline":"offline-luonnokset","edit_conflict":"muokkauskonflikti","group_mentioned_limit":{"one":"\u003cb\u003eVaroitus!\u003c/b\u003e Olet maininnut ryhmän \u003ca href='%{group_link}'\u003e%{group}\u003c/a\u003e, mutta ryhmässä on yli %{count} käyttäjä, mikä on ylläpitäjän asettama rajoitus maininnoille. Kukaan ei saa ilmoitusta.","other":"\u003cb\u003eVaroitus!\u003c/b\u003e Olet maininnut ryhmän \u003ca href='%{group_link}'\u003e%{group}\u003c/a\u003e, mutta ryhmässä on yli %{count} käyttäjää, mikä on ylläpitäjän asettama rajoitus maininnoille. Kukaan ei saa ilmoitusta."},"group_mentioned":{"one":"Jos mainitset ryhmän %{group}, \u003ca href='%{group_link}'\u003e%{count} käyttäjä\u003c/a\u003e saa ilmoituksen – oletko varma?","other":"Jos mainitset ryhmän %{group}, \u003ca href='%{group_link}'\u003e%{count} käyttäjää\u003c/a\u003e saa ilmoituksen – oletko varma?"},"cannot_see_mention":{"category":"Mainitsit käyttäjän %{username}, mutta hän ei saa ilmoitusta, koska hänellä ei ole pääsyä tälle alueelle. Hänet tulee lisätä ryhmään, jolla on pääsy alueelle.","private":"Mainitsit käyttäjän %{username}, mutta hän ei saa ilmoitusta, koska hän ei näe tätä yksityiskeskustelua. Hänet tulee kutsua tähän yksityiskeskusteluun."},"duplicate_link":"Näyttää siltä, että \u003cb\u003e@%{username}\u003c/b\u003e linkitti jo samaan kohteeseen \u003cb\u003e%{domain}\u003c/b\u003e ketjun \u003ca href='%{post_url}'\u003eaiemmassa vastauksessa %{ago}\u003c/a\u003e – oletko varma, että haluat lähettää sen uudestaan?","reference_topic_title":"RE: %{title}","error":{"title_missing":"Otsikko on pakollinen","title_too_short":{"one":"Otsikon täytyy olla vähintään %{count} merkin pituinen","other":"Otsikon täytyy olla vähintään %{count} merkkiä pitkä"},"title_too_long":{"one":"Otsikossa saa olla enintään %{count} merkki","other":"Otsikossa saa olla enintään %{count} merkkiä"},"post_missing":"Viesti ei voi olla tyhjä","post_length":{"one":"Viestin on oltava vähintään %{count} merkin pituinen","other":"Viestin on oltava vähintään %{count} merkkiä pitkä"},"try_like":"Oletko kokeillut painiketta %{heart}?","category_missing":"Sinun täytyy valita alue","tags_missing":{"one":"Sinun täytyy valita vähintään %{count} tunniste","other":"Sinun täytyy valita vähintään %{count} tunnistetta"},"topic_template_not_modified":"Lisää ketjuun tietoja ja yksityiskohtia muokkaamalla ketjun mallipohjaa."},"save_edit":"Tallenna muokkaus","overwrite_edit":"Korvaa muokkaus","reply_original":"Vastaa alkuperäiseen ketjuun","reply_here":"Vastaa tänne","reply":"Vastaa","cancel":"Peruuta","create_topic":"Aloita ketju","create_pm":"Lähetä","create_whisper":"Kuiskaa","create_shared_draft":"Luo jaettu luonnos","edit_shared_draft":"Muokkaa jaettua luonnosta","title":"Tai paina Ctrl+Enter","users_placeholder":"Lisää käyttäjä","title_placeholder":"Kuvaile lyhyesti mistä tässä keskustelussa on kyse?","title_or_link_placeholder":"Kirjoita otsikko tai liitä linkki tähän","edit_reason_placeholder":"miksi muokkaat viestiä?","topic_featured_link_placeholder":"Kirjoita otsikossa näkyvä linkki.","remove_featured_link":"Poista linkki ketjusta.","reply_placeholder":"Kirjoita tähän. Käytä Markdownia, BBCodea tai HTML:ää muotoiluun. Vedä tai pudota kuvia.","reply_placeholder_no_images":"Kirjoita tähän. Käytä Markdownia, BBCodea tai HTML:ää muotoiluun.","reply_placeholder_choose_category":"Valitse alue ennen kuin kirjoitat tähän.","view_new_post":"Katsele uutta viestiäsi.","saving":"Tallennetaan","saved":"Tallennettu!","saved_draft":"Viestiluonnos kesken. Jatka napauttamalla.","uploading":"Ladataan...","show_preview":"näytä esikatselu","hide_preview":"piilota esikatselu","quote_post_title":"Lainaa koko viestiä","bold_label":"B","bold_title":"Lihavoitu","bold_text":"lihavoitu teksti","italic_label":"I","italic_title":"Kursiivi","italic_text":"kursivoitu teksti","link_title":"Hyperlinkki","link_description":"kirjoita linkin kuvaus tähän","link_dialog_title":"Lisää linkki","link_optional_text":"valinnainen otsikko","link_url_placeholder":"Liitä URL tai hae ketjua kirjoittamalla","blockquote_title":"Sitaatti","blockquote_text":"Sitaatti","code_title":"Teksti ilman muotoiluja","code_text":"Sisennä teksti neljällä välilyönnillä poistaaksesi automaattisen muotoilun","paste_code_text":"kirjoita tai liitä koodia tähän","upload_title":"Lataa","upload_description":"kirjoita ladatun tiedoston kuvaus tähän","olist_title":"Numeroitu luettelo","ulist_title":"Luettelomerkillinen luettelo","list_item":"Luettelokohde","toggle_direction":"Vaihda suuntaa","help":"Markdown-mukkausohje","collapse":"pienennä kirjoituspaneeli","open":"avaa kirjoituspaneeli","abandon":"sulje kirjoitustila ja hylkää luonnos","enter_fullscreen":"siirry koko ruudun kirjoitustilaan","exit_fullscreen":"poistu koko ruudun kirjoitustilasta","show_toolbar":"näytä kirjoitustilan työkalurivi","hide_toolbar":"piilota kirjoitustilan työkalurivi","modal_ok":"OK","modal_cancel":"Peruuta","cant_send_pm":"Et voi valitettavasti lähettää viestiä käyttäjälle %{username}.","yourself_confirm":{"title":"Unohditko lisätä vastaanottajia?","body":"Olet lähettämässä viestiä vain itsellesi!"},"slow_mode":{"error":"Tämä ketju on hitaassa tilassa. Lähetit viestin äskettäin; voit lähettää uuden %{timeLeft} kuluttua."},"admin_options_title":"Tämän ketjun vain henkilökunnalle näytettävät asetukset","composer_actions":{"reply":"Vastaa","draft":"Luonnos","edit":"Muokkaa","reply_to_post":{"label":"Vastaa käytäjän %{postUsername} viestiin","desc":"Vastaa tiettyyn viestiin"},"reply_as_new_topic":{"label":"Vastaa liittyvässä ketjussa","desc":"Aloita uusi, tähän ketjuun liittyvä ketju","confirm":"Sinulla on tallennettuna uusi ketjuluonnos, joka korvataan, jos luot liittyvän ketjun."},"reply_as_new_group_message":{"label":"Vastaa uudessa ryhmäviestissä"},"reply_as_private_message":{"label":"Uusi viesti","desc":"Luo uusi yksityisviesti"},"reply_to_topic":{"label":"Vastaa ketjuun","desc":"Vastaa ketjuun, muttei mihinkään tiettyyn viestiin"},"toggle_whisper":{"label":"Kuiskaus päälle/pois","desc":"Kuiskaukset näkyvät vain henkilökunnan jäsenille"},"create_topic":{"label":"Uusi ketju"},"shared_draft":{"label":"Jaettu luonnos","desc":"Luonnostele ketju, joka näkyy vain määrätyille käyttäjille"},"toggle_topic_bump":{"label":"Ketjun nosto päälle/pois","desc":"Vastaa muuttamatta ketjun viimeisimmän vastauksen päivämäärää"}},"reload":"Lataa uudelleen","ignore":"Ohita","details_title":"Yhteenveto","details_text":"Tämä teksti piilotetaan"},"notifications":{"tooltip":{"regular":{"one":"%{count} uusi ilmoitus","other":"%{count} uutta ilmoitusta"},"message":{"one":"%{count} lukematon viesti","other":"%{count} lukematonta viestiä"},"high_priority":{"one":"%{count} lukematon korkean prioriteetin ilmoitus","other":"%{count} lukematonta korkean prioriteetin ilmoitusta"}},"title":"ilmoitukset @nimi-maininnoista, vastauksista omiin viesteihin ja ketjuihin, viesteistä ym.","none":"Ilmoitusten lataaminen ei onnistunut.","empty":"Ilmoituksia ei löytynyt.","post_approved":"Viestisi hyväksyttiin","reviewable_items":"käsittelyä odottavaa kohdetta","mentioned":"\u003cspan\u003e%{username}\u003c/span\u003e %{description}","group_mentioned":"\u003cspan\u003e%{username}\u003c/span\u003e %{description}","quoted":"\u003cspan\u003e%{username}\u003c/span\u003e %{description}","bookmark_reminder":"\u003cspan\u003e%{username}\u003c/span\u003e %{description}","replied":"\u003cspan\u003e%{username}\u003c/span\u003e %{description}","posted":"\u003cspan\u003e%{username}\u003c/span\u003e %{description}","edited":"\u003cspan\u003e%{username}\u003c/span\u003e %{description}","liked":"\u003cspan\u003e%{username}\u003c/span\u003e %{description}","liked_2":"\u003cspan class='double-user'\u003e%{username}, %{username2}\u003c/span\u003e %{description}","liked_many":{"one":"\u003cspan class='multi-user'\u003e%{username}, %{username2} ja %{count} muu\u003c/span\u003e %{description}","other":"\u003cspan class='multi-user'\u003e%{username}, %{username2} ja %{count} muuta\u003c/span\u003e %{description}"},"liked_consolidated_description":{"one":"tykkäsi %{count} viestistäsi","other":"tykkäsi %{count} viestistäsi"},"liked_consolidated":"\u003cspan\u003e%{username}\u003c/span\u003e %{description}","private_message":"\u003cspan\u003e%{username}\u003c/span\u003e %{description}","invited_to_private_message":"\u003cp\u003e\u003cspan\u003e%{username}\u003c/span\u003e %{description}","invited_to_topic":"\u003cspan\u003e%{username}\u003c/span\u003e %{description}","invitee_accepted":"\u003cspan\u003e%{username}\u003c/span\u003e hyväksyi kutsusi","moved_post":"\u003cspan\u003e%{username}\u003c/span\u003e siirsi kohteen %{description}","linked":"\u003cspan\u003e%{username}\u003c/span\u003e %{description}","granted_badge":"Ansaitsit kunniamerkin '%{description}'","topic_reminder":"\u003cspan\u003e%{username}\u003c/span\u003e %{description}","watching_first_post":"\u003cspan\u003eUusi ketju\u003c/span\u003e %{description}","membership_request_accepted":"Hyväksyttiin ryhmään '%{group_name}'","membership_request_consolidated":{"one":"%{count} avoin jäsenhakemus ryhmään '%{group_name}'","other":"%{count} avointa jäsenhakemusta ryhmään '%{group_name}'"},"reaction":"\u003cspan\u003e%{username}\u003c/span\u003e %{description}","reaction_2":"\u003cspan\u003e%{username}, %{username2}\u003c/span\u003e %{description}","votes_released":"%{description} – valmis","group_message_summary":{"one":"%{count} viesti ryhmän %{group_name} saapuneissa","other":"%{count} viestiä ryhmän %{group_name} saapuneissa"},"popup":{"mentioned":"%{username} mainitsi sinut ketjussa \"%{topic}\" – %{site_title}","group_mentioned":"%{username} mainitsi sinut ketjussa \"%{topic}\" – %{site_title}","quoted":"%{username} lainasi sinua ketjussa \"%{topic}\" – %{site_title}","replied":"%{username} vastasi sinulle ketjussa \"%{topic}\" – %{site_title}","posted":"%{username} lähetti viestin ketjuun \"%{topic}\" – %{site_title}","private_message":"%{username} lähetti sinulle yksityisviestin ketjussa \"%{topic}\" – %{site_title}","linked":"%{username} linkitti viestiisi ketjusta \"%{topic}\" – %{site_title}","watching_first_post":"%{username} loi uuden ketjun \"%{topic}\" – %{site_title}","confirm_title":"Ilmoitukset käytössä – %{site_title}","confirm_body":"Onnistui! Ilmoitukset ovat käytössä.","custom":"Ilmoitus käyttäjältä %{username} sivustolla %{site_title}"},"titles":{"mentioned":"mainitsi","replied":"uusi vastaus","quoted":"lainasi","edited":"muokkasi","liked":"uusi tykkäys","private_message":"uusi yksityisviesti","invited_to_private_message":"kutsuttiin yksityiskeskusteluun","invitee_accepted":"kutsu hyväksyttiin","posted":"uusi viesti","moved_post":"viesti siirrettiin","linked":"linkitti","bookmark_reminder":"kirjanmerkkimuistutus","bookmark_reminder_with_name":"kirjanmerkkimuistutus – %{name}","granted_badge":"kunniamerkki myönnettiin","invited_to_topic":"kutsuttiin ketjuun","group_mentioned":"ryhmä mainittiin","group_message_summary":"uusia ryhmäviestejä","watching_first_post":"uusi ketju","topic_reminder":"ketjumuistutus","liked_consolidated":"uusia tykkäyksiä","post_approved":"viesti hyväksytty","membership_request_consolidated":"uusia jäsenhakemuksia","reaction":"uusi reaktio","votes_released":"Ääni vapautui"}},"upload_selector":{"uploading":"Ladataan","processing":"Latausta käsitellään","select_file":"Valitse tiedosto","default_image_alt_text":"kuva"},"search":{"sort_by":"Järjestä","relevance":"Osuvuus","latest_post":"Uusin viesti","latest_topic":"Uusin ketju","most_viewed":"Katselluin","most_liked":"Tykätyin","select_all":"Valitse kaikki","clear_all":"Tyhjennä kaikki","too_short":"Hakusana on liian lyhyt.","result_count":{"one":"\u003cspan\u003e%{count} tulos haulle\u003c/span\u003e\u003cspan class='term'\u003e%{term}\u003c/span\u003e","other":"\u003cspan\u003e%{count}%{plus} tulosta haulle\u003c/span\u003e\u003cspan class='term'\u003e%{term}\u003c/span\u003e"},"title":"hae ketjuja, viestejä, käyttäjiä tai alueita","full_page_title":"hae ketjuja tai viestejä","no_results":"Ei tuloksia.","no_more_results":"Enempää tuloksia ei löytynyt.","post_format":"#%{post_number} käyttäjältä %{username}","results_page":"Tulokset hakusanalle '%{term}'","more_results":"Tuloksia olisi enemmänkin. Rajaa hakuasi.","cant_find":"Etkö löydä etsimääsi?","start_new_topic":"Haluaisitko aloittaa uuden ketjun?","or_search_google":"Tai kokeile Google-hakua:","search_google":"Kokeile Google-hakua:","search_google_button":"Google","search_button":"Hae","context":{"user":"Hae käyttäjän @%{username} viestejä","category":"Hae alueelta #%{category}","tag":"Hae tunnistetta #%{tag}","topic":"Hae tästä ketjusta","private_messages":"Hae viesteistä"},"advanced":{"title":"Tarkennettu haku","posted_by":{"label":"Kirjoittaja"},"in_category":{"label":"Alueella"},"in_group":{"label":"Kirjoittajan ryhmä"},"with_badge":{"label":"Kirjoittajalla kunniamerkki"},"with_tags":{"label":"Ketjulla on tunniste"},"filters":{"label":"Tuloksiin vain ketjuja/viestejä...","title":"Hae vain otsikoista","likes":"joista olen tykännyt","posted":"joihin olen kirjoittanut","created":"jotka minä aloitin","watching":"joita tarkkailen","tracking":"joita seuraan","private":"yksityiskeskusteluistani","bookmarks":"kirjanmerkeistäni","first":"jotka ovat ketjun avausviestejä","pinned":"jotka on kiinnitettyjä","seen":"jotka olen lukenut","unseen":"joita en ole lukenut","wiki":"ovat wiki-viestejä","images":"joissa on kuvia","all_tags":"Ketjulla on kaikki nämä tunnisteet"},"statuses":{"label":"Ketju/Ketjuun","open":"on avoin","closed":"on suljettu","public":"ovat julkisia","archived":"on arkistoitu","noreplies":"ei ole vastattu","single_user":"on kirjoittanut vain yksi käyttäjä"},"post":{"count":{"label":"Viestejä"},"min":{"placeholder":"vähintään"},"max":{"placeholder":"enintään"},"time":{"label":"Kirjoitettu","before":"ennen","after":"jälkeen"}},"views":{"label":"Katseluita"},"min_views":{"placeholder":"vähintään"},"max_views":{"placeholder":"enintään"}}},"hamburger_menu":"vaihda ketjulistausta tai siirry toiselle alueelle","new_item":"uusi","go_back":"palaa takaisin","not_logged_in_user":"käyttäjäsivu, jossa on yhteenveto käyttäjän viimeaikaisesta toiminnasta sekä käyttäjäasetukset","current_user":"siirry omalle käyttäjäsivullesi","view_all":"näytä kaikki %{tab}","topics":{"new_messages_marker":"edellinen vierailu","bulk":{"select_all":"Valitse kaikki","clear_all":"Tyhjennä kaikki","unlist_topics":"Poista ketjuja listauksista","relist_topics":"Palauta ketjuja listauksiin","reset_read":"Palauta lukutila","delete":"Poista ketjut","dismiss":"Kuittaa","dismiss_read":"Kuittaa luetuiksi","dismiss_read_with_selected":{"one":"Kuittaa %{count} lukematon","other":"Kuittaa %{count} lukematonta"},"dismiss_button":"Kuittaa...","dismiss_button_with_selected":{"one":"Kuittaa (%{count})…","other":"Kuittaa (%{count})…"},"dismiss_tooltip":"Kuittaa uudet viestit luetuiksi tai lopeta ketjujen seuraaminen","also_dismiss_topics":"Älä seuraa näitä ketjuja enää – ne eivät jatkossa lukemattomina","dismiss_new":"Kuittaa luetuksi","dismiss_new_with_selected":{"one":"Kuittaa uusi (%{count})","other":"Kuittaa uudet (%{count})"},"toggle":"Vaihda useamman ketjun valintaa","actions":"Joukkotoiminnot","close_topics":"Sulje ketjut","archive_topics":"Arkistoi ketjut","move_messages_to_inbox":"Siirrä saapuneisiin","change_notification_level":"Muuta ilmoitustasoa","choose_new_category":"Valitse uusi alue ketjuille:","selected":{"one":"Olet valinnut \u003cb\u003e%{count}\u003c/b\u003e ketjun.","other":"Olet valinnut \u003cb\u003e%{count}\u003c/b\u003e ketjua."},"change_tags":"Korvaa tunnisteet","append_tags":"Lisää tunnisteita","choose_new_tags":"Valitse tunnisteet näille ketjuille:","choose_append_tags":"Valitse ketjuille lisättävät uudet tunnisteet:","changed_tags":"Ketjujen tunnisteet muutettiin.","remove_tags":"Poista kaikki tunnisteet","confirm_remove_tags":{"one":"Kaikki tunnisteet poistetaan tästä ketjusta. Oletko varma?","other":"Kaikki tunnisteet poistetaan \u003cb\u003e%{count}\u003c/b\u003e ketjusta. Oletko varma?"},"progress":{"one":"Edetty: \u003cstrong\u003e%{count}\u003c/strong\u003e ketju","other":"Edetty: \u003cstrong\u003e%{count}\u003c/strong\u003e ketjua"}},"none":{"unread":"Sinulla ei ole lukemattomia ketjuja.","new":"Sinulla ei ole uusia ketjuja.","read":"Et ole lukenut vielä yhtään ketjua.","posted":"Et ole kirjoittanut vielä yhteenkään ketjuun.","latest":"Olet ajan tasalla!","bookmarks":"Sinulla ei ole vielä kirjanmerkkeihin lisättyjä ketjuja.","category":"Alueella %{category} ei ole ketjua.","top":"Suosittuja ketjuja ei ole.","educate":{"new":"\u003cp\u003eSinulle uudet ketjut näytetään tässä. Oletuksena ketju tulkitaan uudeksi ja sen yhteydessä näytetään \u003cspan class=\"badge new-topic badge-notification\" style=\"vertical-align:middle;line-height:inherit;\"\u003e\u003c/span\u003e-merkintä, jos se on aloitettu edellisten kahden päivän aikana.\u003c/p\u003e\u003cp\u003eAikarajaa voit muuttaa \u003ca href=\"%{userPrefsUrl}\"\u003ekäyttäjäasetuksissasi\u003c/a\u003e.\u003c/p\u003e","unread":"\u003cp\u003eLukemattomia viestejä sisältävät ketjut näytetään tässä.\u003c/p\u003e\u003cp\u003eKetjun yhteydessä näytetään lukemattomien viestien lukumäärä \u003cspan class=\"badge unread-posts badge-notification\"\u003e1\u003c/span\u003e, jos olet:\u003c/p\u003e\u003cul\u003e\u003cli\u003ealoittanut ketjun\u003c/li\u003e\u003cli\u003evastannut ketjuun\u003c/li\u003e\u003cli\u003elukenut ketjua pidempään kuin 4 minuuttia\u003c/li\u003e\u003c/ul\u003e\u003cp\u003etai, jos olet erikseen merkannut ketjun seurattavaksi tai tarkkailtavaksi ketjun lopusta löytyvälä painikkeella.\u003c/p\u003e\u003cp\u003eVoit muuttaa tätä \u003ca href=\"%{userPrefsUrl}\"\u003ekäyttäjäasetuksissasi\u003c/a\u003e.\u003c/p\u003e"}},"bottom":{"latest":"Tuoreimpia ketjuja ei ole enempää.","posted":"Ketjuja, joihin olet kirjoittanut, ei ole enempää.","read":"Luettuja ketjuja ei ole enempää.","new":"Uusia ketjuja ei ole enempää.","unread":"Ketjuja ei ole enempää lukematta.","category":"Alueen %{category} ketjuja ei ole enempää.","tag":"Tunnisteella %{tag} merkittyjä ketjuja ei ole enempää.","top":"Suosittuja ketjuja ei ole enempää.","bookmarks":"Kirjanmerkkeihin lisättyjä ketjuja ei ole enempää."}},"topic":{"filter_to":{"one":"%{count} viesti ketjussa","other":"%{count} viestiä ketjussa"},"create":"Uusi ketju","create_long":"Aloita uusi ketju","open_draft":"Avaa luonnos","private_message":"Luo viesti","archive_message":{"help":"Siirrä viesti arkistoosi","title":"Arkistoi"},"move_to_inbox":{"title":"Siirrä saapuneisiin","help":"Siirrä takaisin saapuneisiin."},"edit_message":{"help":"Muokkaa keskustelun ensimmäistä viestiä","title":"Muokkaa"},"defer":{"help":"Merkitse lukemattomaksi","title":"Lykkää"},"list":"Ketjut","new":"uusi ketju","unread":"lukematta","new_topics":{"one":"%{count} uusi ketju","other":"%{count} uutta ketjua"},"unread_topics":{"one":"%{count} ketju lukematta","other":"%{count} ketjua lukematta"},"title":"Ketju","invalid_access":{"title":"Tämä ketju on yksityinen","description":"Sinulla ei valitettavasti ole pääsyä tähän ketjuun!","login_required":"Sinun täytyy kirjautua sisään nähdäksesi tämän ketjun."},"server_error":{"title":"Ketjun lataaminen epäonnistui","description":"Ketjun lataaminen epäonnistui. Kyse saattaa olla yhteysongelmasta. Kokeile sivun lataamista uudestaan, ja jos ongelma jatkuu, ota meihin yhteyttä."},"not_found":{"title":"Ketjua ei löytynyt","description":"Ketjua ei valitettavasti löytynyt. Ehkäpä valvoja on poistanut sen?"},"unread_posts":{"one":"sinulla on %{count} lukematon viesti tässä ketjussa","other":"sinulla on %{count} lukematonta viestiä tässä ketjussa"},"likes":{"one":"tässä ketjussa on %{count} tykkäys","other":"tässä ketjussa on %{count} tykkäystä"},"back_to_list":"Takaisin ketjuluetteloon","options":"Ketjun asetukset","show_links":"näytä tämän ketjun linkit","collapse_details":"kutista ketjun tiedot","expand_details":"laajenna ketjun tiedot","read_more_in_category":"Haluatko lukea lisää? Selaile muita alueen %{catLink} ketjuja tai %{latestLink}.","read_more":"Haluatko lukea lisää? Selaa aluetta %{catLink} tai katsele %{latestLink}.","unread_indicator":"Kukaan jäsen ei ole lukenut ketjun viimeistä viestiä vielä.","browse_all_categories":"Selaa kaikkia alueita","browse_all_tags":"Selaa kaikkia tunnisteita","view_latest_topics":"katso tuoreimmat ketjut","suggest_create_topic":"Valmiina \u003ca href\u003ealoittamaan uuden keskustelun?\u003c/a\u003e","jump_reply_up":"siirry aiempaan vastaukseen","jump_reply_down":"siirry myöhempään vastaukseen","deleted":"Tämä ketju on poistettu","slow_mode_update":{"title":"Hidas tila","select":"Käyttäjän tulee odottaa ennen toisen viestin lähettämistä:","description":"Jotta keskustelu kiivaasti etenevästä tai tulenarasta aiheesta olisi harkitumpaa, käyttäjien täytyy odottaa ennen kuin he lähettävät uuden viestin tähän ketjuun.","enable":"Ota käyttöön","update":"Päivitä","enabled_until":"Aktiivisena tähän asti:","remove":"Poista käytöstä","hours":"Tuntia:","minutes":"Minuuttia:","seconds":"Sekuntia:","durations":{"10_minutes":"10 minuuttia","15_minutes":"15 minuuttia","30_minutes":"30 minuuttia","45_minutes":"45 minuuttia","1_hour":"1 tunti","2_hours":"2 tuntia","4_hours":"4 tuntia","8_hours":"8 tuntia","12_hours":"12 tuntia","24_hours":"24 tuntia","custom":"Valitse kesto"}},"slow_mode_notice":{"duration":"Tässä ketjussa on odotettava %{duration} viestien välillä."},"topic_status_update":{"title":"Ketjun ajastin","save":"Aseta ajastin","num_of_hours":"Tuntien määrä:","num_of_days":"Päivien määrä:","remove":"Poista ajastin","publish_to":"Mihin julkaistaan:","when":"Milloin:","time_frame_required":"Valitse ajanjakso","min_duration":"Keston on oltava suurempi kuin 0","max_duration":"Keston on oltava alle 20 vuotta"},"auto_update_input":{"none":"Valitse ajanjakso","now":"Nyt","later_today":"Myöhemmin tänään","tomorrow":"Huomenna","later_this_week":"Myöhemmin tällä viikolla","this_weekend":"Viikonloppuna","next_week":"Ensi viikolla","two_weeks":"Kaksi viikkoa","next_month":"Ensi kuussa","two_months":"Kaksi kuukautta","three_months":"Kolme kuukautta","four_months":"Neljä kuukautta","six_months":"Kuusi kuukautta","one_year":"Yksi vuosi","forever":"Ikuisesti","pick_date_and_time":"Valitse päivämäärä ja kellonaika","set_based_on_last_post":"Sulje viimeisimmän viestin mukaan"},"publish_to_category":{"title":"Julkaise määrättynä ajankohtana"},"temp_open":{"title":"Avaa väliaikaisesti"},"auto_reopen":{"title":"Avaa ketju automaattisesti"},"temp_close":{"title":"Sulje väliaikaisesti"},"auto_close":{"title":"Sulje ketju automaattisesti","label":"Sulje ketjut automaattisesti, kun on kulunut:","error":"Anna kelvollinen arvo.","based_on_last_post":"Älä sulje ennen kuin ketjun viimeisin viesti on ainakin näin vanha."},"auto_close_after_last_post":{"title":"Sulje ketju automaattisesti viimeisen viestin jälkeen"},"auto_delete":{"title":"Poista ketju automaattisesti"},"auto_bump":{"title":"Nosta ketjua automaattisesti"},"reminder":{"title":"Muistuta minua"},"auto_delete_replies":{"title":"Poista vastaukset automaattisesti"},"status_update_notice":{"auto_open":"Ketju avautuu automaattisesti %{timeLeft}.","auto_close":"Ketju suljetaan ajastetusti %{timeLeft}.","auto_publish_to_category":"Ketju julkaistaan alueella \u003ca href=%{categoryUrl}\u003e#%{categoryName}\u003c/a\u003e %{timeLeft}.","auto_close_after_last_post":"Ketju sulkeutuu %{duration} kuluttua viimeisimmästä vastauksesta.","auto_delete":"Ketju poistetaan automaattisesti %{timeLeft}.","auto_bump":"Ketjua nostetaan automaattisesti %{timeLeft}.","auto_reminder":"Sinua muistutetaan tästä ketjusta %{timeLeft}.","auto_delete_replies":"Tähän ketjuun tulevat vastaukset poistetaan automaattisesti %{duration} kuluttua."},"auto_close_title":"Automaattisen sulkemisen asetukset","auto_close_immediate":{"one":"Ketjun viimeisin viesti on jo %{count} tunnin vanha, joten ketju suljetaan heti.","other":"Ketjun viimeisin viesti on jo %{count} tuntia vanha, joten ketju suljetaan heti."},"auto_close_momentarily":{"one":"Ketjun viimeisin viesti on jo %{count} tunnin vanha, joten ketju suljetaan hetkellisesti.","other":"Ketjun viimeisin viesti on jo %{count} tuntia vanha, joten ketju suljetaan hetkellisesti."},"timeline":{"back":"Takaisin","back_description":"Siirry takaisin ensimmäiseen lukemattomaan viestiin","replies_short":"%{current} / %{total}"},"progress":{"title":"ketjun edistyminen","go_top":"alkuun","go_bottom":"loppuun","go":"siirry","jump_bottom":"siirry viimeisimpään viestiin","jump_prompt":"siirry...","jump_prompt_of":{"one":"%{count} viestistä","other":"%{count} viestistä"},"jump_prompt_long":"Siirry...","jump_bottom_with_number":"siirry viestiin %{post_number}","jump_prompt_to_date":"päivämäärään","jump_prompt_or":"tai","total":"viestejä yhteensä","current":"tämänhetkinen viesti"},"notifications":{"title":"muuta sitä, kuinka usein saat muistutuksia tästä ketjusta","reasons":{"mailing_list_mode":"Sinulla on postituslistatila käytössä, joten sinulle ilmoitetaan vastauksista tähän ketjuun sähköpostitse.","3_10":"Saat ilmoituksia, koska tarkkailet tähän ketjuun liittyvää tunnistetta.","3_10_stale":"Saat ilmoituksia, koska olet tarkkaillut tähän ketjuun liittyvää tunnistetta aikaisemmin.","3_6":"Saat ilmoituksia, koska olet asettanut tämän alueen tarkkailuun.","3_6_stale":"Saat ilmoituksia, koska olet tarkkaillut tätä aluetta aikaisemmin.","3_5":"Saat ilmoituksia, koska ketju on asetettu tarkkailuun automaattisesti.","3_2":"Saat ilmoituksia, koska olet asettanut ketjun tarkkailuun.","3_1":"Saat ilmoituksia, koska aloitit tämän ketjun.","3":"Saat ilmoituksia, koska olet asettanut ketjun tarkkailuun.","2_8":"Näet uusien vastausten määrän, koska olet asettanut tämän alueen seurantaan.","2_8_stale":"Näet uusien vastauksien määrän, koska olet seurannut tätä aluetta aikaisemmin.","2_4":"Näet uusien vastausten määrän, koska olet kirjoittanut ketjuun.","2_2":"Näet uusien vastausten määrän, koska olet asettanut ketjun seurantaan.","2":"Näet uusien vastausten määrän, koska \u003ca href=\"%{basePath}/u/%{username}/preferences/notifications\"\u003eluit tätä ketjua\u003c/a\u003e.","1_2":"Saat ilmoituksen, jos joku mainitsee @nimesi tai vastaa sinulle.","1":"Saat ilmoituksen, jos joku mainitsee @nimesi tai vastaa sinulle.","0_7":"Et saa mitään ilmoituksia tältä alueelta.","0_2":"Et saa mitään ilmoituksia tästä ketjusta.","0":"Et saa mitään ilmoituksia tästä ketjusta."},"watching_pm":{"title":"Tarkkailussa","description":"Saat ilmoituksen kaikista uusista vastauksista tähän viestiin, ja uusien vastausten lukumäärä näytetään."},"watching":{"title":"Tarkkailussa","description":"Saat ilmoituksen kaikista uusista vastauksista tähän ketjuun, ja uusien vastausten lukumäärä näytetään."},"tracking_pm":{"title":"Seurannassa","description":"Tälle viestille näytetään uusien vastausten lukumäärä. Saat ilmoituksen, jos joku mainitsee @nimesi tai vastaa sinulle."},"tracking":{"title":"Seurannassa","description":"Tälle ketjulle näytetään uusien vastausten lukumäärä. Saat ilmoituksen, jos joku mainitsee @nimesi tai vastaa sinulle."},"regular":{"title":"Tavallinen","description":"Saat ilmoituksen, jos joku mainitsee @nimesi tai vastaa sinulle."},"regular_pm":{"title":"Tavallinen","description":"Saat ilmoituksen, jos joku mainitsee @nimesi tai vastaa sinulle."},"muted_pm":{"title":"Vaimennettu","description":"Et saa mitään ilmoituksia tästä viestistä."},"muted":{"title":"Vaimennettu","description":"Et saa ilmoituksia mistään tässä ketjussa, eikä se näy tuoreimmissa."}},"actions":{"title":"Toiminnot","recover":"Peru ketjun poisto","delete":"Poista ketju","open":"Avaa ketju","close":"Sulje ketju","multi_select":"Valitse viestejä...","timed_update":"Aseta ajastin ketjulle...","pin":"Kiinnitä ketju...","unpin":"Poista ketjun kiinnitys...","unarchive":"Peru ketjun arkistointi","archive":"Arkistoi ketju","invisible":"Poista listauksista","visible":"Näytä listauksissa","reset_read":"Nollaa tiedot lukemisista","make_private":"Muuta yksityisviestiksi","reset_bump_date":"Palauta ketjun päiväysleima"},"feature":{"pin":"Kiinnitä ketju","unpin":"Poista ketjun kiinnitys","pin_globally":"Kiinnitä ketju koko palstalle","remove_banner":"Poista banneriketju"},"reply":{"title":"Vastaa","help":"aloita kirjoittamaan vastausta tähän ketjuun"},"share":{"title":"Jaa","extended_title":"Jaa linkki","help":"jaa linkki tähän ketjuun","instructions":"Jaa linkki tähän ketjuun:","copied":"Ketjun linkki kopioitu.","notify_users":{"title":"Ilmoita","instructions":"Ilmoita seuraaville käyttäjille tästä ketjusta:","success":{"one":"Tästä ketjusta ilmoitettiin käyttäjälle %{username}.","other":"Tästä ketjusta ilmoitettiin kaikille käyttäjille."}},"invite_users":"Kutsu"},"print":{"title":"Tulosta","help":"Avaa tulostettava versio tästä ketjusta"},"flag_topic":{"title":"Merkitse","help":"merkitse tämä ketju yksityisesti huomiota vaativaksi tai lähetä siitä yksityinen ilmoitus","success_message":"Ketjun merkintä onnistui."},"make_public":{"title":"Muuta julkiseksi ketjuksi","choose_category":"Valitse alue julkiselle ketjulle:"},"feature_topic":{"title":"Nosta tämä ketju","pin":"Kiinnitä tämä ketju alueen %{categoryLink} yläosaan, kunnes","unpin":"Poista tämä ketju alueen %{categoryLink} yläosasta.","unpin_until":"Poista tämä ketju alueen %{categoryLink} yläosasta, tai odota \u003cstrong\u003e%{until}\u003c/strong\u003e saakka.","pin_note":"Käyttäjät voivat poistaa ketjun kiinnityksen itseltään.","pin_validation":"Päivämäärä vaaditaan ketjun kiinnittämiseksi","not_pinned":"Alueella %{categoryLink} ei ole kiinnitettyjä ketjuja.","already_pinned":{"one":"Kiinnitettyjä ketjuja alueella %{categoryLink}: \u003cstrong class='badge badge-notification unread'\u003e%{count}\u003c/strong\u003e","other":"Kiinnitettyjä ketjuja alueella %{categoryLink}: \u003cstrong class='badge badge-notification unread'\u003e%{count}\u003c/strong\u003e"},"pin_globally":"Kiinnitä tämä ketju kaikkien alueiden yläosaan, kunnes","confirm_pin_globally":{"one":"Olet jo kiinnittänyt %{count} ketjun koko palstalle. Liian suuri kiinnitettyjen ketjujen määrä voi häiritä uusia sekä anonyymejä käyttäjiä. Oletko varma, että haluat kiinnittää yhden ketjun lisää koko palstalle?","other":"Olet jo kiinnittänyt %{count} ketjua koko palstalle. Liian suuri kiinnitettyjen ketjujen määrä voi häiritä uusia sekä anonyymejä käyttäjiä. Oletko varma, että haluat kiinnittää yhden ketjun lisää koko palstalle?"},"unpin_globally":"Poista tämä ketju kaikkien ketjuluetteloiden yläosasta.","unpin_globally_until":"Poista tämä ketju kaikkien ketjuluetteloiden yläosasta, tai odota \u003cstrong\u003e%{until}\u003c/strong\u003e saakka.","global_pin_note":"Käyttäjät voivat poistaa ketjun kiinnityksen itseltään.","not_pinned_globally":"Yhtään ketjua ei ole kiinnitetty koko palstalle.","already_pinned_globally":{"one":"Koko palstalle kiinnitettyjä ketjuja: \u003cstrong class='badge badge-notification unread'\u003e%{count}\u003c/strong\u003e","other":"Koko palstalle kiinnitettyjä ketjuja: \u003cstrong class='badge badge-notification unread'\u003e%{count}\u003c/strong\u003e"},"make_banner":"Tee tästä ketjusta banneri, joka näytetään kaikkien sivujen yläosassa.","remove_banner":"Poista banneri, joka näytetään kaikkien sivujen yläosassa.","banner_note":"Käyttäjät voivat piilottaa bannerin sulkemalla sen. Vain yksi ketju kerrallaan voi olla banneri.","no_banner_exists":"Banneriketjua ei ole määritelty.","banner_exists":"Banneriketju \u003cstrong class='badge badge-notification unread'\u003eon\u003c/strong\u003e määritelty."},"inviting":"Kutsutaan...","automatically_add_to_groups":"Tämä kutsu sisältää myös pääsyn näihin ryhmiin:","invite_private":{"title":"Kutsu viestiin","email_or_username":"Kutsuttavan sähköpostiosoite tai käyttäjätunnus","email_or_username_placeholder":"sähköpostiosoite tai käyttäjätunnus","action":"Kutsu","success":"Käyttäjä on kutsuttu osallistumaan tähän viestiin.","success_group":"Ryhmä on kutsuttu osallistumaan tähän viestiin.","error":"Kutsuttaessa käyttäjää tapahtui valitettavasti virhe.","not_allowed":"Tätä käyttäjää ei valitettavasti voi kutsua.","group_name":"ryhmän nimi"},"controls":"Ketjun hallinta","invite_reply":{"title":"Kutsu","username_placeholder":"käyttäjätunnus","action":"Lähetä kutsu","help":"Kutsu muita tähän ketjuun sähköpostitse tai ilmoitusten kautta","to_forum":"Lähetämme lyhyen sähköpostin, jonka avulla ystäväsi voi liittyä napsauttamalla linkkiä.","discourse_connect_enabled":"Syötä henkilön käyttäjätunnus, jonka haluaisit kutsua tähän ketjuun.","to_topic_blank":"Syötä henkilön käyttäjätunnus tai sähköpostiosoite, jonka haluaisit kutsua tähän ketjuun.","to_topic_email":"Syötit sähköpostiosoitteen. Lähetämme ystävällesi sähköpostin, jonka avulla hän voi heti vastata tähän ketjuun.","to_topic_username":"Annoit käyttäjätunnuksen. Lähetämme hänelle ilmoituksen, jossa on linkki ja kutsu tähän ketjuun.","to_username":"Kirjoita henkilön käyttäjätunnus, jonka haluat kutsua. Lähetämme hänelle ilmoituksen, jossa on linkki ja kutsu tähän ketjuun.","email_placeholder":"nimi@esimerkki.fi","success_email":"Olemme lähettäneet kutsun osoitteeseen \u003cb\u003e%{invitee}\u003c/b\u003e. Ilmoitamme, kun kutsuun on vastattu. Voit seurata käyttäjäsivusi kutsut-välilehdeltä kutsujesi tilannetta.","success_username":"Olemme kutsuneet käyttäjän osallistumaan tähän ketjuun.","error":"Emme valitettavasti onnistuneet kutsumaan tätä henkilöä. Ehkäpä hänet on jo kutsuttu? (Huomaa, että kutsumistiheyttä rajoitetaan)","success_existing_email":"Käyttäjä sähköpostiosoitteella \u003cb\u003e%{emailOrUsername}\u003c/b\u003e on jo olemassa. Hänet kutsuttiin osallistumaan tähän ketjuun."},"login_reply":"Kirjaudu sisään vastataksesi","filters":{"n_posts":{"one":"%{count} viesti","other":"%{count} viestiä"},"cancel":"Poista suodatin"},"move_to":{"title":"Siirrä","action":"siirrä","error":"Viestien siirtämisessä tapahtui virhe."},"split_topic":{"title":"Siirrä uuteen ketjuun","action":"siirrä uuteen ketjuun","topic_name":"Uuden ketjun otsikko","radio_label":"Uusi ketju","error":"Viestien siirtämisessä uuteen ketjuun tapahtui virhe.","instructions":{"one":"Olet luomassa uutta ketjua valitsemastasi viestistä.","other":"Olet aloittamassa uutta ketjua valitsemistasi \u003cb\u003e%{count}\u003c/b\u003e viestistä."}},"merge_topic":{"title":"Siirrä olemassa olevaan ketjuun","action":"siirrä olemassa olevaan ketjuun","error":"Viestien siirtämisessä ketjuun tapahtui virhe.","radio_label":"Olemassa oleva ketju","instructions":{"one":"Valitse ketju, johon haluat siirtää valitun viestin.","other":"Valitse ketju, johon haluat siirtää valitut \u003cb\u003e%{count}\u003c/b\u003e viestiä."}},"move_to_new_message":{"title":"Siirrä uuteen viestiin","action":"siirrä uuteen viestiin","message_title":"Uuden viestin otsikko","radio_label":"Uusi viesti","participants":"Osallistujat","instructions":{"one":"Olet luomassa uutta viestiä valitsemallasi viestillä.","other":"Olet luomassa uutta viestiä valitsemillasi \u003cb\u003e%{count}\u003c/b\u003e viestillä."}},"move_to_existing_message":{"title":"Siirrä olemassa olevaan viestiin","action":"siirrä olemassa olevaan viestiin","radio_label":"Olemassa oleva viesti","participants":"Osallistujat","instructions":{"one":"Valitse viesti, johon haluat siirtää tämän viestin.","other":"Valitse viesti, johon haluat siirtää nämä \u003cb\u003e%{count}\u003c/b\u003e viestiä."}},"merge_posts":{"title":"Yhdistä valitut viestit","action":"yhdistä valitut viestit","error":"Valittuja viestejä yhdistettäessä tapahtui virhe."},"publish_page":{"title":"Sivujulkaisu","publish":"Julkaise","description":"Kun ketju julkaistaan sivuna, sen URL-osoitteen voi jakaa ja se näytetään mukautetulla muotoiltuna.","slug":"Polkutunnus","public":"Julkinen","public_description":"Ihmiset näkevät sivun, vaikka siihen liittyvä ketju olisi yksityinen.","publish_url":"Sivusi julkaistiin osoitteessa:","topic_published":"Ketjusi julkaistiin osoitteessa;","preview_url":"Sivusi julkaistaan osoitteessa:","invalid_slug":"Et voi valitettavasti julkaista tätä sivua.","unpublish":"Peru julkaisu","unpublished":"Sivusi julkaisu peruttiin, eikä se ole enää käytettävissä.","publishing_settings":"Julkaisuasetukset"},"change_owner":{"title":"Vaihda omistajaa","action":"vaihda omistajuutta","error":"Viestin omistajan vaihdossa tapahtui virhe.","placeholder":"uuden omistajan käyttäjätunnus","instructions":{"one":"Valitse uusi omistaja käyttäjän \u003cb\u003e@%{old_user}\u003c/b\u003e viestille.","other":"Valitse uusi omistaja käyttäjän \u003cb\u003e@%{old_user}\u003c/b\u003e %{count} viestille."},"instructions_without_old_user":{"one":"Valitse uusi omistaja viestille","other":"Valitse uusi omistaja %{count} viestille"}},"change_timestamp":{"title":"Muuta aikaleimaa...","action":"muuta aikaleimaa","invalid_timestamp":"Aikaleima ei voi olla tulevaisuudessa.","error":"Ketjun aikaleiman vaihtamisessa tapahtui virhe","instructions":"Valitse ketjulle uusi aikaleima. Ketjun viestit päivitetään samalla aikaerolla."},"multi_select":{"select":"valitse","selected":"valittuna (%{count})","select_post":{"label":"valitse","title":"Lisää viesti valittuihin"},"selected_post":{"label":"valittu","title":"Poista viesti valituista klikkaamalla"},"select_replies":{"label":"valitse +vastaukset","title":"Lisää viesti ja kaikki sen vastaukset valittuihin"},"select_below":{"label":"valitse +myöhemmät","title":"Lisää viesti ja kaikki sitä myöhemmät valittuihin"},"delete":"poista valitut","cancel":"peruuta valinta","select_all":"valitse kaikki","deselect_all":"poista kaikkien valinta","description":{"one":"Olet valinnut \u003cb\u003e%{count}\u003c/b\u003e viestin.","other":"Olet valinnut \u003cb\u003e%{count}\u003c/b\u003e viestiä."}},"deleted_by_author_simple":"(kirjoittajan poistama ketju)"},"post":{"quote_reply":"Lainaa","quote_share":"Jaa","edit_reason":"Syy: ","post_number":"viesti %{number}","ignored":"Sivuutettua sisältöä","wiki_last_edited_on":"wikiä muokattu viimeksi %{dateTime}","last_edited_on":"viestiä muokattu viimeksi %{dateTime}","reply_as_new_topic":"Vastaa liittyvässä ketjussa","reply_as_new_private_message":"Vastaa samoille vastaanottajille uudessa viestissä","continue_discussion":"Jatkoa ketjulle %{postLink}:","follow_quote":"siirry lainattuun viestiin","show_full":"Näytä koko viesti","show_hidden":"Katso sivuutettu sisältö.","deleted_by_author_simple":"(kirjoittajan poistama viesti)","collapse":"kutista","expand_collapse":"laajenna/kutista","locked":"henkilökunnan jäsen on estänyt tämän viestin muokkaamisen","gap":{"one":"näytä %{count} piilotettu vastaus","other":"näytä %{count} piilotettua vastausta"},"notice":{"new_user":"Tämä on ensimmäinen kerta kun %{user} kirjoittaa — toivotetaan hänet tervetulleeksi yhteisöömme!","returning_user":"Siitä on aikaa kun %{user} on viimeksi nähty — hän oli viimeksi kirjoittanut %{time}."},"unread":"Viesti on lukematta","has_replies":{"one":"%{count} vastaus","other":"%{count} vastausta"},"has_replies_count":"%{count}","unknown_user":"(tuntematon/poistettu käyttäjä)","has_likes_title":{"one":"%{count} käyttäjä tykkäsi tästä viestistä","other":"%{count} käyttäjää tykkäsi tästä viestistä"},"has_likes_title_only_you":"tykkäsit tästä viestistä","has_likes_title_you":{"one":"Sinä ja %{count} muuta tykkäsitte tästä viestistä","other":"Sinä ja %{count} muuta tykkäsitte tästä viestistä"},"filtered_replies_hint":{"one":"Näytä tämä viesti ja siihen liittyvä vastaus","other":"Näytä tämä viesti ja %{count} siihen liittyvää vastausta"},"filtered_replies_viewing":{"one":"Katsellaan %{count} vastausta","other":"Katsellaan %{count} vastausta"},"in_reply_to":"Lataa emoviesti","view_all_posts":"Näytä kaikki viestit","errors":{"create":"Viestin luonti epäonnistui. Yritä uudelleen.","edit":"Viestin muokkaus epäonnistui. Yritä uudelleen.","upload":"Tiedoston lataaminen epäonnistui. Yritä uudelleen.","file_too_large":"Tiedosto on valitettavasti liian suuri (enimmäiskoko on %{max_size_kb} kt). Mitäpä jos lataisit suuren tiedostosi johonkin pilvipalveluun ja jakaisit linkin?","too_many_uploads":"Voit ladata vain yhden tiedoston kerrallaan.","too_many_dragged_and_dropped_files":{"one":"Voit ladata vain %{count} tiedoston kerrallaan.","other":"Voit ladata vain %{count} tiedostoa kerrallaan."},"upload_not_authorized":"Tiedosto. jota yrität ladata, ei ole sallittu (sallitut päätteet: %{authorized_extensions}).","image_upload_not_allowed_for_new_user":"Uudet käyttäjät eivät saa ladata kuvia.","attachment_upload_not_allowed_for_new_user":"Uudet käyttäjät eivät saa ladata liitteitä.","attachment_download_requires_login":"Sinun täytyy kirjautua sisään, jotta voit ladata liitetiedostoja."},"cancel_composer":{"confirm":"Mitä haluaisit tehdä viestillesi?","discard":"Hylkää","save_draft":"Tallenna luonnos myöhempää käyttöä varten","keep_editing":"Jatka muokkaamista"},"via_email":"tämä viesti lähetettiin sähköpostitse","via_auto_generated_email":"tämä viesti saapui automaattisesti luotuna sähköpostina","whisper":"tämä viesti on yksityinen kuiskaus valvojille","wiki":{"about":"tämä viesti on wiki-viesti"},"few_likes_left":"Kiitos hyvän mielen levittämisestä! Sinulla on enää muutama tykkäys jäljellä tälle päivälle.","controls":{"reply":"aloita vastaamaan tähän viestiin","like":"tykkää viestistä","has_liked":"tykkäsit tästä viestistä","read_indicator":"jäsenet, jotka ovat lukeneet tämän viestin","undo_like":"peru tykkäys","edit":"muokkaa viestiä","edit_action":"Muokkaa","edit_anonymous":"Sinun täytyy ensin kirjautua sisään, jotta voit muokata tätä viestiä.","flag":"merkitse tämä viesti yksityisesti huomiota vaativaksi tai lähetä siitä yksityinen ilmoitus","delete":"poista tämä viesti","undelete":"peru viestin poistaminen","share":"jaa linkki tähän viestiin","more":"Lisää","delete_replies":{"confirm":"Haluatko poistaa myös tähän viestiin liittyvät vastaukset?","direct_replies":{"one":"Kyllä, ja %{count} suora vastaus","other":"Kyllä, ja %{count} suoraa vastausta"},"all_replies":{"one":"Kyllä, ja %{count} vastaus","other":"Kyllä, ja kaikki %{count} vastausta"},"just_the_post":"Ei, vain tämä viesti"},"admin":"viestin ylläpitotoimet","wiki":"Tee wiki","unwiki":"Poista wiki","convert_to_moderator":"Lisää henkilökunnan taustaväri","revert_to_regular":"Poista henkilökunnan taustaväri","rebake":"Koosta HTML uudelleen","publish_page":"Sivujulkaisu","unhide":"Poista piilotus","lock_post":"Lukitse viesti","lock_post_description":"estä kirjoittajaa muokkaamasta tätä viestiä","unlock_post":"Poista viestin lukitus","unlock_post_description":"salli kirjoittajan muokata viestiä","delete_topic_disallowed_modal":"Sinulla ei ole oikeutta poistaa tätä ketjua. Jos haluat sen poistetuksi, merkitse se perustelujen kera, ja valvoja päättää poistamisesta.","delete_topic_disallowed":"sinulla ei ole oikeutta poistaa tätä ketjua","delete_topic_confirm_modal":{"one":"Ketjua on katseltu yli %{count} kerran, ja se voi olla suosittu hakutulos. Haluatko varmasti poistaa ketjun kokonaan sen sijaan, että muokkaisit sitä paremmaksi?","other":"Ketjua on katseltu yli %{count} kertaa, ja se voi olla suosittu hakutulos. Haluatko varmasti poistaa ketjun kokonaan sen sijaan, että muokkaisit sitä paremmaksi?"},"delete_topic_confirm_modal_yes":"Kyllä, poista ketju","delete_topic_confirm_modal_no":"Ei, säilytä ketju","delete_topic_error":"Ketjua poistettaessa tapahtui virhe","delete_topic":"poista ketju","delete_post_notice":"Poista ilmoitus henkilökunnalle","remove_timer":"poista ajastin","edit_timer":"muokkaa ajastusta"},"actions":{"people":{"like":{"one":"tykkäsi tästä","other":"tykkäsivät tästä"},"read":{"one":"luki tämän","other":"lukivat tämän"},"like_capped":{"one":"ja %{count} muu tykkäsivät tästä","other":"ja %{count} muuta tykkäsivät tästä"},"read_capped":{"one":"ja %{count} muu lukivat tämän","other":"ja %{count} muuta lukivat tämän"}},"by_you":{"off_topic":"Merkitsit tämän eksyvän aiheesta","spam":"Merkitsit tämän roskapostiksi","inappropriate":"Merkitsit tämän sopimattomaksi","notify_moderators":"Merkitsit tämän valvojille tiedoksi","notify_user":"Lähetit viestin tälle käyttäjälle"}},"delete":{"confirm":{"one":"Oletko varma, että haluat poistaa viestin?","other":"Oletko varma, että haluat poistaa %{count} viestiä?"}},"merge":{"confirm":{"one":"Oletko varma, että haluat yhdistää nämä viestit?","other":"Oletko varma, että haluat yhdistää nämä %{count} viestiä?"}},"revisions":{"controls":{"first":"Ensimmäinen revisio","previous":"Edellinen revisio","next":"Seuraava revisio","last":"Viimeinen revisio","hide":"Piilota revisio","show":"Näytä revisio","revert":"Palaa revisioon %{revision}","edit_wiki":"Muokkaa wikiä","edit_post":"Muokkaa viestiä","comparing_previous_to_current_out_of_total":"\u003cstrong\u003e%{previous}\u003c/strong\u003e %{icon} \u003cstrong\u003e%{current}\u003c/strong\u003e / %{total}"},"displays":{"inline":{"title":"Näytä lisäykset ja poistot tekstin osana","button":"HTML"},"side_by_side":{"title":"Näytä muokkauksen versiot vierekkäin","button":"HTML"},"side_by_side_markdown":{"title":"Näytä viestien lähdekoodit erot vierekkäin","button":"Raaka"}}},"raw_email":{"displays":{"raw":{"title":"Näytä raaka sähköposti","button":"Raaka"},"text_part":{"title":"Näytä sähköpostin tekstiosa","button":"Teksti"},"html_part":{"title":"Näytä sähköpostin HTML-osa","button":"HTML"}}},"bookmarks":{"create":"Luo kirjanmerkki","edit":"Muokkaa kirjanmerkkiä","created":"Luotu","updated":"Päivitetty","name":"Nimi","name_placeholder":"Mitä varten kirjanmerkki on?","set_reminder":"Muistuta minua","options":"Asetukset","actions":{"delete_bookmark":{"name":"Poista kirjanmerkki","description":"Poistaa kirjanmerkin profiilistasi ja kumoaa kaikki kirjanmerkkiin liittyvät muistutukset"},"edit_bookmark":{"name":"Muokkaa kirjanmerkkiä","description":"Muokkaa kirjanmerkin nimeä tai muuta muistutuksen päivämäärää ja kellonaikaa"},"pin_bookmark":{"name":"Kiinnitä kirjanmerkki","description":"Kiinnitä kirjanmerkki. Näin se näkyy kirjanmerkkiluettelon yläosassa."},"unpin_bookmark":{"name":"Poista kirjanmerkin kiinnitys","description":"Poista kirjanmerkin kiinnitys. Se ei enää näy kirjanmerkkiluettelon yläosassa."}}},"filtered_replies":{"viewing_posts_by":"Katsellaan %{post_count} viestiä käyttäjältä","viewing_subset":"Jotkin vastaukset on kutistettu","viewing_summary":"Katsellaan ketjun yhteenvetoa","post_number":"%{username}, viesti #%{post_number}","show_all":"Näytä kaikki"}},"category":{"none":"(ei aluetta)","all":"Kaikki alueet","choose":"alue\u0026hellip;","edit":"Muokkaa","edit_dialog_title":"Muokkaa: %{categoryName}","view":"Katsele alueen ketjuja","back":"Takaisin alueelle","general":"Yleistä","settings":"Asetukset","topic_template":"Ketjun mallipohja","tags":"Tunnisteet","tags_allowed_tags":"Rajaa nämä tunnisteet tälle alueelle:","tags_allowed_tag_groups":"Rajaa nämä tunnisteryhmät tälle alueelle:","tags_placeholder":"(Valinnainen) lista sallituista tunnisteista","tags_tab_description":"Yllä määritellyt tunnisteet ja tunnisteryhmät ovat käytössä vain tällä alueella sekä muilla alueilla, jotka ovat myös määrittäneet ne. Ne eivät ole käytettävissä muilla alueilla.","tag_groups_placeholder":"(Valinnainen) lista sallituista tunnisteryhmistä","manage_tag_groups_link":"Hallitse tunnisteryhmiä","allow_global_tags_label":"Salli myös muut tunnisteet","tag_group_selector_placeholder":"(Valinnainen) tunnisteryhmä","required_tag_group_description":"Edellytä, että uudella ketjulla on tunnisteita tunnisteryhmästä:","min_tags_from_required_group_label":"Tunnisteiden määrä:","required_tag_group_label":"Tunnisteryhmä:","topic_featured_link_allowed":"Salli ketjulinkit tällä alueella","delete":"Poista alue","create":"Uusi alue","create_long":"Luo uusi alue","save":"Tallenna alue","slug":"Alueen polkutunnus","slug_placeholder":"(Valinnainen) väliviivoilla erotettuja sanoja URL-osoitetta varten","creation_error":"Alueen luonnissa tapahtui virhe.","save_error":"Alueen tallennuksessa tapahtui virhe.","name":"Alueen nimi","description":"Kuvaus","logo":"Alueen logokuva","background_image":"Alueen taustakuva","badge_colors":"Kunniamerkin värit","background_color":"Taustaväri","foreground_color":"Edustaväri","name_placeholder":"Enintään yksi tai kaksi sanaa","color_placeholder":"Mikä tahansa verkkoväri","delete_confirm":"Oletko varma, että haluat poistaa tämän alueen?","delete_error":"Alueen poistossa tapahtui virhe.","list":"Listaa alueet","no_description":"Lisää alueelle kuvaus.","change_in_category_topic":"Muokkaa kuvausta","already_used":"Tämä väri on jo käytössä toisella alueella","security":"Turvallisuus","security_add_group":"Lisää ryhmä","permissions":{"group":"Ryhmä","see":"Katselu","reply":"Vastaus","create":"Aloitus","no_groups_selected":"Millekään ryhmällä ei ole myönnetty pääsyä; alue näkyy vain henkilökunnalle.","everyone_has_access":"Tämä alue on julkinen: kaikki voivat lukea, vastata ja luoda viestejä. Voit rajoittaa oikeuksia poistamalla yhden tai useamman ryhmälle \"kaikki\" annetuista oikeuksista.","toggle_reply":"Muuta vastausoikeutta","toggle_full":"Muuta aloitusoikeutta","inherited":"Tämä oikeus periytyy ryhmältä \"kaikki\""},"special_warning":"Varoitus: Tämä on asennusvaiheessa luotu alue, eikä sen turvallisuusasetuksia voi muuttaa. Jos et halua käyttää tätä aluetta, älä muuta sen käyttötarkoitusta, vaan poista se.","uncategorized_security_warning":"Tämä alue on erityinen. Se on tarkoitettu säilytyspaikaksi ketjuille, joilla ei ole aluetta; sille ei voi määritellä turvallisuusasetuksia.","uncategorized_general_warning":"Tämä alue on erityinen. Se on oletusalue uusille ketjuille, joille ei ole valittu aluetta. Jos et kaipaa tätä ja haluat mieluummin pakottaa valitsemaan alueen, \u003ca href=\"%{settingLink}\"\u003epoista asetus käytöstä täällä\u003c/a\u003e. Jos haluat vaihtaa nimeä tai kuvasta, siirry kohtaan \u003ca href=\"%{customizeLink}\"\u003eMukauta / Tekstisisältö\u003c/a\u003e.","pending_permission_change_alert":"Et ole lisännyt ryhmää %{group} tälle alueelle; lisää klikkaamalla tätä painiketta.","images":"Kuvat","email_in":"Mukautettu saapuvan postin sähköpostiosoite:","email_in_allow_strangers":"Hyväksy sähköpostit anonyymeiltä käyttäjiltä, joilla ei ole tiliä","email_in_disabled":"Uusien ketjujen aloittaminen sähköpostitse on poistettu käytöstä sivuston asetuksissa. Salliaksesi uusien ketjujen luomisen sähköpostilla, ","email_in_disabled_click":"ota käyttöön saapuvien sähköpostien asetus.","mailinglist_mirror":"Alue jäljittelee postituslistaa","show_subcategory_list":"Näytä ala-alueiden luettelo ketjujen yläpuolella tällä alueella.","read_only_banner":"Banneriteksti, joka näytetään, jos käyttäjä ei voi aloittaa ketjua tälle alueelle:","num_featured_topics":"Aluesivulla näytettävien ketjujen määrä:","subcategory_num_featured_topics":"Ylätason alueen sivulla näytettävien ketjujen määrä:","all_topics_wiki":"Tee uusista ketjuista wiki-viestejä oletuksena","allow_unlimited_owner_edits_on_first_post":"Salli rajattomat omistajan muokkaukset ensimmäisessä viestissä","subcategory_list_style":"Ala-alueluettelon tyyli:","sort_order":"Ketjuluettelon järjestys:","default_view":"Oletusketjuluettelo:","default_top_period":"Suositut-listauksen oletusajanjakso:","default_list_filter":"Oletusluettelosuodatin:","allow_badges_label":"Salli kunniamerkkien myöntäminen tällä alueella","edit_permissions":"Muokkaa oikeuksia","reviewable_by_group":"Henkilökunnan lisäksi tämän alueen sisältöä voi käsitellä myös:","review_group_name":"ryhmän nimi","require_topic_approval":"Edellytä valvojan hyväksyntää kaikille uusille ketjuille","require_reply_approval":"Edellytä valvojan hyväksyntää kaikille uusille vastauksille","this_year":"tänä vuonna","position":"Sijoitus aluesivulla:","default_position":"Oletussijoitus","position_disabled":"Alueet näytetään aktiivisuusjärjestyksessä. Muokataksesi järjestystä, ","position_disabled_click":"ota käyttöön pysyvien aluesijoitusten asetus.","minimum_required_tags":"Ketjussa vaadittavien tunnisteiden vähimmäismäärä:","parent":"Ylätason alue","num_auto_bump_daily":"Päivittäin nostettavien avointen ketjujen määrä:","navigate_to_first_post_after_read":"Siirry ensimmäiseen viestiin, kun ketjut on luettu","notifications":{"watching":{"title":"Tarkkailu","description":"Tarkkailet automaattisesti kaikkia ketjuja tällä alueella. Saat ilmoituksen jokaisesta uudesta viestistä missä tahansa ketjussa, ja uusien vastausten määrä näytetään."},"watching_first_post":{"title":"Tarkkaillaan ensimmäistä viestiä","description":"Saat ilmoituksia uusista tämän alueen ketjuista, muttet ketjuihin tulevista vastauksista."},"tracking":{"title":"Seuranta","description":"Seuraat automaattisesti kaikkia ketjuja tällä alueella. Saat ilmoituksen, jos joku mainitsee @nimesi tai vastaa sinulle, ja uusien vastausten määrä näytetään."},"regular":{"title":"Tavallinen","description":"Saat ilmoituksen, jos joku mainitsee @nimesi tai vastaa sinulle."},"muted":{"title":"Vaimennettu","description":"Et saa ilmoituksia uusista ketjuista tällä alueella, eivätkä ne näy tuoreimmissa."}},"search_priority":{"label":"Hakuprioriteetti","options":{"normal":"Normaali","ignore":"Sivuuta","very_low":"Erittäin matala","low":"Matala","high":"Korkea","very_high":"Erittäin korkea"}},"sort_options":{"default":"oletus","likes":"Tykkäykset","op_likes":"Avausviestin tykkäykset","views":"Katselut","posts":"Viestit","activity":"Toiminta","posters":"Kirjoittajat","category":"Alue","created":"Luomisaika"},"sort_ascending":"Nouseva","sort_descending":"Laskeva","subcategory_list_styles":{"rows":"Rivit","rows_with_featured_topics":"Rivit ja valikoituja ketjuja","boxes":"Laatikot","boxes_with_featured_topics":"Laatikot, joissa esiteltyjä ketjuja"},"settings_sections":{"general":"Yleistä","moderation":"Valvonta","appearance":"Ulkoasu","email":"Sähköposti"},"list_filters":{"all":"kaikki ketjut","none":"ei ala-alueita"},"colors_disabled":"Et voi valita värejä, koska alueen tyyliksi on asetettu 'ei mikään'"},"flagging":{"title":"Kiitos avustasi yhteisön hyväksi!","action":"Merkitse viesti","take_action":"Ryhdy toimiin...","take_action_options":{"default":{"title":"Ryhdy toimiin","details":"Ylitä merkintöjen kynnysmäärä välittömästi, odottamatta enempää yhteisön jäsenten merkintöjä"},"suspend":{"title":"Hyllytä käyttäjä","details":"Ylitä merkintöjen kynnysmäärä ja hyllytä käyttäjä"},"silence":{"title":"Hiljennä käyttäjä","details":"Ylitä merkintöjen kynnysmäärä ja hiljennä käyttäjä"}},"notify_action":"Viesti","official_warning":"Virallinen varoitus","delete_spammer":"Poista roskapostittaja","flag_for_review":"Tarkastettavien jono","yes_delete_spammer":"Kyllä, poista roskapostittaja","ip_address_missing":"-","hidden_email_address":"(piilotettu)","submit_tooltip":"Lähetä yksityinen merkintä","take_action_tooltip":"Ylitä merkintöjen kynnysmäärä välittömästi, odottamatta enempää yhteisön jäsenten merkintöjä","cant":"Et valitettavasti voi merkitä tätä viestiä tällä hetkellä.","notify_staff":"Ilmoita henkilökunnalle yksityisesti","formatted_name":{"off_topic":"Se eksyy aiheesta","inappropriate":"Se on sopimaton","spam":"Se on roskapostia"},"custom_placeholder_notify_user":"Esitä asiasi ymmärrettävästi, ole rakentava ja kohtelias.","custom_placeholder_notify_moderators":"Kerro ymmärrettävästi ja selvästi, mistä olet huolestunut ja lisää viestiin oleelliset esimerkit ja linkit, jos mahdollista.","custom_message":{"at_least":{"one":"syötä vähintään %{count} merkki","other":"syötä vähintään %{count} merkkiä"},"more":{"one":"Vielä %{count}...","other":"Vielä %{count}..."},"left":{"one":"%{count} jäljellä","other":"%{count} jäljellä"}}},"flagging_topic":{"title":"Kiitos avustasi yhteisön hyväksi!","action":"Merkitse ketju","notify_action":"Viesti"},"topic_map":{"title":"Ketjun yhteenveto","participants_title":"Useimmin kirjoittaneet","links_title":"Suositut linkit","links_shown":"näytä enemmän linkkejä...","clicks":{"one":"%{count} klikkaus","other":"%{count} klikkausta"}},"post_links":{"about":"laajenna lisää linkkejä tähän viestiin","title":{"one":"%{count} lisää","other":"%{count} lisää"}},"topic_statuses":{"warning":{"help":"Tämä on virallinen varoitus."},"bookmarked":{"help":"Olet lisännyt tämän ketjun kirjanmerkkeihisi"},"locked":{"help":"Tämä ketju on suljettu; siihen ei voi enää vastata."},"archived":{"help":"Tämä ketju on arkistoitu; se on jäädytetty, eikä sitä voi muuttaa"},"locked_and_archived":{"help":"Tämä ketju on suljettu ja arkistoitu, sihen ei voi enää vastata, eikä sitä voi muuttaa"},"unpinned":{"title":"Kiinnitys poistettu","help":"Ketjun kiinnitys on poistettu sinulta; se näytetään tavallisessa järjestyksessä."},"pinned_globally":{"title":"Kiinnitetty koko palstalle","help":"Tämä ketju on kiinnitetty koko palstalle; se näytetään tuoreimpien ja oman alueensa yläosassa"},"pinned":{"title":"Kiinnitetty","help":"Tämä ketju on kiinnitetty sinulle; se näytetään alueensa yläosassa"},"unlisted":{"help":"Tämä ketju on piilotettu; sitä ei näytetä ketjuluetteloissa, ja siihen pääsee vain suoran linkin kautta"},"personal_message":{"title":"Tämä ketju on yksityisviesti","help":"Tämä ketju on yksityisviesti"}},"posts":"Viestejä","original_post":"Aloitusviesti","views":"Katseluita","views_lowercase":{"one":"katselu","other":"katselua"},"replies":"Vastauksia","views_long":{"one":"ketjua on katseltu %{count} kerran","other":"ketjua on katseltu %{number} kertaa"},"activity":"Toiminta","likes":"Tykkäykset","likes_lowercase":{"one":"tykkäys","other":"tykkäystä"},"users":"Käyttäjät","users_lowercase":{"one":"käyttäjä","other":"käyttäjää"},"category_title":"Alue","history_capped_revisions":"Historia, viimeiset 100 versiota","changed_by":"käyttäjältä %{author}","raw_email":{"title":"Saapuva sähköposti","not_available":"Ei käytettävissä!"},"categories_list":"Alueluettelo","filters":{"with_topics":"%{filter} ketjut","with_category":"%{filter} %{category} ketjut","latest":{"title":"Tuoreimmat","title_with_count":{"one":"Tuoreimmat (%{count})","other":"Tuoreimmat (%{count})"},"help":"ketjut, joissa on viimeaikaisia viestejä"},"read":{"title":"Luetut","help":"lukemasi ketjut, lukemisjärjestyksessä"},"categories":{"title":"Alueet","title_in":"Alue – %{categoryName}","help":"kaikki ketjut alueen mukaan järjestettynä"},"unread":{"title":"Lukematta","title_with_count":{"one":"Lukematta (%{count})","other":"Lukematta (%{count})"},"help":"ketjut, joita seuraat tai tarkkailet tällä hetkellä ja joissa on lukemattomia viestejä","lower_title_with_count":{"one":"%{count} lukematta","other":"%{count} lukematta"}},"new":{"lower_title_with_count":{"one":"%{count} uusi","other":"%{count} uutta"},"lower_title":"uusi","title":"Uudet","title_with_count":{"one":"Uudet (%{count})","other":"Uudet (%{count})"},"help":"viime päivinä aloitetut ketjut"},"posted":{"title":"Viestini","help":"ketjut, joihin olet kirjoittanut"},"bookmarks":{"title":"Kirjanmerkit","help":"ketjut, jotka olet lisännyt kirjanmerkkeihin"},"category":{"title":"%{categoryName}","title_with_count":{"one":"%{categoryName} (%{count})","other":"%{categoryName} (%{count})"},"help":"Tuoreimmat alueella %{categoryName}"},"top":{"title":"Suositut","help":"Aktiivisimmat ketjut viimeisen vuoden, kuukauden ja päivän ajalta","all":{"title":"Kaikkina aikoina"},"yearly":{"title":"Vuosittain"},"quarterly":{"title":"Neljännesvuosittain"},"monthly":{"title":"Kuukausittain"},"weekly":{"title":"Viikoittain"},"daily":{"title":"Päivittäin"},"all_time":"Kaikkina aikoina","this_year":"Vuosi","this_quarter":"Vuosineljännes","this_month":"Kuukausi","this_week":"Viikko","today":"Tänään","other_periods":"katso suosituimmat:"}},"browser_update":"Valitettavasti \u003ca href=\"https://www.discourse.org/faq/#browser\"\u003eselaimesi on liian vanha eikä siksi toimi tällä sivustolla\u003c/a\u003e. \u003ca href=\"https://browsehappy.com\"\u003ePäivitä selaimesi\u003c/a\u003e, niin voit katsella monipuolista sisältöä, kirjautua sisään ja vastata.","permission_types":{"full":"Luoda / Vastata / Nähdä","create_post":"Vastata / Nähdä","readonly":"Nähdä"},"lightbox":{"download":"lataa","previous":"Edellinen (vasen nuolinäppäin)","next":"Seuraava (oikea nuolinäppäin)","counter":"%curr% / %total%","close":"Sulje (Esc)","content_load_error":"\u003ca href=\"%url%\"\u003eSisällön\u003c/a\u003e lataaminen ei onnistunut.","image_load_error":"\u003ca href=\"%url%\"\u003eKuvan\u003c/a\u003e lataaminen ei onnistunut."},"cannot_render_video":"Tätä videota ei voida toistaa, koska selaimesi ei tue tarvittavaa koodekkia.","keyboard_shortcuts_help":{"shortcut_key_delimiter_comma":", ","shortcut_key_delimiter_plus":"+","shortcut_delimiter_or":"%{shortcut1} tai %{shortcut2}","shortcut_delimiter_slash":"%{shortcut1}/%{shortcut2}","shortcut_delimiter_space":"%{shortcut1} %{shortcut2}","title":"Pikanäppäimet","jump_to":{"title":"Siirry","home":"%{shortcut} Aloitussivulle","latest":"%{shortcut} Tuoreimmat","new":"%{shortcut} Uudet","unread":"%{shortcut} Lukemattomat","categories":"%{shortcut} Alueet","top":"%{shortcut} Suositut","bookmarks":"%{shortcut} Kirjanmerkit","profile":"%{shortcut} Profiili","messages":"%{shortcut} Viestit","drafts":"%{shortcut} Luonnokset","next":"%{shortcut} Seuraava ketju","previous":"%{shortcut} Edellinen ketju"},"navigation":{"title":"Navigointi","jump":"%{shortcut} Siirry viestiin #","back":"%{shortcut} Takaisin","up_down":"%{shortcut} Siirrä valintaa \u0026uarr; \u0026darr;","open":"%{shortcut} Avaa valittu ketju","next_prev":"%{shortcut} Seuraava/edellinen osa","go_to_unread_post":"%{shortcut} Siirry ensimmäiseen lukemattomaan viestiin"},"application":{"title":"Sovellus","create":"%{shortcut} Aloita uusi ketju","notifications":"%{shortcut} Avaa ilmoitukset","hamburger_menu":"%{shortcut} Avaa hampurilaisvalikko","user_profile_menu":"%{shortcut} Avaa käyttäjävalikko","show_incoming_updated_topics":"%{shortcut} Näytä päivitetyt ketjut","search":"%{shortcut} Haku","help":"%{shortcut} Näytä näppäinohjeet","dismiss_new":"%{shortcut} Kuittaa uudet","dismiss_topics":"%{shortcut} Kuittaa ketjut","log_out":"%{shortcut} Kirjaudu ulos"},"composing":{"title":"Kirjoittaminen","return":"%{shortcut} Palaa kirjoitustilaan","fullscreen":"%{shortcut} Koko ruudun kirjoitustila"},"bookmarks":{"title":"Kirjanmerkit","enter":"%{shortcut} Tallenna ja sulje","later_today":"%{shortcut} Myöhemmin tänään","later_this_week":"%{shortcut} Myöhemmin tällä viikolla","tomorrow":"%{shortcut} Huomenna","next_week":"%{shortcut} Ensi viikolla","next_month":"%{shortcut} Ensi kuussa","next_business_week":"%{shortcut} Ensi viikon alussa","next_business_day":"%{shortcut} Seuraavana arkipäivänä","custom":"%{shortcut} Valitse päivämäärä ja kellonaika","none":"%{shortcut} Ei muistutusta","delete":"%{shortcut} Poista kirjanmerkki"},"actions":{"title":"Toiminnot","bookmark_topic":"%{shortcut} Lisää ketju kirjanmerkkeihin/poista kirjanmerkeistä","pin_unpin_topic":"%{shortcut} Kiinnitä ketju/Poista ketjun kiinnitys","share_topic":"%{shortcut} Jaa ketju","share_post":"%{shortcut} Jaa viesti","reply_as_new_topic":"%{shortcut} Vastaa liittyvässä ketjussa","reply_topic":"%{shortcut} Vastaa ketjuun","reply_post":"%{shortcut} Vastaa viestiin","quote_post":"%{shortcut} Lainaa viestiä","like":"%{shortcut} Tykkää viestistä","flag":"%{shortcut} Merkitse viesti","bookmark":"%{shortcut} Lisää viesti kirjanmerkkeihin","edit":"%{shortcut} Muokkaa viestiä","delete":"%{shortcut} Poista viesti","mark_muted":"%{shortcut} Vaimenna ketju","mark_regular":"%{shortcut} Tavallinen (oletus) ketju","mark_tracking":"%{shortcut} Seuraa ketjua","mark_watching":"%{shortcut} Tarkkaile ketjua","print":"%{shortcut} Tulosta ketju","defer":"%{shortcut} Lykkää ketjua","topic_admin_actions":"%{shortcut} Avaa ketjun ylläpitotyökalut"},"search_menu":{"title":"Hakuvalikko","prev_next":"%{shortcut} Siirry valinnassa ylös ja alas","insert_url":"%{shortcut} Lisää valinta avoinna olevaan kirjoitustyökaluun"}},"badges":{"earned_n_times":{"one":"On ansainnut tämän kunniamerkin %{count} kerran","other":"On ansainnut tämän kunniamerkin %{count} kertaa"},"granted_on":"Myönnetty %{date}","others_count":"Muita, joilla on tämä kunniamerkki (%{count})","title":"Kunniamerkit","allow_title":"Voit käyttää tätä kunniamerkkiä tittelinä","multiple_grant":"Voit ansaita tämän useasti","badge_count":{"one":"%{count} kunniamerkki","other":"%{count} kunniamerkkiä"},"more_badges":{"one":"+%{count} Lisää","other":"+%{count} Lisää"},"granted":{"one":"%{count} myönnetty","other":"%{count} myönnettyä"},"select_badge_for_title":"Valitse kunniamerkki käytettäväksi tittelinäsi","none":"(ei mitään)","successfully_granted":"Kunniamerkin %{badge} myöntäminen käyttäjälle %{username} onnistui","badge_grouping":{"getting_started":{"name":"Aloittaminen"},"community":{"name":"Yhteisö"},"trust_level":{"name":"Luottamustaso"},"other":{"name":"Muut"},"posting":{"name":"Viestien julkaiseminen"}},"favorite_max_reached":"Et voi lisätä enempää kunniamerkkejä suosikkeihin.","favorite_max_not_reached":"Merkitse tämä kunniamerkki suosikiksi","favorite_count":"%{count}/%{max} kunniamerkkiä merkitty suosikeiksi"},"tagging":{"all_tags":"Kaikki tunnisteet","other_tags":"Muut tunnisteet","selector_all_tags":"kaikki tunnisteet","selector_no_tags":"ei tunnisteita","changed":"muutetut tunnisteet","tags":"Tunnisteet","choose_for_topic":"valinnaiset tunnisteet","info":"Tietoa","default_info":"Tätä tunnistetta ei ole rajoitettu mihinkään alueeseen, eikä sillä ole synonyymejä. Lisää rajoituksia laittamalla tämä tunniste \u003ca href=%{basePath}/tag_groups\u003etunnisteryhmään\u003c/a\u003e.","category_restricted":"Tämä tunniste on rajoitettu alueille, joille sinulla ei ole pääsyoikeutta.","synonyms":"Synonyymit","synonyms_description":"Kun näitä tunnisteita käytetään, ne korvataan tunnisteella \u003cb\u003e%{base_tag_name}\u003c/b\u003e.","tag_groups_info":{"one":"Tunniste kuuluu ryhmään \"%{tag_groups}\".","other":"Tunniste kuuluu näihin ryhmiin: %{tag_groups}"},"category_restrictions":{"one":"Sitä voi käyttää vain tällä alueella:","other":"Sitä voi käyttää vain näillä alueilla:"},"edit_synonyms":"Hallitse synonyymejä","add_synonyms_label":"Lisää synonyymejä:","add_synonyms":"Lisää","add_synonyms_explanation":{"one":"Kaikkialla, missä tätä tunnistetta käytetään, vaihdetaan tunnisteeksi \u003cb\u003e%{tag_name}\u003c/b\u003e. Haluatko varmasti tehdä tämän muutoksen?","other":"Kaikkialla, missä näitä tunnisteita käytetään, vaihdetaan tunnisteeksi \u003cb\u003e%{tag_name}\u003c/b\u003e. Haluatko varmasti tehdä tämän muutoksen?"},"add_synonyms_failed":"Näitä tunnisteita ei voitu lisätä synonyymeiksi: \u003cb\u003e%{tag_names}\u003c/b\u003e. Varmista, ettei niillä itsellään ole synonyymejä ja etteivät ne ole toisen tunnisteen synonyymejä.","remove_synonym":"Poista synonyymi","delete_synonym_confirm":"Haluatko varmasti poistaa synonyymin \"%{tag_name}\"?","delete_tag":"Poista tunniste","delete_confirm":{"one":"Haluatko varmasti poistaa tämän tunnisteen? Tämä poistaa sen myös %{count} ketjulta, jolla tunniste on.","other":"Haluatko varmasti poistaa tämän tunnisteen? Tämä poistaa sen myös %{count} ketjulta, joilla tunniste on."},"delete_confirm_no_topics":"Haluatko varmasti poistaa tunnisteen?","delete_confirm_synonyms":{"one":"Sen synonyymi poistetaan myös.","other":"Sen %{count} synonyymiä poistetaan myös."},"rename_tag":"Nimeä tunniste uudelleen","rename_instructions":"Valitse uusi nimi tälle tunnisteelle:","sort_by":"Järjestys:","sort_by_count":"lukumäärä","sort_by_name":"nimi","manage_groups":"Hallitse tunnisteryhmiä","manage_groups_description":"Määrittele ryhmiä tunnisteiden järjestämiseksi","upload":"Lataa tunnisteita","upload_description":"Luo iso joukko tunnisteita kerralla lataamalla CSV-tiedosto","upload_instructions":"Yksi per rivi, valinnaisesti tunnisteryhmän kanssa muodossa \"tunnisteen_nimi,tunnisteen_ryhmä\".","upload_successful":"Tunnisteiden lataaminen onnistui","delete_unused_confirmation":{"one":"%{count} tunniste poistetaan: %{tags}","other":"%{count} tunnistetta poistetaan: %{tags}"},"delete_unused_confirmation_more_tags":{"one":"%{tags} ja %{count} muu","other":"%{tags} ja %{count} muuta"},"delete_no_unused_tags":"Käyttämättömiä tunnisteita ei ole.","tag_list_joiner":", ","delete_unused":"Poista käyttämättömät tunnisteet","delete_unused_description":"Poista kaikki tunnisteet, joita ei ole liitetty ketjuihin tai yksityisviesteihin","cancel_delete_unused":"Peruuta","filters":{"without_category":"%{filter} %{tag} ketjut","with_category":"%{filter} %{tag} ketjut alueella %{category}","untagged_without_category":"%{filter} ketjut, joilla ei ole tunnisteita","untagged_with_category":"%{filter} ketjut, joilla ei tunnisteita alueella %{category}"},"notifications":{"watching":{"title":"Tarkkailu","description":"Ketjut, joilla on tämä tunniste asetetaan automaattisesti tarkkailuun. Saat ilmoituksen kaikista uusista viesteistä sekä ketjuista, ja lukemattomien ja uusien viestien lukumäärä näytetään ketjun vieressä."},"watching_first_post":{"title":"Tarkkaillaan ensimmäistä viestiä","description":"Saat ilmoituksia uusista ketjuista, joilla on tämä tunniste, muttet ketjuihin tulevista vastauksista."},"tracking":{"title":"Seuranta","description":"Seuraat automaattisesti ketjuja, joilla on tämä tunniste. Uusien ja lukemattomien viestien lukumäärä näytetään ketjun yhteydessä."},"regular":{"title":"Tavallinen","description":"Saat ilmoituksen, jos joku mainitsee @nimesi tai vastaa viestiisi."},"muted":{"title":"Vaimennettu","description":"Et saa ilmoituksia ketjusta, jolla on tämä tunniste, eivätkä ne näy lukemattomien välilehdessä."}},"groups":{"title":"Tunnisteryhmät","about_heading":"Valitse tunnisteryhmä tai luo uusi","about_heading_empty":"Aloita luomalla uusi tunnisteryhmä","about_description":"Tunnisteryhmät auttavat hallitsemaan useiden tunnisteiden käyttöoikeuksia yhdessä paikassa.","new":"Uusi ryhmä","new_title":"Luo uusi ryhmä","edit_title":"Muokkaa tunnisteryhmää","tags_label":"Tunnisteet tässä ryhmässä","parent_tag_label":"Emotunniste","parent_tag_description":"Tämän ryhmän tunnisteita voi käyttää vain, jos emotunniste on asetettu.","one_per_topic_label":"Vain yksi tunniste per ketju tästä ryhmästä","new_name":"Uusi tunnisteryhmä","name_placeholder":"Nimi","save":"Tallenna","delete":"Poista","confirm_delete":"Oletko varma, että haluat poistaa tämän tunnisteryhmän?","everyone_can_use":"Kuka vain voi käyttää tunnisteita","usable_only_by_groups":"Tunnisteet näkyvät kaikille, mutta vain nämä ryhmät voivat käyttää niitä","visible_only_to_groups":"Tunnisteet näkyvät vain näille ryhmille","cannot_save":"Tunnisteryhmää ei voida tallentaa. Varmista, että ryhmässä on vähintään yksi tunniste, ryhmän nimi ei ole tyhjä ja että ryhmä on valittuna tunnisteiden käyttöoikeuksiin.","tags_placeholder":"Etsi tai luo tunnisteita","parent_tag_placeholder":"Valinnainen","select_groups_placeholder":"Valitse ryhmät ...","disabled":"Tunnisteiden lisääminen on poistettu käytöstä. "},"topics":{"none":{"unread":"Sinulla ei ole lukemattomia ketjuja.","new":"Sinulla ei ole uusia ketjuja.","read":"Et ole lukenut vielä yhtään ketjua.","posted":"Et ole kirjoittanut vielä yhteenkään ketjuun.","latest":"Tuoreimpia ketjuja ei ole.","bookmarks":"Et ole vielä lisännyt ketjuja kirjanmerkkeihin.","top":"Suosittuja ketjuja ei ole."}}},"invite":{"custom_message":"Tee kutsusta persoonallisempi kirjoittamalla \u003ca href\u003eyksilöllinen viesti\u003c/a\u003e.","custom_message_placeholder":"Kirjoita yksilöllinen viestisi","approval_not_required":"Käyttäjä hyväksytään automaattisesti, kun hän hyväksyy tämän kutsun.","custom_message_template_forum":"Hei, sinun kannattaa liittyä tähän foorumiin!","custom_message_template_topic":"Hei, ajattelin, että voisit tykätä tästä ketjusta!"},"forced_anonymous":"Erittäin suuren kuormituksen vuoksi tämä näytetään väliaikaisesti kaikille tavalla, jolla uloskirjautunut käyttäjä näkee sen.","forced_anonymous_login_required":"Sivusto on erittäin suuren kuormituksen alla, eikä sitä voi ladata juuri nyt. Yritä uudelleen muutaman minuutin kuluttua.","footer_nav":{"back":"Takaisin","forward":"Seuraava","share":"Jaa","dismiss":"Sulje"},"safe_mode":{"enabled":"Vikasietotila on käytössä, poistu vikasietotilasta sulkemalla selainikkuna"},"image_removed":"(kuva poistettu)","do_not_disturb":{"title":"Älä häiritse...","label":"Älä häiritse","remaining":"%{remaining} jäljellä","options":{"half_hour":"30 minuuttiin","one_hour":"1 tuntiin","two_hours":"2 tuntiin","tomorrow":"Ennen huomista","custom":"Mukautettu"},"set_schedule":"Aseta ilmoitusten aikataulu"},"trust_levels":{"names":{"newuser":"tulokas","basic":"haastaja","member":"konkari","regular":"mestari","leader":"johtaja"},"detailed_name":"%{level}: %{name}"},"admin":{"site_settings":{"categories":{"chat_integration":"Chatti-integroinnit"}}},"chat_integration":{"menu_title":"Chatti-integroinnit","settings":"Asetukset","no_providers":"Sinun täytyy sallia jotkut palveluntarjoajat lisäosien asetuksissa","channels_with_errors":"Jotkin tämän palveluntuottajan kanavista pettivät viimeksi, kun viestejä lähetettiin. Klikkaa vikaikonia/ikoneita saadaksesi lisää tietoa.","channel_exception":"Tuntematon virhe tapahtui viimeksi, kun viesti lähetettiin tälle kanavalle. ","choose_group":"(valitse ryhmä) ","all_categories":"(kaikki alueet)","all_tags":"(kaikki tunnisteet) ","create_rule":"Luo sääntö","create_channel":"Luo kanava","delete_channel":"Poista","test_channel":"Testi","edit_channel":"Muokkaa","channel_delete_confirm":"Oletko varma, että haluat poistaa tämän kanavan? Kaikki kanavaan liittyvät säännöt poistetaan. ","test_modal":{"title":"Lähetä testiviesti","topic":"Ketju","send":"Lähetä testiviesti","close":"Sulje","error":"Tuntematon virhe tapahtui viestiä lähetettäessä. Tarkasta sivuston loki saadaksesi lisätietoa. ","success":"Viesti lähetetty onnistuneesti "},"type":{"normal":"Normaali","group_message":"Ryhmäviesti","group_mention":"Ryhmämaininta"},"filter":{"mute":"Vaimenna","follow":"Uusi ketju","watch":"Kaikki viestit ja vastaukset"},"rule_table":{"filter":"Suodatin","category":"Alue","tags":"Tunnisteet","edit_rule":"Muokkaa","delete_rule":"Poista"},"edit_channel_modal":{"title":"Muokkaa kanavaa","save":"Tallenna kanava","cancel":"Peru","provider":"Palveluntarjoaja","channel_validation":{"ok":"Voimassa","fail":"Formaatti ei kelpaa"}},"edit_rule_modal":{"title":"Muokkaa sääntöä","save":"Tallenna sääntö","cancel":"Peru","provider":"Palveluntarjoaja","type":"Tyyppi","channel":"Kanava","filter":"Suodatin","category":"Alue","group":"Ryhmä","tags":"Tunnisteet","instructions":{"filter":"Muistutusten taso. Vaimenna syrjäyttää muut vastaavat asetukset","category":"Tämä asetus koskee vain ketjuja määritellyssä kategoriassa","group":"Tämä asetus koskee tähän ryhmään viittaavia viestejä ","tags":"Jos määritelty, tämä asetus koskee vain ketjuja, joissa on vähintään yksi näistä tunnisteista"}},"provider":{"slack":{"title":"Slack","param":{"identifier":{"title":"Kanava","help":"esim. #kanava, @käyttäjänimi"}},"errors":{"action_prohibited":"Botilla ei ole oikeuksia lähettää viestejä tuolle kanavalle","channel_not_found":"Kyseistä kanavaa ei ole olemassa slackissa"}},"telegram":{"title":"Telegram","param":{"name":{"title":"Nimi","help":"Kanavaa kuvaava nimi. Sitä ei käytetä Telegramiin yhdistämiseen."},"chat_id":{"title":"Chatin ID","help":"Botin antama numero, tai julkisen kanavan tunnus muodossa @kanavannimi"}},"errors":{"channel_not_found":"Kyseistä kanavaa ei ole olemassa Telegramissa","forbidden":"Botilla ei ole oikeuksia lähettää viestejä tälle kanavalle"}},"discord":{"title":"Discord","param":{"name":{"title":"Nimi","help":"Kanavaa kuvaava nimi. Sitä ei käytetä Discordiin yhdistämiseen."},"webhook_url":{"title":"Webhook URL","help":"Webhook URL, joka on luotu Discord palvelimesi asetuksissa"}}},"mattermost":{"title":"Mattermost","param":{"identifier":{"title":"Kanava","help":"esim. #kanava, @käyttäjänimi."}},"errors":{"channel_not_found":"Kyseistä kanavaa ei ole olemassa Mattermostissa"}},"matrix":{"title":"Matrix","param":{"name":{"title":"Nimi","help":"Kanavaa kuvaava nimi. Sitä ei käytetä Matrixiin yhdistämiseen."},"room_id":{"title":"Huoneen ID"}},"errors":{"unknown_room":"Huoneen tunnus ei kelpaa"}},"zulip":{"title":"Zulip","param":{"subject":{"title":"Otsikko"}}},"rocketchat":{"title":"Rocket.Chat","param":{"identifier":{"title":"Kanava","help":"esim. #kanava, @käyttäjänimi"}}},"gitter":{"title":"Gitter","param":{"name":{"title":"Nimi"},"webhook_url":{"title":"Webhook URL"}}}}},"details":{"title":"Piilota tiedot"},"discourse_local_dates":{"relative_dates":{"today":"Tänään %{time}","tomorrow":"Huomenna %{time}","yesterday":"Eilen %{time}","countdown":{"passed":"päivämäärä on mennyt"}},"title":"Lisää päivämäärä/aika","create":{"form":{"insert":"Lisää","advanced_mode":"Lisäasetukset","simple_mode":"Piilota lisäasetukset","format_description":"Muotoilu, jota käytetään päivämäärän näyttämiseen käyttäjälle. Aseta Z näyttääksesi siirtymän ja zz aikavyöhykkeen nimen.","timezones_title":"Näytettävät aikavyöhykkeet","timezones_description":"Aikavyöhykkeitä käytetään näytettäessä päivämääriä esikatselussa sekä varana virhetilanteissa.","recurring_title":"Toistuvuus","recurring_description":"Määrittele tapahtuman toistuvuus. Voit myös manuaalisesti muokata toistuvuusparametriä, jonka lomake luo viestiin. Käytä näitä avainsanoja: years, quarters, months, weeks, days, hours, minutes, seconds, milliseconds.","recurring_none":"Ei toistu","invalid_date":"Päiväys ei kelpaa, tarkista päivämäärä ja aika","date_title":"Päivämäärä","time_title":"Aika","format_title":"Päivämäärän muoto","timezone":"Aikavyöhyke","until":"Asti...","recurring":{"every_day":"Joka päivä","every_week":"Joka viikko","every_two_weeks":"Joka toinen viikko","every_month":"Joka kuukausi","every_two_months":"Joka toinen kuukausi","every_three_months":"Joka kolmas kuukausi","every_six_months":"Kuuden kuukauden välein","every_year":"Kerran vuodessa"}}}},"discourse_narrative_bot":{"welcome_post_type":{"new_user_track":"Aloita alkeiskurssi kaikkien uusien käyttäjien kanssa","welcome_message":"Lähetä kaikille uusille käyttäjille tervetuloviesti, jossa on pika-aloitusopas palstan käyttöön"}},"presence":{"replying":{"one":"kirjoittaa vastausta","other":"kirjoittavat vastausta"},"editing":{"one":"muokkaa vastausta","other":"muokkaavat vastausta"},"replying_to_topic":{"one":"kirjoittaa vastausta","other":"kirjoittavat vastausta"}},"whos_online":{"title":"Paikalla ({{count}}):","tooltip":"Viimeisten 5 minuutin aikana paikalla","no_users":"Kukaan ei ole paikalla juuri nyt"},"poll":{"voters":{"one":"äänestäjä","other":"äänestäjää"},"total_votes":{"one":"ääni","other":"ääntä"},"average_rating":"Keskiarvo: \u003cstrong\u003e%{average}\u003c/strong\u003e","public":{"title":"Äänet ovat \u003cstrong\u003ejulkisia\u003c/strong\u003e."},"results":{"groups":{"title":"Sinun täytyy olla ryhmien %{groups} jäsen, jotta voit äänestää tässä kyselyssä."},"vote":{"title":"Tulokset näytetään \u003cstrong\u003ekyselyn jälkeen\u003c/strong\u003e."},"closed":{"title":"Tulokset näytetään kyselyn \u003cstrong\u003esulkeuduttua\u003c/strong\u003e."},"staff":{"title":"Tulokset näytetään vain \u003cstrong\u003ehenkilökunnan\u003c/strong\u003e jäsenille."}},"multiple":{"help":{"at_least_min_options":{"one":"Valitse ainakin \u003cstrong\u003e%{count}\u003c/strong\u003e vaihtoehto.","other":"Valitse ainakin \u003cstrong\u003e%{count}\u003c/strong\u003e vaihtoehtoa."},"up_to_max_options":{"one":"Valitse enintään \u003cstrong\u003e%{count}\u003c/strong\u003e vaihtoehtoa.","other":"Valitse enintään \u003cstrong\u003e%{count}\u003c/strong\u003e vaihtoehtoa."},"x_options":{"one":"Valitse \u003cstrong\u003e%{count}\u003c/strong\u003e vaihtoehto.","other":"Valitse \u003cstrong\u003e%{count}\u003c/strong\u003e vaihtoehtoa."},"between_min_and_max_options":"Valitse vähintään \u003cstrong\u003e%{min}\u003c/strong\u003e ja enintään \u003cstrong\u003e%{max}\u003c/strong\u003e vaihtoehtoa."}},"cast-votes":{"title":"Antakaa äänenne","label":"Äänestä nyt!"},"show-results":{"title":"Näytä kyselyn tulos","label":"Näytä tulokset"},"hide-results":{"title":"Palaa äänestysvalintaasi","label":"Näytä äänestys"},"group-results":{"title":"Lajittele äänet käyttäjäkentän perusteella","label":"Näytä erittely"},"export-results":{"title":"Vie kyselyn tulos","label":"Vie"},"open":{"title":"Avaa kysely","label":"Avaa","confirm":"Avataanko kysely?"},"close":{"title":"Sulje kysely","label":"Sulje","confirm":"Suljetaanko kysely?"},"automatic_close":{"closes_in":"Sulkeutuu \u003cstrong\u003e%{timeLeft}\u003c/strong\u003e kuluttua","age":"Sulkeutui \u003cstrong\u003e%{age}\u003c/strong\u003e"},"breakdown":{"title":"Kyselyn tulokset","votes":"%{count} ääntä","breakdown":"Erittely","percentage":"Prosenttiosuus","count":"Lukumäärä"},"error_while_toggling_status":"Kyselyn tilaa muutettaessa tapahtui virhe.","error_while_casting_votes":"Ääntä annettaessa tapahtui virhe.","error_while_fetching_voters":"Äänestäneiden näyttämisessä tapahtui virhe.","error_while_exporting_results":"Kyselyn tuloksen vienti epäonnistui.","ui_builder":{"title":"Luo kysely","insert":"Lisää kysely","help":{"options_min_count":"Syötä vähintään 1 vaihtoehto.","options_max_count":"Syötä enintään %{count} vaihtoehtoa.","invalid_min_value":"Vähimmäisarvon on oltava vähintään 1.","invalid_max_value":"Enimmäisarvon on oltava vähintään 1, mutta pienempi tai yhtä suuri kuin vaihtoehtojen määrä.","invalid_values":"Vähimmäisarvon täytyy olla enimmäisarvoa pienempi.","min_step_value":"Askelvälin on oltava vähintään 1"},"poll_type":{"label":"Tyyppi","regular":"Yksi valinta","multiple":"Monivalinta","number":"Numeroarviointi"},"poll_result":{"label":"Näytä tulokset...","always":"Aina näkyvissä","vote":"Vasta äänestämisen jälkeen","closed":"Kun kysely on suljettu","staff":"Vain henkilökunnalle"},"poll_groups":{"label":"Rajoita äänestys näihin ryhmiin"},"poll_chart_type":{"label":"Tuloskaavio","bar":"Pylväs","pie":"Ympyrä"},"poll_config":{"max":"Valintoja enintään","min":"Valintoja vähintään","step":"Askelväli"},"poll_public":{"label":"Näytä äänestäneet"},"poll_title":{"label":"Otsikko (valinnainen)"},"poll_options":{"label":"Valittavat vaihtoehdot (yksi per rivi)","add":"Lisää vaihtoehto"},"automatic_close":{"label":"Sulje kysely automaattisesti"},"show_advanced":"Näytä lisäasetukset","hide_advanced":"Piilota lisäasetukset"}},"styleguide":{"title":"Tyyliopas","welcome":"Aloita valitsemalla osio vasemmalla olevasta valikosta.","categories":{"atoms":"Atomit","molecules":"Molekyylit","organisms":"Organismit"},"sections":{"typography":{"title":"Typografia","example":"Tervetuloa käyttämään Discoursea","paragraph":"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."},"date_time_inputs":{"title":"Päivämäärä-/kellonaikakentät"},"font_scale":{"title":"Fonttijärjestelmä"},"colors":{"title":"Värit"},"icons":{"title":"Kuvakkeet","full_list":"Katso täydellinen luettelo Font Awesome -kuvakkeista"},"input_fields":{"title":"Tekstikentät"},"buttons":{"title":"Painikkeet"},"dropdowns":{"title":"Pudotusvalikot"},"categories":{"title":"Luokat"},"bread_crumbs":{"title":"Navigointipolku"},"navigation":{"title":"Navigointi"},"navigation_bar":{"title":"Navigointipalkki"},"navigation_stacked":{"title":"Pystynavigointi"},"categories_list":{"title":"Alueluettelo"},"topic_link":{"title":"Ketjun linkki"},"topic_list_item":{"title":"Ketjulistauksen osa"},"topic_statuses":{"title":"Ketjun tilat"},"topic_list":{"title":"Ketjulistaus"},"basic_topic_list":{"title":"Tavallinen ketjulistaus"},"footer_message":{"title":"Alatunnisteen viesti"},"signup_cta":{"title":"Rekisteröitymisen CTA"},"topic_timer_info":{"title":"Ketjuajastimet"},"topic_footer_buttons":{"title":"Ketjun alatunnisteen painikkeet"},"topic_notifications":{"title":"Ketjun ilmoitukset"},"post":{"title":"Viesti"},"topic_map":{"title":"Ketjun kartta"},"site_header":{"title":"Sivuston yläpalkki"},"suggested_topics":{"title":"Ehdotettuja ketjuja"},"post_menu":{"title":"Viestin valikko"},"modal":{"title":"Modaali-ikkuna","header":"Modaalin otsikko","footer":"Modaalin alatunniste"},"user_about":{"title":"Käyttäjätietolaatikko"},"header_icons":{"title":"Yläpalkin kuvakkeet"},"spinners":{"title":"Latausnäkymät"}}}}},"en":{"js":{"dates":{"wrap_on":"on %{date}","from_placeholder":"from date"},"skip_to_main_content":"Skip to main content","s3":{"regions":{"eu_south_1":"EU (Milan)"}},"drafts":{"label_with_count":"Drafts (%{count})","new_private_message":"New personal message draft"},"review":{"date_filter":"Posted between","stale_help":"This reviewable has been resolved by \u003cb\u003e%{username}\u003c/b\u003e."},"groups":{"members":{"no_filter_matches":"No members match that search."},"default_notifications":{"modal_title":"User default notifications"}},"user":{"user_notifications":{"filters":{"unseen":"Unseen"}},"sr_expand_profile":"Expand profile details","sr_collapse_profile":"Collapse profile details","no_notifications_page_body":"You will be notified about activity directly relevant to you, including replies to your topics and posts, when someone \u003cb\u003e@mentions\u003c/b\u003e you or quotes you, and replies to topics you are watching. Notifications will also be sent to your email when you haven’t logged in for a while. \u003cbr\u003e\u003cbr\u003e Look for the %{icon} to decide which specific topics, categories and tags you want to be notified about. For more, see your \u003ca href='%{preferencesUrl}'\u003enotification preferences\u003c/a\u003e.\n","messages":{"all":"all inboxes","personal":"Personal","read_more_in_group":"Want to read more? Browse other messages in %{groupLink}.","read_more":"Want to read more? Browse other messages in \u003ca href='%{basePath}/u/%{username}/messages/personal'\u003epersonal messages\u003c/a\u003e."},"associated_accounts":{"confirm_description":{"disconnect":"Your existing %{provider} account '%{account_description}' will be disconnected."}}},"summary":{"short_label":"Summarize","short_title":"Show a summary of this topic: the most interesting posts as determined by the community"},"create_account":{"associate":"Already have an account? \u003ca href='%{associate_link}'\u003eLog In\u003c/a\u003e to link your %{provider} account."},"login":{"google_oauth2":{"sr_title":"Login with Google"},"twitter":{"sr_title":"Login with Twitter"},"instagram":{"sr_title":"Login with Instagram"},"facebook":{"sr_title":"Login with Facebook"},"github":{"sr_title":"Login with GitHub"},"discord":{"sr_title":"Login with Discord"}},"select_kit":{"results_count":{"one":"%{count} result","other":"%{count} results"}},"composer":{"composer_actions":{"reply_as_new_group_message":{"desc":"Create new message starting with same recipients"}}},"topics":{"bulk":{"change_category":"Set Category...","notification_level":"Notifications..."},"none":{"unseen":"You have no unseen topics."},"bottom":{"unseen":"There are no more unseen topics."}},"topic":{"actions":{"slow_mode":"Set Slow Mode...","make_public":"Make Public Topic..."},"feature":{"make_banner":"Make Banner Topic"}},"post":{"quote_edit":"Edit","controls":{"change_owner":"Change Ownership...","grant_badge":"Grant Badge...","add_post_notice":"Add Staff Notice...","change_post_notice":"Change Staff Notice..."}},"category":{"default_slow_mode":"Enable \"Slow Mode\" for new topics in this category."},"history":"History","filters":{"unseen":{"title":"Unseen","lower_title":"unseen","help":"new topics and topics you are currently watching or tracking with unread posts"}},"tagging":{"topics":{"none":{"unseen":"You have no unseen topics."}}},"pick_files_button":{"unsupported_file_picked":"You have picked an unsupported file. Supported file types – %{types}."},"user_activity":{"no_activity_title":"No activity yet","no_activity_body":"Welcome to our community! You are brand new here and have not yet contributed to discussions. As a first step, visit \u003ca href='%{topUrl}'\u003eTop\u003c/a\u003e or \u003ca href='%{categoriesUrl}'\u003eCategories\u003c/a\u003e and just start reading! Select %{heartIcon} on posts that you like or want to learn more about. If you have not already done so, help others get to know you by adding a picture and bio in your \u003ca href='%{preferencesUrl}'\u003euser preferences\u003c/a\u003e.","no_activity_others":"No activity.","no_replies_title":"You have not replied to any topics yet","no_replies_others":"No replies.","no_drafts_title":"You haven’t started any drafts","no_drafts_body":"Not quite ready to post? We’ll automatically save a new draft and list it here whenever you start composing a topic, reply, or personal message. Select the cancel button to discard or save your draft to continue later.","no_likes_title":"You haven’t liked any topics yet","no_likes_body":"A great way to jump in and start contributing is to start reading conversations that have already taken place, and select the %{heartIcon} on posts that you like!","no_likes_others":"No liked posts.","no_topics_title":"You have not started any topics yet","no_read_topics_title":"You haven’t read any topics yet","no_read_topics_body":"Once you start reading discussions, you’ll see a list here. To start reading, look for topics that interest you in \u003ca href='%{topUrl}'\u003eTop\u003c/a\u003e or \u003ca href='%{categoriesUrl}'\u003eCategories\u003c/a\u003e or search by keyword %{searchIcon}"},"no_group_messages_title":"No group messages found","chat_integration":{"group_mention_template":"Mentions of: @%{name}","group_message_template":"Messages to: @%{name}","filter":{"thread":"All posts with threaded replies"},"edit_rule_modal":{"instructions":{"type":"Change the type to trigger notifications for group messages or mentions"}},"provider":{"matrix":{"param":{"room_id":{"help":"The 'private identifier' for the room. It should look something like !abcdefg:matrix.org"}},"errors":{"unknown_token":"Access token is invalid"}},"zulip":{"param":{"stream":{"title":"Stream","help":"The name of the Zulip stream the message should be sent to. e.g. 'general'"},"subject":{"help":"The subject that these messages sent by the bot should be given"}},"errors":{"does_not_exist":"That stream does not exist on Zulip"}},"rocketchat":{"errors":{"invalid_channel":"That channel does not exist on Rocket Chat"}},"gitter":{"param":{"name":{"help":"A Gitter room's name e.g. gitterHQ/services."},"webhook_url":{"help":"The URL provided when you create a new integration in a Gitter room."}}},"flowdock":{"title":"Flowdock","param":{"flow_token":{"title":"Flow Token","help":"The flow token provided after creating a source for a flow into which you want to send messages."}}},"groupme":{"title":"GroupMe","param":{"groupme_instance_name":{"title":"GroupMe Instance Name","help":"name of the Groupme instance as listed in Site Settings. use 'all' to send to all  instances"}},"errors":{"not_found":"The path you attempted to post your message to was not found. Check the Bot ID in Site Settings.","instance_names_issue":"instance names incorrectly formatted or not provided"}},"teams":{"title":"Microsoft Teams","param":{"name":{"title":"Name","help":"A Teams channel name e.g. discourse"},"webhook_url":{"title":"Webhook URL","help":"The URL provided when you create a new incomming webhook"}},"errors":{"invalid_channel":"That channel does not exist on Microsoft Teams"}},"webex":{"title":"Webex Teams","param":{"name":{"title":"Name","help":"A Webex space name e.g. discourse"},"webhook_url":{"title":"Webhook URL","help":"The URL provided when you create a new incomming webhook"}},"errors":{"invalid_channel":"That channel does not exist on Webex"}},"google":{"title":"Google Chat","param":{"name":{"title":"Name","help":"A name for the channel (only shown in the Discourse admin interface)"},"webhook_url":{"title":"Webhook URL","help":"The URL provided when you create a new webhook"}}}}}}}};
I18n.locale = 'fi';
