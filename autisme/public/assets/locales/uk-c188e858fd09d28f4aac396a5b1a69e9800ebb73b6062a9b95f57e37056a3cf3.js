...
r += ", ви також можете продивитись інші повідомлення в групі ";
if(!d){
throw new Error("MessageFormat: No data passed to function.");
}
r += d["groupLink"];
