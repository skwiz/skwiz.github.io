...
"other" : function(d){
var r = "";
r += "zijn <b>" + (function(){ var x = k_1 - off_0;
if( isNaN(x) ){
throw new Error("MessageFormat: `"+lastkey_1+"` isnt a number.");
}
return x;
...
r += " met een geschatte leestijd van <b>";
if(!d){
throw new Error("MessageFormat: No data passed to function.");
}
...
r += " van deze gebruiker te verwijderen, hun account te verwijderen, registraties vanaf hun IP-adres <b>";
if(!d){
throw new Error("MessageFormat: No data passed to function.");
}
r += d["ip_address"];
r += "</b> te blokkeren, en hun e-mailadres <b>";
if(!d){
throw new Error("MessageFormat: No data passed to function.");
}
r += d["email"];
r += "</b> toe te voegen aan een permanente blokkeerlijst. Weet u het zeker?";
return r;
...
"low" : function(d){
var r = "";
r += "met een hoge verhouding likes per bericht";
return r;
},
"med" : function(d){
var r = "";
r += "met een erg hoge verhouding likes per bericht";
return r;
},
"high" : function(d){
var r = "";
r += "met een zeer hoge verhouding likes per bericht";
return r;
},
"other" : function(d){
var r = "";
...
r += " te verwijderen. Weet u het zeker?";
return r;
