...
r += " deste utilizador, remover a conta do mesmo, bloquear registos a partir do endereço de IP <b>";
if(!d){
throw new Error("MessageFormat: No data passed to function.");
}
r += d["ip_address"];
r += "</b> correspondente, e adicionar o endereço de e-mail <b>";
if(!d){
throw new Error("MessageFormat: No data passed to function.");
}
r += d["email"];
r += "</b> dos mesmos a uma lista negra permanente. Tem a certeza que este utilizador é de facto um spammer?";
return r;
