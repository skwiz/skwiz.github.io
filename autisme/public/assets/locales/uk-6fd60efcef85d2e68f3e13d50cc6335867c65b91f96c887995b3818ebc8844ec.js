...
r += ", ви також можете продивитись інші <a href='";
if(!d){
throw new Error("MessageFormat: No data passed to function.");
}
r += d["basePath"];
...
r += d["username"];
r += "/messages'> приватні повідомлення</a>";
return r;
