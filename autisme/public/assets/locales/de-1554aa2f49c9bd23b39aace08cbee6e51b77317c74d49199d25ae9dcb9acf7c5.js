...
r += " verbleibend, oder durchsuche andere Nachrichten in ";
if(!d){
throw new Error("MessageFormat: No data passed to function.");
}
r += d["groupLink"];
...
r += " verbleibend oder durchsuche andere <a href='";
if(!d){
throw new Error("MessageFormat: No data passed to function.");
}
r += d["basePath"];
...
r += d["username"];
r += "/message'>persönliche Nachrichten</a>";
return r;
...
r += ". Dieser Hinweis wird nur Team-Mitgliedern angezeigt.";
return r;
...
r += "</a> hat die Grenze der Website-Einstellung von ";
if(!d){
throw new Error("MessageFormat: No data passed to function.");
}
var lastkey_1 = "limit";
...
"low" : function(d){
var r = "";
r += "mit einem hohen Verhältnis von „Gefällt mir“ zu Beiträgen";
return r;
},
"med" : function(d){
var r = "";
r += "mit einem sehr hohen Verhältnis von „Gefällt mir“ zu Beiträgen";
return r;
},
"high" : function(d){
var r = "";
r += "mit einem extrem hohen Verhältnis von „Gefällt mir“ zu Beiträgen";
return r;
},
"other" : function(d){
var r = "";
