define("truth-helpers/helpers/and", ["exports", "@ember/component/helper", "../utils/truth-convert"], function (_exports, _helper, _truthConvert) {
  "use strict";
...
define("truth-helpers/helpers/not", ["exports", "@ember/component/helper", "../utils/truth-convert"], function (_exports, _helper, _truthConvert) {
  "use strict";
...
define("truth-helpers/helpers/or", ["exports", "@ember/component/helper", "../utils/truth-convert"], function (_exports, _helper, _truthConvert) {
  "use strict";
...
define("discourse-common/lib/get-url", ["exports"], function (_exports) {
  ...
  var cdn, baseUrl, baseUri, baseUriMatcher;
  var S3BaseUrl, S3CDN;
  ...
  function getURL(url) {
    ...
    var found = baseUriMatcher.test(url);
  ...
  function setPrefix(configBaseUri) {
    ...
    baseUriMatcher = new RegExp("^".concat(baseUri, "(/|$)"));
  }
  ...
  function samePrefix(url) {
    ...
    var cmp = url[0] === "/" ? baseUri || "/" : origin + baseUri || origin;
...
define("discourse-common/lib/icon-library", ["exports", "I18n", "discourse-common/lib/attribute-hook", "virtual-dom", "discourse-common/config/environment", "discourse-common/lib/escape"], function (_exports, _I18n, _attributeHook, _virtualDom, _environment, _escape) {
  "use strict";
  ...
  registerIconRenderer({
    ...
    string: function string(icon, params) {
      var id = (0, _escape.default)(handleIconId(icon));
      var html = "<svg class='".concat((0, _escape.default)(iconClasses(icon, params)), " svg-string'");
      ...
      if (params.label) {
        html += "<span class='sr-only'>".concat((0, _escape.default)(params.label), "</span>");
      }

      if (params.title) {
        html = "<span class=\"svg-icon-title\" title='".concat((0, _escape.default)(_I18n.default.t(params.title)), "'>").concat(html, "</span>");
      }

      if (params.translatedtitle) {
        html = "<span class=\"svg-icon-title\" title='".concat((0, _escape.default)(params.translatedtitle), "'>").concat(html, "</span>");
      }
    ...
    node: function node(icon, params) {
      ...
      var svg = (0, _virtualDom.h)("svg", {
        ...
        "xlink:href": (0, _attributeHook.default)("http://www.w3.org/1999/xlink", "#".concat((0, _escape.default)(id))),
        namespace: SVG_NAMESPACE
      })]);
...
define("discourse-common/resolver", ["exports", "@ember/string", "discourse-common/lib/deprecated", "discourse-common/lib/helpers", "@ember/object"], function (_exports, _string, _deprecated, _helpers, _object) {
  ...
  _exports.clearResolverOptions = clearResolverOptions;
  ...
  var _default = _comboBox.default.extend({
    ...
    modifyNoSelection: function modifyNoSelection() {
      if (!(0, _utils.isNone)(this.selectKit.options.none)) {
        ...
        return _category2.default.findUncategorized();
      } else {
    ...
    search: function search(filter) {
      ...
      if (filter) {
        ...
        return this.content.filter(function (item) {
          var category = _category2.default.findById(_this.getValue(item));
    ...
    content: (0, _object.computed)("selectKit.filter", "selectKit.options.scopedCategoryId", "selectKit.options.prioritizedCategoryId", function () {
      if (!this.selectKit.filter) {
        var _this$selectKit$optio = this.selectKit.options,
            scopedCategoryId = _this$selectKit$optio.scopedCategoryId,
            prioritizedCategoryId = _this$selectKit$optio.prioritizedCategoryId;
    ...
    categoriesByScope: function categoriesByScope() {
      ...
      var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
          _ref$scopedCategoryId = _ref.scopedCategoryId,
          scopedCategoryId = _ref$scopedCategoryId === void 0 ? null : _ref$scopedCategoryId,
          _ref$prioritizedCateg = _ref.prioritizedCategoryId,
          prioritizedCategoryId = _ref$prioritizedCateg === void 0 ? null : _ref$prioritizedCateg;

      var categories = this.fixedCategoryPositionsOnCreate ? _category2.default.list() : _category2.default.listByActivity();

      if (scopedCategoryId) {
        var scopedCat = _category2.default.findById(scopedCategoryId);

        scopedCategoryId = scopedCat.parent_category_id || scopedCat.id;
      }

      if (prioritizedCategoryId) {
        var category = _category2.default.findById(prioritizedCategoryId);
      ...
      var scopedCategories = categories.filter(function (category) {
      ...
      if (prioritizedCategoryId) {
        ...
        var _iterator = _createForOfIteratorHelper(scopedCategories),
            _step;

        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var _category = _step.value;
            var categoryId = this.getValue(_category);

            if (categoryId === prioritizedCategoryId || _category.parent_category_id === prioritizedCategoryId) {
              prioritized.push(_category);
            } else {
              other.push(_category);
            }
          }
        } catch (err) {
          _iterator.e(err);
...
define("select-kit/components/category-drop", ["exports", "discourse/models/category", "select-kit/components/combo-box", "discourse/lib/url", "I18n", "discourse/helpers/category-link", "@ember/object", "@ember/object/computed"], function (_exports, _category, _comboBox, _url, _I18n, _categoryLink, _object, _computed) {
  "use strict";
  ...
  var _default = _comboBox.default.extend({
    ...
    search: function search(filter) {
      if (filter) {
        var results = _category.default.search(filter);
    ...
    actions: {
      onChange: function onChange(categoryId) {
        var category = categoryId === ALL_CATEGORIES_ID || categoryId === NO_CATEGORIES_ID ? this.selectKit.options.parentCategory : _category.default.findById(parseInt(categoryId, 10));
        var route = this.editingCategory ? (0, _url.getEditCategoryUrl)(category, categoryId !== NO_CATEGORIES_ID, this.editingCategoryTab) : (0, _url.getCategoryAndTagUrl)(category, categoryId !== NO_CATEGORIES_ID, this.tagId);
    ...
    search: function search(filter) {
      ...
      if (result.length === 1) {
        (function () {
          ...
          for (var i = 0; i < _this2.siteSettings.max_category_nesting; ++i) {
            subcategoryIds.forEach(function (categoryId) {
              _this2.content.forEach(function (category) {
...
define("select-kit/components/color-palettes/color-palettes-row", ["exports", "select-kit/components/select-kit/select-kit-row", "@ember/object", "select-kit/templates/components/color-palettes/color-palettes-row"], function (_exports, _selectKitRow, _object, _colorPalettesRow) {
  "use strict";
  ...
  var _default = _selectKitRow.default.extend({
    ...
    palettes: (0, _object.computed)("item.colors.[]", function () {
      return (this.item.colors || []).filter(function (color) {
        ...
        return "#".concat(escape(color.hex));
      }).map(function (hex) {
    ...
    backgroundColor: (0, _object.computed)("item.colors.[]", function () {
      ...
      if (secondary && secondary.hex) {
        return "background-color:#".concat(escape(secondary.hex)).htmlSafe();
      } else {
        return "";
      }
    })
...
define("select-kit/components/composer-actions", ["exports", "discourse/models/composer", "discourse-common/utils/decorators", "discourse/models/draft", "select-kit/components/dropdown-select-box", "I18n", "bootbox", "@ember/string", "@ember/object/computed", "@ember/utils"], function (_exports, _composer, _decorators, _draft, _dropdownSelectBox, _I18n, _bootbox, _string, _computed, _utils) {
  "use strict";
  ...
  var _default = _dropdownSelectBox.default.extend((_dec = (0, _decorators.default)("isEditing", "action", "whisper", "noBump", "isInSlowMode"), _dec2 = (0, _decorators.default)("seq"), (_obj = {
    ...
    iconForComposerAction: function iconForComposerAction(isEditing, action, whisper, noBump, isInSlowMode) {
  ...
  var _default = _selectKitRow.default.extend({
    ...
    didReceiveAttrs: function didReceiveAttrs() {
      ...
      (0, _runloop.schedule)("afterRender", function () {
        ...
        _this.element.style.borderLeftColor = color.startsWith("#") ? color : "#".concat(color);
      });
    }
  });
...
define("select-kit/components/dropdown-select-box/dropdown-select-box-header", ["exports", "select-kit/components/select-kit/single-select-header", "@ember/object", "select-kit/templates/components/dropdown-select-box/dropdown-select-box-header", "@ember/object/computed"], function (_exports, _singleSelectHeader, _object, _dropdownSelectBoxHeader, _computed) {
  ...
  var _default = _singleSelectHeader.default.extend({
    ...
    btnStyleClass: (0, _object.computed)("customStyle", function () {
      return "".concat(this.customStyle ? "" : "btn-default");
    }),
...
define("select-kit/components/email-group-user-chooser", ["exports", "select-kit/components/user-chooser"], function (_exports, _userChooser) {
  ...
  var _default = _userChooser.default.extend({
    ...
    search: function search() {
      ...
      return superPromise.then(function (results) {
...
define("select-kit/components/flair-chooser", ["exports", "@ember/object", "select-kit/components/combo-box"], function (_exports, _object, _comboBox) {
  ...
  var _default = _comboBox.default.extend({
    ...
    selectedContent: (0, _object.computed)("value", "content.[]", "selectKit.noneItem", function () {
      var content = (this.content || []).findBy(this.selectKit.valueProperty, this.value);
...
define("select-kit/components/future-date-input-selector", ["exports", "select-kit/components/combo-box", "select-kit/components/future-date-input-selector/mixin", "@ember/object", "@ember/object/computed", "@ember/utils", "discourse/lib/timeframes-builder", "I18n"], function (_exports, _comboBox, _mixin, _object, _computed, _utils, _timeframesBuilder, _I18n) {
  "use strict";
  ...
  var _default = _comboBox.default.extend(_mixin.default, {
    ...
    content: (0, _object.computed)("statusType", function () {
      ...
      return (0, _timeframesBuilder.default)(opts).map(function (tf) {
        return {
          id: tf.id,
...
define("select-kit/components/future-date-input-selector/mixin", ["exports", "discourse/controllers/edit-topic-timer", "@ember/object/mixin", "@ember/utils", "discourse/lib/timeframes-builder"], function (_exports, _editTopicTimer, _mixin, _utils, _timeframesBuilder) {
  "use strict";
  ...
  var _default = _mixin.default.create({
    ...
    _computeDatetimeForValue: function _computeDatetimeForValue(value) {
      ...
      if (time) {
        var details = (0, _timeframesBuilder.timeframeDetails)(value);
    ...
    _updateAt: function _updateAt(selection) {
      var details = (0, _timeframesBuilder.timeframeDetails)(selection);
...
define("select-kit/components/icon-picker", ["exports", "discourse-common/lib/icon-library", "select-kit/components/multi-select", "@ember/object", "discourse-common/config/environment", "discourse-common/lib/helpers", "select-kit/lib/ajax-helper"], function (_exports, _iconLibrary, _multiSelect, _object, _environment, _helpers, _ajaxHelper) {
  "use strict";
  ...
  var _default = _multiSelect.default.extend({
    ...
    search: function search() {
      ...
      if (filter === "" && this._cachedIconsList && this._cachedIconsList.length) {
        ...
        return (0, _ajaxHelper.ajax)("/svg-sprite/picker-search", {
          data: {
            filter: filter
          }
        }).then(function (icons) {
...
define("select-kit/components/mini-tag-chooser", ["exports", "@ember/object/computed", "select-kit/components/multi-select", "I18n", "select-kit/mixins/tags", "@ember/object", "discourse-common/lib/helpers", "discourse/lib/computed"], function (_exports, _computed, _multiSelect, _I18n, _tags, _object, _helpers, _computed2) {
  ...
  var _default = _multiSelect.default.extend(_tags.default, {
    ...
    minimumSelectedTags: (0, _object.computed)(function () {
      if (this.selectKit.options.minimum || this.selectKit.options.requiredTagGroups) {
...
define("select-kit/components/mini-tag-chooser/selected-collection", ["exports", "@ember/object/computed", "@ember/component", "@ember/object", "select-kit/templates/components/mini-tag-chooser/selected-collection"], function (_exports, _computed, _component, _object, _selectedCollection) {
  ...
  var _default = _component.default.extend({
    ...
    tags: (0, _object.computed)("selectedTags.[]", "selectKit.filter", function () {
      ...
      return tags.map(function (selectedTag) {
        return {
          value: selectedTag,
  ...
  var _default = _selectKit.default.extend({
    ...
    select: function select(value, item) {
      ...
      if (this.selectKit.hasSelection && this.selectKit.options.maximum === 1) {
        ...
        (0, _runloop.next)(function () {
          _this4.selectKit.select(value, item);
        });
        return;
      }
      ...
      if (!(0, _utils.isPresent)(value)) {
        ...
        this.selectKit.change(_toConsumableArray(new Set(newValues)), newContent.length ? newContent : (0, _helpers.makeArray)(this.defaultItem(value, value)));
      }
    },
    selectedContent: (0, _object.computed)("value.[]", "content.[]", function () {
      ...
      var value = (0, _helpers.makeArray)(this.value).map(function (v) {
        return _this5.selectKit.options.castInteger && _this5._isNumeric(v) ? Number(v) : v;
      });

      if (value.length) {
        var content = [];
        value.forEach(function (v) {
          if (_this5.selectKit.valueProperty) {
            var c = (0, _helpers.makeArray)(_this5.content).findBy(_this5.selectKit.valueProperty, v);

            if (c) {
              content.push(c);
            }
          } else {
            if ((0, _helpers.makeArray)(_this5.content).includes(v)) {
              content.push(v);
            }
          }
        });
...
define("select-kit/components/multi-select/format-selected-content", ["exports", "@ember/component", "@ember/object", "select-kit/templates/components/multi-select/format-selected-content", "discourse-common/lib/helpers", "select-kit/mixins/utils"], function (_exports, _component, _object, _formatSelectedContent, _helpers, _utils) {
  ...
  var _default = _component.default.extend(_utils.default, {
    ...
    content: null,
    selectKit: null,
    formatedContent: (0, _object.computed)("content", function () {
      var _this = this;

      if (this.content) {
        return (0, _helpers.makeArray)(this.content).map(function (c) {
...
define("select-kit/components/multi-select/multi-select-filter", ["exports", "I18n", "select-kit/components/select-kit/select-kit-filter", "@ember/utils", "discourse-common/utils/decorators", "select-kit/templates/components/select-kit/select-kit-filter"], function (_exports, _I18n, _selectKitFilter, _utils, _decorators, _selectKitFilter2) {
  "use strict";
...
define("select-kit/components/select-kit", ["exports", "discourse-common/config/environment", "@ember/object", "select-kit/mixins/plugin-api", "@ember/runloop", "@ember/utils", "@ember/component", "I18n", "@ember/object/mixin", "rsvp", "select-kit/mixins/utils", "@popperjs/core", "discourse-common/lib/deprecated", "discourse-common/lib/debounce", "@ember/object/internals", "discourse-common/lib/helpers"], function (_exports, _environment, _object, _pluginApi, _runloop, _utils, _component, _I18n, _mixin, _rsvp, _utils2, _core, _deprecated2, _debounce, _internals, _helpers) {
  "use strict";
  ...
  var _default = _component.default.extend(SELECT_KIT_OPTIONS, _pluginApi.default, _utils2.default, {
    ...
    langProperty: null,
    init: function init() {
      var _this$attrs, _this$attrs$id, _this$attrs2;
      ...
      this.set("selectKit", _object.default.create({
        uniqueID: ((_this$attrs = this.attrs) === null || _this$attrs === void 0 ? void 0 : (_this$attrs$id = _this$attrs.id) === null || _this$attrs$id === void 0 ? void 0 : _this$attrs$id.value) || ((_this$attrs2 = this.attrs) === null || _this$attrs2 === void 0 ? void 0 : _this$attrs2.id) || (0, _internals.guidFor)(this),
    ...
    _mainElement: function _mainElement() {
      return document.querySelector("#".concat(this.selectKit.uniqueID));
    },
    _headerElement: function _headerElement() {
      return this.selectKit.mainElement().querySelector("summary");
    },
    _bodyElement: function _bodyElement() {
    ...
    deselectByValue: function deselectByValue(value) {
      if (!value) {
        return;
      }

      var item = this.itemForValue(value, this.selectedContent);
      this.deselect(item);
    },
    ...
    _searchWrapper: function _searchWrapper(filter) {
      ...
      return _rsvp.Promise.resolve(this.search(filter)).then(function (result) {
        ...
        _this7.selectKit.setProperties({
          highlighted: _this7.singleSelect && _this7.value ? _this7.itemForValue(_this7.value, _this7.mainCollection) : (0, _utils.isEmpty)(_this7.selectKit.filter) ? null : _this7.mainCollection.firstObject,
          isLoading: false,
          hasNoContent: hasNoContent
        });

        _this7._safeAfterRender(function () {
          if (_this7.selectKit.isExpanded) {
        ...
        _this7.set("selectKit.enterDisabled", false);
      });
    },
    ...
    _scrollToRow: function _scrollToRow(rowItem) {
      var preventScroll = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
      var value = this.getValue(rowItem);
      var rowContainer;

      if ((0, _utils.isPresent)(value)) {
        rowContainer = this.element.querySelector(".select-kit-row[data-value=\"".concat(value, "\"]"));
      } else {
    ...
    _highlightLast: function _highlightLast() {
      var highlighted = this.mainCollection.objectAt(this.mainCollection.length - 1);
    ...
    _highlightFirst: function _highlightFirst() {
      var highlighted = this.mainCollection.objectAt(0);
    ...
    _cancelSearch: function _cancelSearch() {
      this._searchPromise && (0, _runloop.cancel)(this._searchPromise);
    },
    ...
    _close: function _close(event) {
      ...
      this.clearErrors();
      var inModal = this.element.closest("#discourse-modal");

      if (inModal && (this === null || this === void 0 ? void 0 : (_this$site = this.site) === null || _this$site === void 0 ? void 0 : _this$site.mobileView)) {
        var modalBody = inModal.querySelector(".modal-body");
        modalBody.style = "";
      }
    ...
    _open: function _open(event) {
      ...
      if (!this.popper) {
        ...
        var anchor = document.querySelector("#".concat(this.selectKit.uniqueID, "-header"));
        var popper = document.querySelector("#".concat(this.selectKit.uniqueID, "-body"));
        var placementStrategy = (this === null || this === void 0 ? void 0 : (_this$site2 = this.site) === null || _this$site2 === void 0 ? void 0 : _this$site2.mobileView) ? "absolute" : "fixed";
        ...
        this.popper = (0, _core.createPopper)(anchor, popper, {
          ...
          modifiers: [{
            ...
            fn: function fn(_ref3) {
              ...
              state.styles.popper.minWidth = "".concat(Math.max(state.rects.reference.width, 220), "px");

              if (state.rects.reference.width >= 300) {
                state.styles.popper.maxWidth = "".concat(state.rects.reference.width, "px");
              } else {
            ...
            effect: function effect(_ref4) {
              ...
              state.elements.popper.style.minWidth = "".concat(Math.max(state.elements.reference.offsetWidth, 220), "px");

              if (state.elements.reference.offsetWidth >= 300) {
                state.elements.popper.style.maxWidth = "".concat(state.elements.reference.offsetWidth, "px");
              } else {
    ...
    _focusFilter: function _focusFilter() {
      ...
      if (!this.selectKit.mainElement().open) {
        var headerContainer = this.getHeader();
      ...
      this._safeAfterRender(function () {
        ...
        } else if (!_this10.selectKit.options.preventHeaderFocus) {
          var _headerContainer = _this10.getHeader();

          _headerContainer && _headerContainer.focus({
            preventScroll: true
          });
        }
      });
    ...
    getFilterInput: function getFilterInput() {
      return document.querySelector("#".concat(this.selectKit.uniqueID, "-filter input"));
    },
    getHeader: function getHeader() {
      return document.querySelector("#".concat(this.selectKit.uniqueID, "-header"));
    },
...
define("select-kit/components/select-kit/errors-collection", ["exports", "@ember/component", "select-kit/templates/components/select-kit/errors-collection"], function (_exports, _component, _errorsCollection) {
  "use strict";
...
define("select-kit/components/select-kit/select-kit-body", ["exports", "@ember/component", "@ember/runloop", "@ember/object", "select-kit/templates/components/select-kit/select-kit-body"], function (_exports, _component, _runloop, _object, _selectKitBody) {
  ...
  var _default = _component.default.extend({
    ...
    handleRootMouseDown: function handleRootMouseDown(event) {
      ...
      var headerElement = document.querySelector("#".concat(this.selectKit.uniqueID, "-header"));
...
define("select-kit/components/select-kit/select-kit-collection", ["exports", "@ember/component", "select-kit/templates/components/select-kit/select-kit-collection"], function (_exports, _component, _selectKitCollection) {
  "use strict";
...
define("select-kit/components/select-kit/select-kit-header", ["exports", "@ember/component", "select-kit/mixins/utils", "@ember/object", "discourse-common/lib/helpers"], function (_exports, _component, _utils, _object, _helpers) {
  ...
  var _default = _component.default.extend(_utils.default, {
    ...
    keyDown: function keyDown(event) {
      ...
      var onlyShiftKey = event.shiftKey && event.key === "Shift";
    ...
    _focusFilterInput: function _focusFilterInput() {
      var filterContainer = document.querySelector("#".concat(this.selectKit.uniqueID, "-filter"));
...
define("select-kit/components/select-kit/select-kit-row", ["exports", "@ember/object", "@ember/component", "I18n", "select-kit/mixins/utils", "@ember/object/internals", "select-kit/templates/components/select-kit/select-kit-row", "discourse-common/lib/helpers", "@ember/object/computed"], function (_exports, _object, _component, _I18n, _utils, _internals, _selectKitRow, _helpers, _computed) {
  ...
  var _default = _component.default.extend(_utils.default, (_obj = {
    ...
    tagName: "li",
    tabIndex: 0,
    attributeBindings: ["tabIndex", "title", "rowValue:data-value", "rowName:data-name", "role", "ariaChecked:aria-checked", "guid:data-guid", "rowLang:lang"],
    ...
    didInsertElement: function didInsertElement() {
      ...
      if (!(this === null || this === void 0 ? void 0 : (_this$site = this.site) === null || _this$site === void 0 ? void 0 : _this$site.mobileView)) {
    ...
    willDestroyElement: function willDestroyElement() {
      ...
      if (!(this === null || this === void 0 ? void 0 : (_this$site2 = this.site) === null || _this$site2 === void 0 ? void 0 : _this$site2.mobileView) && this.element) {
    ...
    handleBlur: function handleBlur(event) {
      if ((!this.isDestroying || !this.isDestroyed) && event.relatedTarget && this.selectKit.mainElement()) {
...
define("select-kit/components/select-kit/single-select-header", ["exports", "@ember/object", "@ember/object/computed", "select-kit/components/select-kit/select-kit-header", "select-kit/mixins/utils", "select-kit/templates/components/select-kit/single-select-header", "I18n"], function (_exports, _object, _computed, _selectKitHeader, _utils, _singleSelectHeader, _I18n) {
  ...
  var _default = _selectKitHeader.default.extend(_utils.default, {
    ...
    focusIn: function focusIn(event) {
      event.stopImmediatePropagation();
      document.querySelectorAll(".select-kit-header").forEach(function (header) {
...
define("select-kit/components/selected-choice-category", ["exports", "select-kit/templates/components/selected-choice-category", "select-kit/components/selected-choice", "discourse/helpers/category-link", "@ember/object"], function (_exports, _selectedChoiceCategory, _selectedChoice, _categoryLink, _object) {
  "use strict";
...
define("select-kit/components/selected-choice-color", ["exports", "discourse/lib/utilities", "select-kit/components/selected-choice", "@ember/runloop", "@ember/object"], function (_exports, _utilities, _selectedChoice, _runloop, _object) {
  ...
  var _default = _selectedChoice.default.extend({
    ...
    escapedColor: (0, _object.computed)("item", function () {
      ...
      var color = "".concat((0, _utilities.escapeExpression)(((_this$item = this.item) === null || _this$item === void 0 ? void 0 : _this$item.name) || this.item));
    ...
    didInsertElement: function didInsertElement() {
      ...
      (0, _runloop.schedule)("afterRender", function () {
        var element = document.querySelector("#".concat(_this.selectKit.uniqueID, " #").concat(_this.id, "-choice"));

        if (!element) {
          return;
        }

        element.style.borderBottomColor = _this.escapedColor;
      });
    }
  });
...
define("select-kit/components/selected-color", ["exports", "select-kit/components/selected-name", "discourse/lib/utilities", "@ember/runloop"], function (_exports, _selectedName, _utilities, _runloop) {
  ...
  var _default = _selectedName.default.extend({
    ...
    didInsertElement: function didInsertElement() {
      ...
      (0, _runloop.schedule)("afterRender", function () {
        var element = document.querySelector("#".concat(_this.selectKit.uniqueID, " #").concat(_this.id));
        ...
        element.style.borderBottomColor = "#".concat(color);
      });
    }
  });
...
define("select-kit/components/selected-flair", ["exports", "select-kit/components/selected-name", "select-kit/templates/components/flair-row"], function (_exports, _selectedName, _flairRow) {
  "use strict";
...
define("select-kit/components/tag-drop", ["exports", "@ember/object/computed", "discourse/lib/computed", "select-kit/components/combo-box", "discourse/lib/url", "select-kit/mixins/tags", "@ember/object", "discourse-common/lib/helpers", "select-kit/components/select-kit"], function (_exports, _computed, _computed2, _comboBox, _url, _tags, _object, _helpers, _selectKit) {
  ...
  var MORE_TAGS_COLLECTION = "MORE_TAGS_COLLECTION";
  ...
  var _default = _comboBox.default.extend(_tags.default, {
    ...
    content: (0, _object.computed)("topTags.[]", "shortcuts.[]", function () {
      var topTags = this.topTags.slice(0, this.maxTagsInFilterList);
...
define("select-kit/components/tag-drop/more-tags-collection", ["exports", "@ember/component", "select-kit/templates/components/tag-drop/more-tags-collection"], function (_exports, _component, _moreTagsCollection) {
  "use strict";
  ...
  var _default = _component.default.extend({
    tagName: "",
    layout: _moreTagsCollection.default,
    collection: null
  });
  ...
  var _default = _miniTagChooser.default.extend((_obj = {
    ...
    onChange: function onChange(tags) {
      ...
      if (tags.includes(this.mainTag)) {
        var remainingTags = tags.filter(function (t) {
          return t !== _this.mainTag;
        });

        if (remainingTags.length >= 1) {
          _url.default.routeTo("/tags/intersection/".concat(this.mainTag, "/").concat(remainingTags.join("/")));
        } else {
          _url.default.routeTo("/tags");
        }
      } else {
        if (tags.length >= 2) {
          _url.default.routeTo("/tags/intersection/".concat(tags.join("/")));
        } else {
          _url.default.routeTo("/tags");
        }
      }
...
define("select-kit/components/topic-notifications-button", ["exports", "@ember/object", "I18n", "@ember/utils", "discourse/lib/notification-levels", "discourse-common/utils/decorators", "discourse-common/lib/get-url", "@ember/component", "select-kit/templates/components/topic-notifications-button"], function (_exports, _object, _I18n, _utils, _notificationLevels, _decorators, _getUrl, _component, _topicNotificationsButton) {
  ...
  var _default = _component.default.extend((_dec = (0, _decorators.default)("topic", "topic.details.{notification_level,notifications_reason_id}"), (_obj = {
    ...
    notificationReasonText: function notificationReasonText(topic, topicDetails) {
      var level = topicDetails.notification_level;
      var reason = topicDetails.notifications_reason_id;

      if (typeof level !== "number") {
        level = 1;
      }

      var localeString = "topic.notifications.reasons.".concat(level);

      if (typeof reason === "number") {
        var localeStringWithReason = localeString + "_" + reason;
      ...
      if (this.currentUser && this.currentUser.mailing_list_mode && level > _notificationLevels.NotificationLevels.MUTED) {
    ...
    // that category.
    _notificationReasonStale: function _notificationReasonStale(level, reason, topic, currentUser) {
      if (!currentUser) {
        return;
      }
      ...
      var tags = topic.tags;
      var watchedCategoryIds = currentUser.watched_category_ids || [];
      var trackedCategoryIds = currentUser.tracked_category_ids || [];
      var watchedTags = currentUser.watched_tags || []; // 2_8 tracking category
      ...
      if (categoryId) {
        ...
        if (level === 3 && reason === 10) {
          if (!tags.some(function (tag) {
            return watchedTags.includes(tag);
          })) {
            return true;
          }
        }
...
define("select-kit/components/user-chooser", ["exports", "discourse/lib/user-search", "select-kit/components/multi-select", "@ember/object", "discourse-common/lib/helpers"], function (_exports, _userSearch, _multiSelect, _object, _helpers) {
  ...
  var CUSTOM_USER_SEARCH_OPTIONS = [];
  ...
  var _default = _multiSelect.default.extend({
    ...
    search: function search() {
      ...
      var customUserSearchOptions = CUSTOM_USER_SEARCH_OPTIONS.reduce(function (obj, option) {
        return _objectSpread(_objectSpread({}, obj), {}, _defineProperty({}, option, options[option]));
      }, {});
      return (0, _userSearch.default)({
        ...
        customUserSearchOptions: customUserSearchOptions
...
define("select-kit/lib/ajax-helper", ["exports"], function (_exports) {
  "use strict";
  ...
  if (window.Discourse) {
    _exports.ajax = ajax = requirejs("discourse/lib/ajax").ajax;
  } else {
    _exports.ajax = ajax = requirejs("wizard/lib/ajax").ajax;
  }
});
...
define("select-kit/mixins/tags", ["exports", "I18n", "@ember/object/mixin", "select-kit/lib/ajax-helper", "discourse-common/lib/get-url", "@ember/utils", "discourse-common/lib/helpers", "discourse/lib/ajax-error", "@ember/object/computed"], function (_exports, _I18n, _mixin, _ajaxHelper, _getUrl, _utils, _helpers, _ajaxError, _computed) {
  "use strict";
  ...
  var _default = _mixin.default.create({
    searchTags: function searchTags(url, data, callback) {
      ...
      return (0, _ajaxHelper.ajax)((0, _getUrl.default)(url), {
        quietMillis: 200,
        dataType: "json",
        data: data
      }).then(function (json) {
...
define("select-kit/mixins/utils", ["exports", "@ember/object/mixin", "@ember/object"], function (_exports, _mixin, _object) {
  ...
  var _default = _mixin.default.create({
    isValidInput: function isValidInput(eventKey) {
      ...
      var nonInputKeysRegex = /F\d+|Arrow.+|Meta|Alt|Control|Shift|Delete|Enter|Escape|Tab|Space|Insert|Backspace/;
...
Ember.TEMPLATES["select-kit/templates/components/email-group-user-chooser-row"] = Ember.HTMLBars.template({"id":null,"block":"{\"symbols\":[],\"statements\":[[4,\"if\",[[24,[\"item\",\"isUser\"]]],null,{\"statements\":[[0,\"  \"],[1,[28,\"avatar\",[[24,[\"item\"]]],[[\"imageSize\"],[\"tiny\"]]],false],[0,\"\\n  \"],[7,\"span\",true],[10,\"class\",\"identifier\"],[8],[1,[28,\"format-username\",[[24,[\"item\",\"id\"]]],null],false],[9],[0,\"\\n  \"],[7,\"span\",true],[10,\"class\",\"name\"],[8],[1,[24,[\"item\",\"name\"]],false],[9],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[4,\"if\",[[24,[\"item\",\"isGroup\"]]],null,{\"statements\":[[0,\"  \"],[1,[28,\"d-icon\",[\"users\"],null],false],[0,\"\\n  \"],[7,\"span\",true],[10,\"class\",\"identifier\"],[8],[1,[24,[\"item\",\"id\"]],false],[9],[0,\"\\n  \"],[7,\"span\",true],[10,\"class\",\"name\"],[8],[1,[24,[\"item\",\"full_name\"]],false],[9],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[0,\"  \"],[1,[28,\"d-icon\",[\"envelope\"],null],false],[0,\"\\n  \"],[7,\"span\",true],[10,\"class\",\"identifier\"],[8],[1,[24,[\"item\",\"id\"]],false],[9],[0,\"\\n\"]],\"parameters\":[]}]],\"parameters\":[]}]],\"hasEval\":false}","meta":{"moduleName":"select-kit/templates/components/email-group-user-chooser-row"}});
Ember.TEMPLATES["select-kit/templates/components/flair-row"] = Ember.HTMLBars.template({"id":null,"block":"{\"symbols\":[],\"statements\":[[4,\"if\",[[24,[\"item\",\"url\"]]],null,{\"statements\":[[0,\"  \"],[1,[28,\"avatar-flair\",null,[[\"flairName\",\"flairUrl\",\"flairBgColor\",\"flairColor\"],[[24,[\"item\",\"name\"]],[24,[\"item\",\"url\"]],[24,[\"item\",\"bgColor\"]],[24,[\"item\",\"color\"]]]]],false],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"\\n\"],[7,\"span\",true],[8],[1,[22,\"label\"],false],[9],[0,\"\\n\"]],\"hasEval\":false}","meta":{"moduleName":"select-kit/templates/components/flair-row"}});
Ember.TEMPLATES["select-kit/templates/components/future-date-input-selector/future-date-input-selector-header"] = Ember.HTMLBars.template({"id":null,"block":"{\"symbols\":[\"icon\"],\"statements\":[[7,\"div\",true],[10,\"class\",\"select-kit-header-wrapper\"],[8],[0,\"\\n\"],[4,\"if\",[[24,[\"icons\"]]],null,{\"statements\":[[0,\"    \"],[7,\"div\",true],[10,\"class\",\"future-date-input-selector-icons\"],[8],[0,\"\\n      \"],[4,\"each\",[[24,[\"icons\"]]],null,{\"statements\":[[0,\" \"],[1,[28,\"d-icon\",[[23,1,[]]],null],false],[0,\" \"]],\"parameters\":[1]},null],[0,\"\\n    \"],[9],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"\\n  \"],[1,[28,\"component\",[[24,[\"selectKit\",\"options\",\"selectedNameComponent\"]]],[[\"tabindex\",\"item\",\"selectKit\"],[[24,[\"tabindex\"]],[24,[\"selectedContent\"]],[24,[\"selectKit\"]]]]],false],[0,\"\\n\\n\"],[4,\"if\",[[24,[\"selectedContent\",\"datetime\"]]],null,{\"statements\":[[0,\"    \"],[7,\"span\",true],[10,\"class\",\"future-date-input-selector-datetime\"],[8],[0,\"\\n      \"],[1,[24,[\"selectedContent\",\"datetime\"]],false],[0,\"\\n    \"],[9],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"\\n  \"],[1,[28,\"d-icon\",[[24,[\"caretIcon\"]]],[[\"class\"],[\"caret-icon\"]]],false],[0,\"\\n\"],[9],[0,\"\\n\"]],\"hasEval\":false}","meta":{"moduleName":"select-kit/templates/components/future-date-input-selector/future-date-input-selector-header"}});
...
Ember.TEMPLATES["select-kit/templates/components/mini-tag-chooser/selected-collection"] = Ember.HTMLBars.template({"id":null,"block":"{\"symbols\":[\"tag\"],\"statements\":[[4,\"if\",[[24,[\"tags\"]]],null,{\"statements\":[[0,\"  \"],[7,\"div\",true],[10,\"class\",\"mini-tag-chooser-selected-collection selected-tags\"],[8],[0,\"\\n\"],[4,\"each\",[[24,[\"tags\"]]],null,{\"statements\":[[4,\"d-button\",null,[[\"translatedTitle\",\"icon\",\"action\",\"actionParam\",\"class\",\"tabindex\"],[[23,1,[\"value\"]],\"times\",[28,\"action\",[[23,0,[]],[24,[\"selectKit\",\"deselect\"]]],null],[23,1,[\"value\"]],[23,1,[\"classNames\"]],0]],{\"statements\":[[0,\"        \"],[1,[28,\"discourse-tag\",[[23,1,[\"value\"]]],[[\"noHref\"],[true]]],false],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[1]},null],[0,\"  \"],[9],[0,\"\\n\"]],\"parameters\":[]},null]],\"hasEval\":false}","meta":{"moduleName":"select-kit/templates/components/mini-tag-chooser/selected-collection"}});
Ember.TEMPLATES["select-kit/templates/components/multi-select"] = Ember.HTMLBars.template({"id":null,"block":"{\"symbols\":[\"collection\",\"item\"],\"statements\":[[4,\"unless\",[[24,[\"selectKit\",\"isHidden\"]]],null,{\"statements\":[[0,\"  \"],[1,[28,\"component\",[[24,[\"selectKit\",\"options\",\"headerComponent\"]]],[[\"tabindex\",\"value\",\"selectedContent\",\"selectKit\",\"id\"],[[24,[\"tabindex\"]],[24,[\"value\"]],[24,[\"selectedContent\"]],[24,[\"selectKit\"]],[28,\"concat\",[[24,[\"selectKit\",\"uniqueID\"]],\"-header\"],null]]]],false],[0,\"\\n\\n\"],[4,\"select-kit/select-kit-body\",null,[[\"selectKit\",\"id\"],[[24,[\"selectKit\"]],[28,\"concat\",[[24,[\"selectKit\",\"uniqueID\"]],\"-body\"],null]]],{\"statements\":[[0,\"    \"],[1,[28,\"component\",[[24,[\"selectKit\",\"options\",\"filterComponent\"]]],[[\"selectKit\",\"id\"],[[24,[\"selectKit\"]],[28,\"concat\",[[24,[\"selectKit\",\"uniqueID\"]],\"-filter\"],null]]]],false],[0,\"\\n\\n\"],[4,\"if\",[[24,[\"selectedContent\"]]],null,{\"statements\":[[0,\"      \"],[7,\"div\",true],[10,\"class\",\"selected-content\"],[8],[0,\"\\n\"],[4,\"each\",[[24,[\"selectedContent\"]]],null,{\"statements\":[[0,\"          \"],[1,[28,\"component\",[[24,[\"selectKit\",\"options\",\"selectedChoiceComponent\"]]],[[\"item\",\"selectKit\"],[[23,2,[]],[24,[\"selectKit\"]]]]],false],[0,\"\\n\"]],\"parameters\":[2]},null],[0,\"      \"],[9],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"\\n\"],[4,\"if\",[[24,[\"selectKit\",\"isLoading\"]]],null,{\"statements\":[[0,\"      \"],[7,\"span\",true],[10,\"class\",\"is-loading\"],[8],[0,\"\\n\"],[4,\"if\",[[24,[\"site\"]]],null,{\"statements\":[[0,\"          \"],[1,[28,\"loading-spinner\",null,[[\"size\"],[\"small\"]]],false],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"      \"],[9],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[4,\"each\",[[24,[\"collections\"]]],null,{\"statements\":[[0,\"        \"],[1,[28,\"component\",[[28,\"component-for-collection\",[[23,1,[\"identifier\"]],[24,[\"selectKit\"]]],null]],[[\"collection\",\"selectKit\",\"value\"],[[23,1,[]],[24,[\"selectKit\"]],[24,[\"value\"]]]]],false],[0,\"\\n\"]],\"parameters\":[1]},null],[0,\"\\n\"],[4,\"if\",[[24,[\"selectKit\",\"filter\"]]],null,{\"statements\":[[4,\"if\",[[24,[\"selectKit\",\"hasNoContent\"]]],null,{\"statements\":[[0,\"          \"],[7,\"span\",true],[10,\"class\",\"no-content\"],[10,\"role\",\"alert\"],[8],[0,\"\\n            \"],[1,[28,\"i18n\",[\"select_kit.no_content\"],null],false],[0,\"\\n          \"],[9],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[0,\"          \"],[7,\"span\",true],[10,\"class\",\"results-count\"],[10,\"role\",\"alert\"],[8],[0,\"\\n            \"],[1,[28,\"i18n\",[\"select_kit.results_count\"],[[\"count\"],[[24,[\"mainCollection\",\"length\"]]]]],false],[0,\"\\n          \"],[9],[0,\"\\n\"]],\"parameters\":[]}]],\"parameters\":[]},null]],\"parameters\":[]}]],\"parameters\":[]},null]],\"parameters\":[]},null]],\"hasEval\":false}","meta":{"moduleName":"select-kit/templates/components/multi-select"}});
Ember.TEMPLATES["select-kit/templates/components/multi-select/format-selected-content"] = Ember.HTMLBars.template({"id":null,"block":"{\"symbols\":[],\"statements\":[[7,\"span\",true],[10,\"class\",\"formated-selection\"],[8],[0,\"\\n  \"],[1,[22,\"formatedContent\"],false],[0,\"\\n\"],[9],[0,\"\\n\"]],\"hasEval\":false}","meta":{"moduleName":"select-kit/templates/components/multi-select/format-selected-content"}});
Ember.TEMPLATES["select-kit/templates/components/multi-select/multi-select-header"] = Ember.HTMLBars.template({"id":null,"block":"{\"symbols\":[\"icon\"],\"statements\":[[7,\"div\",true],[10,\"class\",\"select-kit-header-wrapper\"],[8],[0,\"\\n\"],[4,\"each\",[[24,[\"icons\"]]],null,{\"statements\":[[0,\"    \"],[1,[28,\"d-icon\",[[23,1,[]]],null],false],[0,\"\\n\"]],\"parameters\":[1]},null],[0,\"\\n  \"],[1,[28,\"multi-select/format-selected-content\",null,[[\"content\",\"selectKit\"],[[24,[\"selectedContent\"]],[24,[\"selectKit\"]]]]],false],[0,\"\\n\\n  \"],[1,[28,\"d-icon\",[[24,[\"caretIcon\"]]],[[\"class\"],[\"caret-icon\"]]],false],[0,\"\\n\"],[9],[0,\"\\n\"]],\"hasEval\":false}","meta":{"moduleName":"select-kit/templates/components/multi-select/multi-select-header"}});
...
Ember.TEMPLATES["select-kit/templates/components/notifications-filter/notifications-filter-header"] = Ember.HTMLBars.template({"id":null,"block":"{\"symbols\":[],\"statements\":[[7,\"div\",true],[10,\"class\",\"select-kit-header-wrapper\"],[8],[0,\"\\n  \"],[7,\"span\",true],[10,\"class\",\"filter-text\"],[8],[0,\"\\n    \"],[1,[28,\"i18n\",[\"user.user_notifications.filters.filter_by\"],null],false],[0,\"\\n  \"],[9],[0,\"\\n  \"],[7,\"span\",true],[10,\"class\",\"header-text\"],[8],[0,\"\\n    \"],[1,[28,\"i18n\",[[24,[\"label\"]]],null],false],[0,\"\\n  \"],[9],[0,\"\\n  \"],[1,[28,\"d-icon\",[[24,[\"caretIcon\"]]],[[\"class\"],[\"caret-icon\"]]],false],[0,\"\\n\"],[9],[0,\"\\n\"]],\"hasEval\":false}","meta":{"moduleName":"select-kit/templates/components/notifications-filter/notifications-filter-header"}});
Ember.TEMPLATES["select-kit/templates/components/period-chooser/period-chooser-header"] = Ember.HTMLBars.template({"id":null,"block":"{\"symbols\":[],\"statements\":[[7,\"h2\",true],[10,\"class\",\"selected-name\"],[11,\"title\",[22,\"title\"]],[10,\"role\",\"option\"],[8],[0,\"\\n  \"],[1,[28,\"period-title\",[[24,[\"value\"]]],[[\"showDateRange\",\"fullDay\"],[true,[24,[\"selectKit\",\"options\",\"fullDay\"]]]]],false],[0,\"\\n\"],[9],[0,\"\\n\\n\"],[1,[28,\"d-icon\",[[24,[\"caretIcon\"]]],[[\"class\"],[\"caret-icon\"]]],false],[0,\"\\n\"]],\"hasEval\":false}","meta":{"moduleName":"select-kit/templates/components/period-chooser/period-chooser-header"}});
...
Ember.TEMPLATES["select-kit/templates/components/select-kit/errors-collection"] = Ember.HTMLBars.template({"id":null,"block":"{\"symbols\":[\"item\"],\"statements\":[[4,\"if\",[[24,[\"collection\",\"content\"]]],null,{\"statements\":[[0,\"  \"],[7,\"ul\",true],[10,\"class\",\"select-kit-errors-collection\"],[8],[0,\"\\n\"],[4,\"each\",[[24,[\"collection\",\"content\"]]],null,{\"statements\":[[0,\"      \"],[7,\"li\",true],[10,\"class\",\"select-kit-error\"],[8],[1,[23,1,[]],false],[9],[0,\"\\n\"]],\"parameters\":[1]},null],[0,\"  \"],[9],[0,\"\\n\"]],\"parameters\":[]},null]],\"hasEval\":false}","meta":{"moduleName":"select-kit/templates/components/select-kit/errors-collection"}});
...
Ember.TEMPLATES["select-kit/templates/components/select-kit/select-kit-collection"] = Ember.HTMLBars.template({"id":null,"block":"{\"symbols\":[\"item\"],\"statements\":[[4,\"if\",[[24,[\"collection\",\"content\",\"length\"]]],null,{\"statements\":[[0,\"  \"],[7,\"ul\",true],[10,\"class\",\"select-kit-collection\"],[10,\"aria-live\",\"polite\"],[10,\"role\",\"menu\"],[8],[0,\"\\n\"],[4,\"each\",[[24,[\"collection\",\"content\"]]],null,{\"statements\":[[0,\"      \"],[1,[28,\"component\",[[28,\"component-for-row\",[[24,[\"collection\",\"identifier\"]],[23,1,[]],[24,[\"selectKit\"]]],null]],[[\"item\",\"value\",\"selectKit\"],[[23,1,[]],[24,[\"value\"]],[24,[\"selectKit\"]]]]],false],[0,\"\\n\"]],\"parameters\":[1]},null],[0,\"  \"],[9],[0,\"\\n\"]],\"parameters\":[]},null]],\"hasEval\":false}","meta":{"moduleName":"select-kit/templates/components/select-kit/select-kit-collection"}});
Ember.TEMPLATES["select-kit/templates/components/select-kit/select-kit-filter"] = Ember.HTMLBars.template({"id":null,"block":"{\"symbols\":[],\"statements\":[[4,\"unless\",[[24,[\"isHidden\"]]],null,{\"statements\":[[0,\"  \"],[1,[28,\"input\",null,[[\"tabindex\",\"class\",\"placeholder\",\"autocomplete\",\"autocorrect\",\"autocapitalize\",\"name\",\"spellcheck\",\"value\",\"input\",\"paste\",\"keyDown\",\"keyUp\"],[0,\"filter-input\",[24,[\"placeholder\"]],\"discourse\",\"off\",\"off\",\"filter-input-search\",false,[28,\"readonly\",[[24,[\"selectKit\",\"filter\"]]],null],[28,\"action\",[[23,0,[]],\"onInput\"],null],[28,\"action\",[[23,0,[]],\"onPaste\"],null],[28,\"action\",[[23,0,[]],\"onKeydown\"],null],[28,\"action\",[[23,0,[]],\"onKeyup\"],null]]]],false],[0,\"\\n\\n\"],[4,\"if\",[[24,[\"selectKit\",\"options\",\"filterIcon\"]]],null,{\"statements\":[[0,\"    \"],[1,[28,\"d-icon\",[[24,[\"selectKit\",\"options\",\"filterIcon\"]]],[[\"class\"],[\"filter-icon\"]]],false],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[]},null]],\"hasEval\":false}","meta":{"moduleName":"select-kit/templates/components/select-kit/select-kit-filter"}});
Ember.TEMPLATES["select-kit/templates/components/select-kit/select-kit-row"] = Ember.HTMLBars.template({"id":null,"block":"{\"symbols\":[\"icon\"],\"statements\":[[4,\"each\",[[24,[\"icons\"]]],null,{\"statements\":[[0,\"  \"],[1,[28,\"d-icon\",[[23,1,[]]],[[\"translatedtitle\"],[[24,[\"dasherizedTitle\"]]]]],false],[0,\"\\n\"]],\"parameters\":[1]},null],[0,\"\\n\"],[7,\"span\",true],[10,\"class\",\"name\"],[8],[0,\"\\n  \"],[1,[22,\"label\"],false],[0,\"\\n\"],[9],[0,\"\\n\"]],\"hasEval\":false}","meta":{"moduleName":"select-kit/templates/components/select-kit/select-kit-row"}});
Ember.TEMPLATES["select-kit/templates/components/select-kit/single-select-header"] = Ember.HTMLBars.template({"id":null,"block":"{\"symbols\":[\"icon\"],\"statements\":[[7,\"div\",true],[10,\"class\",\"select-kit-header-wrapper\"],[8],[0,\"\\n  \"],[4,\"each\",[[24,[\"icons\"]]],null,{\"statements\":[[0,\" \"],[1,[28,\"d-icon\",[[23,1,[]]],null],false],[0,\" \"]],\"parameters\":[1]},null],[0,\"\\n\\n  \"],[1,[28,\"component\",[[24,[\"selectKit\",\"options\",\"selectedNameComponent\"]]],[[\"item\",\"selectKit\"],[[24,[\"selectedContent\"]],[24,[\"selectKit\"]]]]],false],[0,\"\\n\"],[9],[0,\"\\n\"]],\"hasEval\":false}","meta":{"moduleName":"select-kit/templates/components/select-kit/single-select-header"}});
Ember.TEMPLATES["select-kit/templates/components/selected-choice-category"] = Ember.HTMLBars.template({"id":null,"block":"{\"symbols\":[],\"statements\":[[4,\"selected-choice\",null,[[\"item\",\"selectKit\",\"extraClass\"],[[24,[\"item\"]],[24,[\"selectKit\"]],[24,[\"extraClass\"]]]],{\"statements\":[[0,\"  \"],[1,[22,\"badge\"],false],[0,\"\\n\"]],\"parameters\":[]},null]],\"hasEval\":false}","meta":{"moduleName":"select-kit/templates/components/selected-choice-category"}});
Ember.TEMPLATES["select-kit/templates/components/selected-choice"] = Ember.HTMLBars.template({"id":null,"block":"{\"symbols\":[\"&default\"],\"statements\":[[7,\"button\",false],[12,\"aria-label\",[28,\"i18n\",[\"select_kit.delete_item\"],[[\"name\"],[[24,[\"itemName\"]]]]]],[12,\"id\",[29,[[22,\"id\"],\"-choice\"]]],[12,\"data-value\",[22,\"itemValue\"]],[12,\"data-name\",[22,\"itemName\"]],[12,\"class\",[29,[\"btn btn-default selected-choice \",[22,\"extraClass\"]]]],[12,\"type\",\"button\"],[3,\"action\",[[23,0,[]],[24,[\"selectKit\",\"deselect\"]],[24,[\"item\"]]]],[8],[0,\"\\n  \"],[1,[28,\"d-icon\",[\"times\"],null],false],[0,\"\\n\"],[4,\"if\",[[25,1]],null,{\"statements\":[[0,\"    \"],[14,1],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[0,\"    \"],[7,\"span\",true],[10,\"class\",\"d-button-label\"],[8],[0,\"\\n      \"],[1,[28,\"html-safe\",[[24,[\"itemName\"]]],null],false],[0,\"\\n    \"],[9],[0,\"\\n\"]],\"parameters\":[]}],[9],[0,\"\\n\"]],\"hasEval\":false}","meta":{"moduleName":"select-kit/templates/components/selected-choice"}});
Ember.TEMPLATES["select-kit/templates/components/selected-name"] = Ember.HTMLBars.template({"id":null,"block":"{\"symbols\":[],\"statements\":[[4,\"if\",[[24,[\"selectKit\",\"options\",\"showFullTitle\"]]],null,{\"statements\":[[0,\"  \"],[7,\"div\",true],[11,\"lang\",[22,\"lang\"]],[11,\"title\",[22,\"title\"]],[11,\"data-value\",[22,\"value\"]],[11,\"data-name\",[22,\"name\"]],[10,\"role\",\"option\"],[10,\"class\",\"select-kit-selected-name selected-name choice\"],[8],[0,\"\\n\"],[4,\"if\",[[24,[\"item\",\"icon\"]]],null,{\"statements\":[[0,\"      \"],[1,[28,\"d-icon\",[[24,[\"item\",\"icon\"]]],null],false],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"\\n    \"],[7,\"span\",true],[10,\"class\",\"name\"],[8],[0,\"\\n      \"],[1,[22,\"label\"],false],[0,\"\\n    \"],[9],[0,\"\\n\\n\"],[4,\"if\",[[24,[\"shouldDisplayClearableButton\"]]],null,{\"statements\":[[0,\"      \"],[1,[28,\"d-button\",null,[[\"class\",\"icon\",\"action\",\"actionParam\",\"ariaLabel\"],[\"btn-clear\",\"times\",[24,[\"selectKit\",\"deselect\"]],[24,[\"item\"]],\"clear_input\"]]],false],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"  \"],[9],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[4,\"if\",[[24,[\"item\",\"icon\"]]],null,{\"statements\":[[0,\"    \"],[7,\"div\",true],[10,\"role\",\"option\"],[11,\"lang\",[22,\"lang\"]],[10,\"class\",\"select-kit-selected-name selected-name choice\"],[8],[0,\"\\n      \"],[1,[28,\"d-icon\",[[24,[\"item\",\"icon\"]]],null],false],[0,\"\\n    \"],[9],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[]}]],\"hasEval\":false}","meta":{"moduleName":"select-kit/templates/components/selected-name"}});
Ember.TEMPLATES["select-kit/templates/components/single-select"] = Ember.HTMLBars.template({"id":null,"block":"{\"symbols\":[\"collection\"],\"statements\":[[4,\"unless\",[[24,[\"selectKit\",\"isHidden\"]]],null,{\"statements\":[[0,\"  \"],[1,[28,\"component\",[[24,[\"selectKit\",\"options\",\"headerComponent\"]]],[[\"tabindex\",\"value\",\"selectedContent\",\"selectKit\",\"id\"],[[24,[\"tabindex\"]],[24,[\"value\"]],[24,[\"selectedContent\"]],[24,[\"selectKit\"]],[28,\"concat\",[[24,[\"selectKit\",\"uniqueID\"]],\"-header\"],null]]]],false],[0,\"\\n\\n\"],[4,\"select-kit/select-kit-body\",null,[[\"selectKit\",\"id\"],[[24,[\"selectKit\"]],[28,\"concat\",[[24,[\"selectKit\",\"uniqueID\"]],\"-body\"],null]]],{\"statements\":[[0,\"    \"],[1,[28,\"component\",[[24,[\"selectKit\",\"options\",\"filterComponent\"]]],[[\"selectKit\",\"id\"],[[24,[\"selectKit\"]],[28,\"concat\",[[24,[\"selectKit\",\"uniqueID\"]],\"-filter\"],null]]]],false],[0,\"\\n\\n\"],[4,\"if\",[[24,[\"selectKit\",\"isLoading\"]]],null,{\"statements\":[[0,\"      \"],[7,\"span\",true],[10,\"class\",\"is-loading\"],[8],[0,\"\\n\"],[4,\"if\",[[24,[\"site\"]]],null,{\"statements\":[[0,\"          \"],[1,[28,\"loading-spinner\",null,[[\"size\"],[\"small\"]]],false],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"      \"],[9],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[4,\"each\",[[24,[\"collections\"]]],null,{\"statements\":[[0,\"        \"],[1,[28,\"component\",[[28,\"component-for-collection\",[[23,1,[\"identifier\"]],[24,[\"selectKit\"]]],null]],[[\"collection\",\"selectKit\",\"value\"],[[23,1,[]],[24,[\"selectKit\"]],[24,[\"value\"]]]]],false],[0,\"\\n\"]],\"parameters\":[1]},null],[0,\"\\n\"],[4,\"if\",[[24,[\"selectKit\",\"filter\"]]],null,{\"statements\":[[4,\"if\",[[24,[\"selectKit\",\"hasNoContent\"]]],null,{\"statements\":[[0,\"          \"],[7,\"span\",true],[10,\"class\",\"no-content\"],[10,\"role\",\"alert\"],[8],[0,\"\\n            \"],[1,[28,\"i18n\",[\"select_kit.no_content\"],null],false],[0,\"\\n          \"],[9],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[0,\"          \"],[7,\"span\",true],[10,\"class\",\"results-count\"],[10,\"role\",\"alert\"],[8],[0,\"\\n            \"],[1,[28,\"i18n\",[\"select_kit.results_count\"],[[\"count\"],[[24,[\"mainCollection\",\"length\"]]]]],false],[0,\"\\n          \"],[9],[0,\"\\n\"]],\"parameters\":[]}]],\"parameters\":[]},null]],\"parameters\":[]}]],\"parameters\":[]},null]],\"parameters\":[]},null]],\"hasEval\":false}","meta":{"moduleName":"select-kit/templates/components/single-select"}});
...
Ember.TEMPLATES["select-kit/templates/components/tag-drop/more-tags-collection"] = Ember.HTMLBars.template({"id":null,"block":"{\"symbols\":[],\"statements\":[[4,\"if\",[[24,[\"collection\",\"content\",\"shouldShowMoreTags\"]]],null,{\"statements\":[[0,\"  \"],[7,\"div\",true],[10,\"class\",\"more-tags\"],[8],[0,\"\\n    \"],[1,[28,\"i18n\",[\"select_kit.components.tag_drop.filter_for_more\"],null],false],[0,\"\\n  \"],[9],[0,\"\\n\"]],\"parameters\":[]},null]],\"hasEval\":false}","meta":{"moduleName":"select-kit/templates/components/tag-drop/more-tags-collection"}});
Ember.TEMPLATES["select-kit/templates/components/tag-drop/tag-drop-header"] = Ember.HTMLBars.template({"id":null,"block":"{\"symbols\":[],\"statements\":[[7,\"div\",true],[10,\"class\",\"select-kit-header-wrapper\"],[8],[0,\"\\n  \"],[1,[28,\"component\",[[24,[\"selectKit\",\"options\",\"selectedNameComponent\"]]],[[\"tabindex\",\"item\",\"selectKit\",\"shouldDisplayClearableButton\"],[[24,[\"tabindex\"]],[24,[\"selectedContent\"]],[24,[\"selectKit\"]],[24,[\"shouldDisplayClearableButton\"]]]]],false],[0,\"\\n\\n  \"],[1,[28,\"d-icon\",[[24,[\"caretIcon\"]]],[[\"class\"],[\"caret-icon\"]]],false],[0,\"\\n\"],[9],[0,\"\\n\"]],\"hasEval\":false}","meta":{"moduleName":"select-kit/templates/components/tag-drop/tag-drop-header"}});
...
Ember.TEMPLATES["select-kit/templates/components/topic-notifications-button"] = Ember.HTMLBars.template({"id":null,"block":"{\"symbols\":[],\"statements\":[[4,\"if\",[[24,[\"appendReason\"]]],null,{\"statements\":[[0,\"  \"],[7,\"p\",true],[10,\"class\",\"reason\"],[8],[0,\"\\n    \"],[1,[28,\"topic-notifications-options\",null,[[\"value\",\"topic\",\"onChange\",\"options\"],[[24,[\"notificationLevel\"]],[24,[\"topic\"]],[28,\"action\",[[23,0,[]],\"changeTopicNotificationLevel\"],null],[28,\"hash\",null,[[\"icon\",\"showFullTitle\",\"showCaret\",\"headerAriaLabel\"],[[24,[\"icon\"]],[24,[\"showFullTitle\"]],[24,[\"showCaret\"]],[28,\"i18n\",[\"topic.notifications.title\"],null]]]]]]],false],[0,\"\\n    \"],[7,\"span\",true],[10,\"class\",\"text\"],[8],[1,[28,\"html-safe\",[[24,[\"notificationReasonText\"]]],null],false],[9],[0,\"\\n  \"],[9],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[0,\"  \"],[1,[28,\"topic-notifications-options\",null,[[\"value\",\"topic\",\"onChange\",\"options\"],[[24,[\"notificationLevel\"]],[24,[\"topic\"]],[28,\"action\",[[23,0,[]],\"changeTopicNotificationLevel\"],null],[28,\"hash\",null,[[\"icon\",\"showFullTitle\",\"showCaret\",\"headerAriaLabel\"],[[24,[\"icon\"]],[24,[\"showFullTitle\"]],[24,[\"showCaret\"]],[28,\"i18n\",[\"topic.notifications.title\"],null]]]]]]],false],[0,\"\\n\"]],\"parameters\":[]}]],\"hasEval\":false}","meta":{"moduleName":"select-kit/templates/components/topic-notifications-button"}});
Ember.TEMPLATES["select-kit/templates/components/user-chooser/user-row"] = Ember.HTMLBars.template({"id":null,"block":"{\"symbols\":[],\"statements\":[[1,[28,\"avatar\",[[24,[\"item\"]]],[[\"imageSize\"],[\"tiny\"]]],false],[0,\"\\n\\n\"],[7,\"span\",true],[10,\"class\",\"username\"],[8],[1,[28,\"format-username\",[[24,[\"item\",\"username\"]]],null],false],[9],[0,\"\\n\\n\"],[4,\"if\",[[24,[\"item\",\"name\"]]],null,{\"statements\":[[0,\"  \"],[7,\"span\",true],[10,\"class\",\"name\"],[8],[1,[24,[\"item\",\"name\"]],false],[9],[0,\"\\n\"]],\"parameters\":[]},null]],\"hasEval\":false}","meta":{"moduleName":"select-kit/templates/components/user-chooser/user-row"}});
...
Ember.TEMPLATES["wizard/templates/components/styling-preview"] = Ember.HTMLBars.template({"id":null,"block":"{\"symbols\":[],\"statements\":[[7,\"div\",true],[11,\"class\",[29,[\"previews \",[28,\"if\",[[24,[\"draggingActive\"]],\"dragging\"],null]]]],[8],[0,\"\\n  \"],[7,\"div\",true],[10,\"class\",\"preview-area topic-preview\"],[8],[0,\"\\n    \"],[7,\"canvas\",true],[11,\"width\",[22,\"elementWidth\"]],[11,\"height\",[22,\"elementHeight\"]],[11,\"style\",[22,\"canvasStyle\"]],[8],[0,\"\\n    \"],[9],[0,\"\\n  \"],[9],[0,\"\\n  \"],[7,\"div\",true],[10,\"class\",\"preview-area homepage-preview\"],[8],[0,\"\\n    \"],[1,[28,\"homepage-preview\",null,[[\"wizard\",\"step\",\"stylingDropdown\"],[[24,[\"wizard\"]],[24,[\"step\"]],[24,[\"stylingDropdown\"]]]]],false],[0,\"\\n  \"],[9],[0,\"\\n\"],[9],[0,\"\\n\\n\"],[7,\"div\",true],[10,\"class\",\"preview-nav\"],[8],[0,\"\\n  \"],[7,\"a\",false],[12,\"href\",\"\"],[12,\"class\",[29,[\"preview-nav-button \",[28,\"if\",[[24,[\"previewTopic\"]],\"active\"],null]]]],[3,\"action\",[[23,0,[]],\"setPreviewTopic\"]],[8],[0,\"\\n    \"],[1,[28,\"i18n\",[\"wizard.previews.topic_preview\"],null],false],[0,\"\\n  \"],[9],[0,\"\\n  \"],[7,\"a\",false],[12,\"href\",\"\"],[12,\"class\",[29,[\"preview-nav-button \",[28,\"unless\",[[24,[\"previewTopic\"]],\"active\"],null]]]],[3,\"action\",[[23,0,[]],\"setPreviewHomepage\"]],[8],[0,\"\\n    \"],[1,[28,\"i18n\",[\"wizard.previews.homepage_preview\"],null],false],[0,\"\\n  \"],[9],[0,\"\\n\"],[9],[0,\"\\n\"]],\"hasEval\":false}","meta":{"moduleName":"wizard/templates/components/styling-preview"}});
...
Ember.TEMPLATES["wizard/templates/components/wizard-field-dropdown"] = Ember.HTMLBars.template({"id":null,"block":"{\"symbols\":[],\"statements\":[[1,[28,\"component\",[[24,[\"componentName\"]]],[[\"class\",\"value\",\"content\",\"nameProperty\",\"tabindex\",\"onChange\",\"options\"],[[24,[\"fieldClass\"]],[24,[\"field\",\"value\"]],[24,[\"field\",\"choices\"]],\"label\",\"9\",[28,\"action\",[[23,0,[]],\"onChangeValue\"],null],[28,\"hash\",null,[[\"translatedNone\"],[false]]]]]],false],[0,\"\\n\"]],\"hasEval\":false}","meta":{"moduleName":"wizard/templates/components/wizard-field-dropdown"}});
...
define("wizard/components/homepage-preview", ["exports", "wizard/lib/preview"], function (_exports, _preview) {
  ...
  var _default = (0, _preview.createPreviewComponent)(659, 320, {
    logo: null,
    avatar: null,
    didUpdateAttrs: function didUpdateAttrs() {
      this._super.apply(this, arguments);
...
define("wizard/components/styling-preview", ["exports", "wizard/lib/preview", "I18n", "discourse-common/utils/decorators"], function (_exports, _preview, _I18n, _decorators) {
  "use strict";
  ...
  var _default = (0, _preview.createPreviewComponent)(659, 320, (_dec = (0, _decorators.observes)("previewTopic"), (_obj = {
    logo: null,
    avatar: null,
    previewTopic: true,
    ...
    mouseDown: function mouseDown(e) {
      var slider = this.element.querySelector(".previews");
      this.setProperties({
        draggingActive: true,
    ...
    didUpdateAttrs: function didUpdateAttrs() {
      var _this$stylingDropdown;

      this._super.apply(this, arguments);

      this.triggerRepaint();

      if (((_this$stylingDropdown = this.stylingDropdown) === null || _this$stylingDropdown === void 0 ? void 0 : _this$stylingDropdown.id) === "homepage_style") {
        this.set("previewTopic", false);
      }
    },
    scrollPreviewArea: function scrollPreviewArea() {
      var el = this.element.querySelector(".previews");
      el.scrollTo({
        top: 0,
    ...
    paint: function paint(_ref) {
      ...
      var margin = 20;
      var avatarSize = height * 0.15;
      var lineHeight = height / 14; // Draw a fake topic
    ...
    actions: {
      setPreviewHomepage: function setPreviewHomepage() {
        this.set("previewTopic", false);
      },
      setPreviewTopic: function setPreviewTopic() {
        this.set("previewTopic", true);
      }
    }
  }, (_applyDecoratedDescriptor(_obj, "scrollPreviewArea", [_dec], Object.getOwnPropertyDescriptor(_obj, "scrollPreviewArea"), _obj)), _obj)));
...
define("wizard/components/wizard-field-dropdown", ["exports", "@ember/component", "discourse-common/utils/decorators", "@ember/object"], function (_exports, _component, _decorators, _object) {
  ...
  var _default = _component.default.extend((_dec = (0, _decorators.default)("field.id"), (_obj = {
      ...
      if (this.field.id === "color_scheme") {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            if (choice === null || choice === void 0 ? void 0 : (_choice$data = choice.data) === null || _choice$data === void 0 ? void 0 : _choice$data.colors) {
    ...
    componentName: function componentName(id) {
      if (id === "color_scheme") {
...
define("wizard/components/wizard-field", ["exports", "@ember/component", "@ember/string", "discourse-common/utils/decorators"], function (_exports, _component, _string, _decorators) {
  ...
  var _default = _component.default.extend((_dec = (0, _decorators.default)("field.type", "field.id"), _dec2 = (0, _decorators.default)("field.id"), _dec3 = (0, _decorators.default)("field.type", "field.id"), (_obj = {
    ...
    typeClasses: function typeClasses(type, id) {
      return "".concat((0, _string.dasherize)(type), "-field ").concat((0, _string.dasherize)(type), "-").concat((0, _string.dasherize)(id));
    },
...
define("wizard/components/wizard-step", ["exports", "discourse-common/utils/decorators", "@ember/component", "I18n", "discourse-common/lib/get-url", "@ember/template", "@ember/runloop"], function (_exports, _decorators, _component, _I18n, _getUrl, _template, _runloop) {
  ...
  var _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _obj, _init, _init2, _init3, _init4, _init5;
  ...
  var _default = _component.default.extend((_dec = (0, _decorators.default)("step.index"), _dec2 = (0, _decorators.default)("step.displayIndex", "wizard.totalSteps"), _dec3 = (0, _decorators.default)("step.displayIndex", "wizard.totalSteps"), _dec4 = (0, _decorators.default)("step.index", "step.displayIndex", "wizard.totalSteps", "wizard.completed"), _dec5 = (0, _decorators.default)("step.index"), _dec6 = (0, _decorators.default)("step.banner"), _dec7 = (0, _decorators.default)("step.id"), _dec8 = (0, _decorators.observes)("step.id"), _dec9 = (0, _decorators.default)("step.index", "wizard.totalSteps"), _dec10 = (0, _decorators.default)("step.fields"), (_obj = {
    ...
    includeSidebar: function includeSidebar(fields) {
    ...
    actions: {
      ...
      stylingDropdownChanged: function stylingDropdownChanged(id, value) {
        this.set("stylingDropdown", {
          id: id,
          value: value
        });
...
define("wizard/models/wizard", ["exports", "@ember/object", "wizard/models/step", "wizard/models/wizard-field", "wizard/lib/ajax", "discourse-common/utils/decorators"], function (_exports, _object, _step, _wizardField, _ajax, _decorators) {
  ...
  var Wizard = _object.default.extend((_dec = (0, _decorators.default)("steps.length"), (_obj = {
    ...
    getCurrentColors: function getCurrentColors(schemeId) {
      var colorStep = this.steps.findBy("id", "styling");

      if (!colorStep) {
        return this.current_color_scheme;
      }

      var themeChoice = colorStep.get("fieldsById.color_scheme");
    ...
    getCurrentFont: function getCurrentFont(fontId) {
      ...
      var fontsStep = this.steps.findBy("id", "styling");
...
define("wizard/controllers/application", ["exports", "@ember/controller", "@ember/string", "discourse-common/utils/decorators"], function (_exports, _controller, _string, _decorators) {
  ...
  var _default = _controller.default.extend((_dec = (0, _decorators.default)("currentStepId"), _dec2 = (0, _decorators.default)("model"), (_obj = {
    ...
    fontClasses: function fontClasses(model) {
      var fontsStep = model.steps.findBy("id", "styling");
...
define("wizard/controllers/step", ["exports", "discourse-common/lib/get-url", "@ember/controller"], function (_exports, _getUrl, _controller) {
  "use strict";
      ...
      goNext: function goNext(response) {
        ...
        if (response.refresh_required) {
          if (this.get("step.id") === "locale") {
            document.location = (0, _getUrl.default)("/wizard/steps/".concat(next));
            return;
          } else {
            this.send("refresh");
          }
...
define("wizard/lib/ajax", ["exports", "rsvp", "discourse-common/lib/get-url", "jquery", "@ember/runloop"], function (_exports, _rsvp, _getUrl, _jquery, _runloop) {
  ...
  function ajax(args) {
    ...
    return new _rsvp.Promise(function (resolve, reject) {
      ...
      args.url = (0, _getUrl.default)(url);

      _jquery.default.ajax(args);
    });
  }
});
define("wizard/lib/preview", ["exports", "@ember/component", "rsvp", "discourse-common/lib/get-url", "@ember/template", "@ember/runloop"], function (_exports, _component, _rsvp, _getUrl, _template, _runloop) {
  "use strict";
  ...
  function createPreviewComponent(width, height, obj) {
    ...
    return _component.default.extend({
      ...
      canvasStyle: (0, _template.htmlSafe)("width:".concat(width, "px;height:").concat(height, "px")),
      ctx: null,
      loaded: false,
      didInsertElement: function didInsertElement() {
        this._super.apply(this, arguments);
      ...
      repaint: function repaint() {
        ...
        var colorsArray = this.wizard.getCurrentColors(this.colorsId);
