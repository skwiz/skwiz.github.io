...
define("pretty-text/allow-lister", ["exports", "discourse-common/lib/deprecated"], function (_exports, _deprecated) {
  ...
  var DEFAULT_LIST = ["a.anchor", "a.attachment", "a.hashtag", "a.mention", "a.mention-group", "a.onebox", "a.inline-onebox", "a.inline-onebox-loading", "a[data-bbcode]", "a[data-word]", "a[name]", "a[rel=nofollow]", "a[rel=ugc]", "a[target=_blank]", "a[title]", "abbr[title]", "aside.quote", "aside[data-*]", "audio", "audio[controls]", "audio[preload]", "b", "big", "blockquote", "br", "code", "dd", "del", "div", "div.quote-controls", "div.title", "div[align]", "div[lang]", "div[data-*]"
...
define("pretty-text/oneboxer", ["exports", "pretty-text/oneboxer-cache", "@ember/runloop"], function (_exports, _oneboxerCache, _runloop) {
  ...
  function applySquareGenericOnebox(elem) {
    ...
    var img = elem.querySelector(".onebox-body img.thumbnail"); // already resolved... skip
  ...
  function loadNext(ajax) {
    ...
    return ajax("/onebox", {
      ...
      if ((result === null || result === void 0 ? void 0 : (_result$jqXHR = result.jqXHR) === null || _result$jqXHR === void 0 ? void 0 : _result$jqXHR.status) === 429) {
        timeoutMs = 2000;
        removeLoading = false;
  ...
  function load(_ref) {
    ...
    if (!refresh) {
      ...
      var cached = (0, _oneboxerCache.lookupCache)(url);
    ...
    elem.classList.add(LOADING_ONEBOX_CSS_CLASS); // Add to the loading queue
...
define("pretty-text/oneboxer-cache", ["exports"], function (_exports) {
  ...
  function lookupCache(url) {
    var _localCache$normalize;

    return (_localCache$normalize = localCache[normalize(url)]) === null || _localCache$normalize === void 0 ? void 0 : _localCache$normalize.outerHTML;
  }
});
