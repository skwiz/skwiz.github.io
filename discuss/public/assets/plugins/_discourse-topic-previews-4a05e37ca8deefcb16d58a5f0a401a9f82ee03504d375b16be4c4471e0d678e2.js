...
define("discourse/plugins/discourse-topic-list-previews/discourse/lib/utilities", ["exports", "discourse-common/lib/icon-library"], function (_exports, _iconLibrary) {
  ...
  var previewUrl = function previewUrl(thumbnails, params) {
    var featured = params ? params.featured : false;
  ...
  var renderUnboundPreview = function renderUnboundPreview(thumbnails, params) {
    ...
    var url = previewUrl(thumbnails, opts || null);
    if (!url) return '';
...
requirejs('discourse-common/lib/raw-templates').addRawTemplate("javascripts/list/topic-actions", __t);
var __t = requirejs('discourse-common/lib/raw-handlebars').template({"1":function(container,depth0,helpers,partials,data) {
...
requirejs('discourse-common/lib/raw-templates').addRawTemplate("javascripts/list/topic-list-item", __t);
var __t = requirejs('discourse-common/lib/raw-handlebars').template({"1":function(container,depth0,helpers,partials,data) {
    var stack1, lookupProperty = container.lookupProperty || function(parent, propertyName) {
        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {
          return parent[propertyName];
...
requirejs('discourse-common/lib/raw-templates').addRawTemplate("javascripts/list/topic-list-title", __t);
var __t = requirejs('discourse-common/lib/raw-handlebars').template({"1":function(container,depth0,helpers,partials,data) {
    var lookupProperty = container.lookupProperty || function(parent, propertyName) {
        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {
          return parent[propertyName];
...
requirejs('discourse-common/lib/raw-templates').addRawTemplate("javascripts/list/topic-meta", __t);
var __t = requirejs('discourse-common/lib/raw-handlebars').template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    var lookupProperty = container.lookupProperty || function(parent, propertyName) {
        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {
          return parent[propertyName];
        }
...
requirejs('discourse-common/lib/raw-templates').addRawTemplate("javascripts/list/topic-thumbnail", __t);
var __t = requirejs('discourse-common/lib/raw-handlebars').template({"1":function(container,depth0,helpers,partials,data) {
    var lookupProperty = container.lookupProperty || function(parent, propertyName) {
        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {
          return parent[propertyName];
...
requirejs('discourse-common/lib/raw-templates').addRawTemplate("javascripts/list/topic-users", __t);
var __t = requirejs('discourse-common/lib/raw-handlebars').template({"1":function(container,depth0,helpers,partials,data) {
    var stack1, lookupProperty = container.lookupProperty || function(parent, propertyName) {
        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {
          return parent[propertyName];
...
requirejs('discourse-common/lib/raw-templates').addRawTemplate("javascripts/mobile/list/topic-list-item", __t);
