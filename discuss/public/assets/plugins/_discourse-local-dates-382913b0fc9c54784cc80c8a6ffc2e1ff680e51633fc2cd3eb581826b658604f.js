...
define("discourse/plugins/discourse-local-dates/initializers/discourse-local-dates", ["exports", "discourse-common/lib/deprecated", "discourse-common/lib/get-owner", "discourse/lib/d-popover", "../lib/local-date-builder", "discourse/lib/plugin-api", "discourse/lib/show-modal"], function (_exports, _deprecated, _getOwner, _dPopover, _localDateBuilder, _pluginApi, _showModal) {
  ...
  function initializeDiscourseLocalDates(api) {
    ...
    api.decorateCookedElement(function (elem) {
      applyLocalDates(elem.querySelectorAll(".discourse-local-date"), siteSettings);
    }, {
  ...
  var _default = {
    ...
    hideDatePopover: function hideDatePopover(event) {
      var _event$target2, _event$target2$classL;

      if (event === null || event === void 0 ? void 0 : (_event$target2 = event.target) === null || _event$target2 === void 0 ? void 0 : (_event$target2$classL = _event$target2.classList) === null || _event$target2$classL === void 0 ? void 0 : _event$target2$classL.contains("discourse-local-date")) {
        (0, _dPopover.hidePopover)(event);
      }
    },
