...
define("discourse/plugins/poll/controllers/poll-ui-builder", ["exports", "discourse-common/utils/decorators", "@ember/controller", "@ember/object", "I18n"], function (_exports, _decorators, _controller, _object, _I18n) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.default = _exports.PIE_CHART_TYPE = _exports.BAR_CHART_TYPE = void 0;

  var _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _obj;
  ...
  var _default = _controller.default.extend((_dec = (0, _decorators.default)("regularPollType", "numberPollType", "multiplePollType"), _dec2 = (0, _decorators.default)("chartType", "pollType", "numberPollType"), _dec3 = (0, _decorators.default)("alwaysPollResult", "votePollResult", "closedPollResult", "staffPollResult"), _dec4 = (0, _decorators.default)("site.groups"), _dec5 = (0, _decorators.default)("pollType", "regularPollType"), _dec6 = (0, _decorators.default)("pollType", "pollOptionsCount", "multiplePollType"), _dec7 = (0, _decorators.default)("pollType", "numberPollType"), _dec8 = (0, _decorators.default)("isRegular"), _dec9 = (0, _decorators.default)("pollOptions"), _dec10 = (0, _decorators.observes)("pollType", "pollOptionsCount"), _dec11 = (0, _decorators.default)("isRegular", "isMultiple", "isNumber", "pollOptionsCount"), _dec12 = (0, _decorators.default)("isRegular", "isMultiple", "isNumber", "pollOptionsCount", "pollMin", "pollStep"), _dec13 = (0, _decorators.default)("isNumber", "pollMax"), _dec14 = (0, _decorators.default)("isNumber", "showMinMax", "pollType", "pollResult", "publicPoll", "pollTitle", "pollOptions", "pollMin", "pollMax", "pollStep", "pollGroups", "autoClose", "chartType", "date", "time"), _dec15 = (0, _decorators.default)("pollOptionsCount", "isRegular", "isMultiple", "isNumber", "pollMin", "pollMax"), _dec16 = (0, _decorators.default)("pollMin", "pollMax"), _dec17 = (0, _decorators.default)("pollStep"), _dec18 = (0, _decorators.default)("disableInsert"), (_obj = {
    ...
    pollChartTypes: [{
      name: _I18n.default.t("poll.ui_builder.poll_chart_type.bar"),
      value: BAR_CHART_TYPE
    }, {
      name: _I18n.default.t("poll.ui_builder.poll_chart_type.pie"),
    ...
    pollTypes: function pollTypes(regularPollType, numberPollType, multiplePollType) {
      return [{
        name: _I18n.default.t("poll.ui_builder.poll_type.regular"),
        value: regularPollType
      }, {
        name: _I18n.default.t("poll.ui_builder.poll_type.number"),
        value: numberPollType
      }, {
        name: _I18n.default.t("poll.ui_builder.poll_type.multiple"),
    ...
    pollOutput: function pollOutput(isNumber, showMinMax, pollType, pollResult, publicPoll, pollTitle, pollOptions, pollMin, pollMax, pollStep, pollGroups, autoClose, chartType, date, time) {
      var pollHeader = "[poll";
      var output = "";
      ...
      if (autoClose) {
        ...
        if (closeDate) {
          pollHeader += " close=".concat(closeDate);
        }
      }
