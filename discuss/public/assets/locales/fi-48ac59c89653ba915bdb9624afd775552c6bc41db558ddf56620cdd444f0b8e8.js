...
r += d["ip_address"];
r += "</b> ja lisäämässä sähköpostiosoitteensa <b>";
if(!d){
throw new Error("MessageFormat: No data passed to function.");
}
r += d["email"];
