...
r += ". Seuls les responsables peuvent voir ce message.";
return r;
...
"true" : function(d){
var r = "";
r += "vous pouvez aussi consulter les autres sujets dans ";
if(!d){
throw new Error("MessageFormat: No data passed to function.");
}
r += d["catLink"];
...
r += d["email"];
r += "</b> à une liste de blocage permanent. Êtes-vous sûr(e) que cet utilisateur est un spammeur ?";
return r;
...
"low" : function(d){
var r = "";
r += "avec un taux élevé de « J'aime » par message";
return r;
},
"med" : function(d){
var r = "";
r += "avec un taux très élevé de « J'aime » par message";
return r;
},
"high" : function(d){
var r = "";
r += "avec un taux extrêmement élevé de « J'aime » par message";
return r;
},
"other" : function(d){
var r = "";
