...
define("select-kit/components/email-group-user-chooser-filter", ["exports", "select-kit/components/multi-select/multi-select-filter"], function (_exports, _multiSelectFilter) {
  "use strict";
  ...
  var _default = _multiSelectFilter.default.extend({
